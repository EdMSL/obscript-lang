...
<h1>xOBSE v0022.11.0 Command Documentation</h1>

<p><a href="https://cs.uesp.net/wiki/Category:Oblivion_Script_Extender">OBSE @ Oblivion Construction Set Wiki</a> - follow the links throughout this documentation to gain access to additional information on the official Oblivion Construction Set Wiki. Users are encouraged to add to the wiki.<br />
...
<ul>
    <li><h3>xOBSE v0022.9</h3></li>
	<li><a href="#GetEditorID2">GetEditorID2</a></li>
    <li><h3>xOBSE v0022.6</h3></li>
	<li><a href="#IsDiseased">IsDiseased</a></li>
	<li><a href="#IsMajorRef">IsMajorRef</a></li>
	<li><a href="#SetCameraFOV2">SetCameraFOV2</a></li>
	<li><a href="#SetInvertFastTravel">SetInvertFastTravel</a></li>
	<li><a href="#IsInvertFastTravel">IsInvertFastTravel</a></li>
	<li><a href="#SetCantWait">SetCantWait</a></li>
	<li><a href="#IsCantWait">IsCantWait</a></li>
	<li><a href="#SetOwningFactionRequiredRank">SetOwningFactionRequiredRank</a></li>
	<li><a href="#SetParentCellOwningFactionRequiredRank">SetParentCellOwningFactionRequiredRank</a></li>
	<li><a href="#GetLoadedTypeArray">GetLoadedTypeArray</a></li>
	<li> Vanilla stubbed command GetDisease implemented with IsDiseased function  </li>
	<li> Ref Cell walking function add new parameter for including deleted reference. Type 90 to match only deleted reference  </li>
	<li> <a href="#HasSpell">HasSpell</a>, <a href="#IsClassSkill ">IsClassSkill</a>, <a href="#GetActorLightAmount">GetActorLightAmount</a>, IsDiseased,IsMajorRef added as conditional functions  </li>
...
<p><a id="IsRefEssential" class="f" href="https://cs.uesp.net/wiki/IsRefEssential">IsRefEssential</a> - returns whether the referenced actor is essential<br />
<code class="s">(isEssential:bool) reference.IsRefEssential</code></p>

<p><a id="SetRefEssential" class="f" href="https://cs.uesp.net/wiki/SetRefEssential">SetRefEssential</a> - sets the calling ref to be essential or not<br />
...
<p><a id="GetActorLightAmount" class="f" href="https://cs.uesp.net/wiki/GetActorLightAmount">GetActorLightAmount</a> - returns a float describing the amount of light falling on an actor, or 100 if the actor is not in high/medium-high process.<br />
...
<p><a id="CanCorpseCheck" class="f" href="https://cs.uesp.net/wiki/CanCorpseCheck">CanCorpseCheck</a> - returns 1 if the Can Corpse Check flag is set on the actor<br />
<code class="s">(canCorpseCheck:bool) <span class="op">reference.</span>CanCorpseCheck <span class="op">actor:ref</span></code></p>

<p><a id="SetCanCorpseCheck" class="f" href="https://cs.uesp.net/wiki/SetCanCorpseCheck">SetCanCorpseCheck</a> - changes the Can Corpse Check flag on the actor<br />
<code class="s">(nothing) <span class="op">reference.</span>SetCanCorpseCheck flag:int <span class="op">actor:ref</span></code></p>

<p><a id="GetActorMinLevel" class="f" href="https://cs.uesp.net/wiki/GetActorMinLevel">GetActorMinLevel</a> - returns the minimum level of the actor if the PC Level Offset flag is set<br />
...
<p><a id="GetActorMaxLevel" class="f" href="https://cs.uesp.net/wiki/GetActorMaxLevel">GetActorMaxLevel</a> - returns the maximum level of the actor if the PC Level Offset flag is set<br />
...
<p><a id="GetNumFactions" class="f" href="https://cs.uesp.net/wiki/GetNumFactions">GetNumFactions</a> - returns the number of factions to which the actor belongs<br />
<code class="s">(numFactions:int) <span class="op">reference.</span>GetNumFactions <span class="op">actor:ref</span></code></p>

<p><a id="GetNthFaction" class="f" href="https://cs.uesp.net/wiki/GetNthFaction">GetNthFaction</a> - returns the nth faction to which the actor belongs<br />
...
<p><a id="GetActorSoulLevel" class="f" href="https://cs.uesp.net/wiki/GetActorSoulLevel">GetActorSoulLevel</a> - returns the soul level of any actor. If an NPC it returns Grand, otherwise if a creature it returns the creature's soul level.<br />
...
<p><a id="HasLowLevelProcessing" class="f" href="https://cs.uesp.net/wiki/HasLowLevelProcessing">HasLowLevelProcessing</a> - returns 1 if the actor has low level processing enabled<br />
<code class="s">(hasLowProc:bool) <span class="op">reference.</span>HasLowLevelProcessing <span class="op">actor:ref</span></code></p>

<p><a id="HasNoPersuasion" class="f" href="https://cs.uesp.net/wiki/HasNoPersuasion">HasNoPersuasion</a> - returns 1 if the No Persuasion flag is set on the actor<br />
<code class="s">(hasNoPers:bool) <span class="op">reference.</span>HasNoPersuasion <span class="op">actor:ref</span></code></p>

<p><a id="SetNoPersuasion" class="f" href="https://cs.uesp.net/wiki/SetNoPersuasion">SetNoPersuasion</a> - changes the No Persuasion flag on the actor<br />
<code class="s">(nothing) <span class="op">reference.</span>SetNoPersuasion flag:int <span class="op">actor:ref</span></code></p>

<p><a id="IsActorRespawning" class="f" href="https://cs.uesp.net/wiki/IsActorRespawning">IsActorRespawning</a> - returns 1 if the Respawn flag is set on the actor<br />
<code class="s">(respawns:bool) <span class="op">reference.</span>IsActorRespawning <span class="op">actor:ref</span></code></p>

<p><a id="IsPCLevelOffset" class="f" href="https://cs.uesp.net/wiki/IsPCLevelOffset">IsPCLevelOffset</a> - returns 1 if the actor's level is calculated relative to the player's level<br />
<code class="s">(isLevOffset:bool) <span class="op">reference.</span>IsPCLevelOffset <span class="op">actor:ref</span></code></p>

<p><a id="GetActorBaseLevel" class="f" href="https://cs.uesp.net/wiki/GetActorBaseLevel">GetActorBaseLevel</a> - returns the level of the base actor. In the editor, for creatures this is the "Level Offset" field; for NPCs it is the "Level" field. For either, the meaning of the return value depends on whether or not the PC Level Offset flag is set for the base actor.<br />
<code class="s">(level:int) <span class="op">reference.</span>GetActorBaseLevel <span class="op">actorBase:ref</span></code></p>

<p><a id="IsSummonable" class="f" href="https://cs.uesp.net/wiki/IsSummonable">IsSummonable</a> - returns 1 if the Summonable flag is set on the actor<br />
<code class="s">(isSummonable:bool) <span class="op">reference.</span>IsSummonable <span class="op">actor:ref</span></code></p>

<p><a id="SetSummonable" class="f" href="https://cs.uesp.net/wiki/SetSummonable">SetSummonable</a> - changes the Summonable flag on the actor<br />
<code class="s">(nothing) <span class="op">reference.</span>SetSummonable flag:int <span class="op">actor:ref</span></code></p>

<p><a id="SetActorRespawns" class="f" href="https://cs.uesp.net/wiki/SetActorRespawns">SetActorRespawns</a> - changes the Respawn flag on the actor<br />
<code class="s">(nothing) <span class="op">reference.</span>SetActorRespawns flag:int <span class="op">actor:ref</span></code></p>

<p><a id="SetFemale" class="f" href="https://cs.uesp.net/wiki/SetFemale">SetFemale</a> - changes the Female flag on the actor. Changes are saved but may not be immediately visible.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetFemale flag:int <span class="op">actor:ref</span></code></p>

<p><a id="SetLowLevelProcessing" class="f" href="https://cs.uesp.net/wiki/SetLowLevelProcessing">SetLowLevelProcessing</a> - turns low level processing on or off for the actor. Note that this sets the No Low Level Processing flag to the opposite of the passed value.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetLowLevelProcessing flag:int <span class="op">actor:ref</span></code></p>

<p><a id="SetPCLevelOffset" class="f" href="https://cs.uesp.net/wiki/SetPCLevelOffset">SetPCLevelOffset</a> - changes the PC Level Offset flag on the actor, and optionally specifies the minimum andmaximum levels. If minLevel or maxLevel is omitted or passed as -1, the existing value will be retained.<br />
...
<p><a id="GetNumPackages" class="f" href="https://cs.uesp.net/wiki/GetNumPackages">GetNumPackages</a> - returns the number of AI packages in the actor's package list<br />
<code class="s">(numPackages:int) <span class="op">reference.</span>GetNumPackages <span class="op">actor:ref</span></code></p>

<p><a id="GetNthPackage" class="f" href="https://cs.uesp.net/wiki/GetNthPackage">GetNthPackage</a> - returns the Nth AI package in the NPC's package list, in the order in which they were added in the editor.<br />
...
<p><a id="HasSpell" class="f" href="https://cs.uesp.net/wiki/HasSpell">HasSpell</a> - returns whether the actor has the specified spell<br />
...
<p><a id="IsDiseased" class="f" href="https://cs.uesp.net/wiki/IsDiseased">IsDiseased</a> - returns whether the actor has a disease<br />
<code class="s">(isDiseased:bool) reference.IsDiseased</code></p>

<p><a id="RemoveBaseSpell" class="f" href="https://cs.uesp.net/wiki/RemoveBaseSpell">RemoveBaseSpell</a> - the game's RemoveSpell removes a spell from a base actor but must be called on a reference. This command does the same thing as RemoveSpell but takes a base object as an argument, returning 1 if the spell was removed.<br />
<code class="s">(bRemoved:bool) RemoveBaseSpell actor:ref</code></p>

<p><a id="GetLeveledSpells" class="f" href="https://cs.uesp.net/wiki/GetLeveledSpells">GetLeveledSpells</a> - returns an Array containing all of the leveled spells in the base actor's spell list.<br />
<code class="s">(spells:Array) <span class="op">reference.</span>GetLeveledSpells <span class="op">actorBase:ref</span></code></p>

<p><a id="GetActorPackages" class="f" href="https://cs.uesp.net/wiki/GetActorPackages">GetActorPackages</a> - returns an Array containing the AI packages defined in the base actor's package list, in the order in which they are listed in the editor.<br />
<code class="s">(packages:Array) <span class="op">reference.</span>GetActorPackages <span class="op">actorBase:ref</span></code></p>

<p><a id="GetCurrentPackage" class="f" href="https://cs.uesp.net/wiki/GetCurrentPackage">GetCurrentPackage</a> - returns the actor ref's currently executing package<br />
<code class="s">(package:ref) reference.GetCurrentPackage</code></p>

<p><a id="GetCurrentPackageProcedure" class="f" href="https://cs.uesp.net/wiki/GetCurrentPackageProcedure">GetCurrentPackageProcedure</a> - returns the name of the <a href="#Package_Procedures">AI procedure</a> currently being executed by the calling actor, or "NONE".<br />
<code class="s">(procedure:string) reference.GetCurrentPackageProcedure</code></p>

<p><a id="GetCurrentEditorPackage" class="f" href="https://cs.uesp.net/wiki/GetCurrentEditorPackage">GetCurrentEditorPackage</a> - returns the actor ref's executing non-dynamic package<br />
<code class="s">(package:ref) reference.GetCurrentEditorPackage</code></p>

<p><a id="EquipItem2" class="f" href="https://cs.uesp.net/wiki/EquipItem2">EquipItem2</a> - duplicates the behavior of the vanilla <code>EquipItem</code> command, but also causes the object's <code>OnEquip</code> script block to run if one exists<br />
<code class="s">(nothing) ref.EquipItem2 item:ref lockEquip:bool</code></p>

<p><a id="EquipItem2NS" class="f" href="https://cs.uesp.net/wiki/EquipItem2NS">EquipItem2NS</a> - behaves identically to <code>EquipItem2</code>, but suppresses the UI message generated by that command<br />
<code class="s">(nothing) ref.EquipItem2NS item:ref lockEquip:bool</code></p>

<p><a id="GetSpecialAnims" class="f" href="https://cs.uesp.net/wiki/GetSpecialAnims">GetSpecialAnims</a> - returns an Array containing the filenames of any special animations for the actor. Animations for creatures, and those in the SpecialAnims folder for NPCs, can be toggled on and off in the actor's animation list in the editor.<br />
<code class="s">(anims:Array) <span class="op">reference.</span>GetSpecialAnims <span class="op">actorBase:ref</span></code></p>

<p><a id="ToggleSpecialAnim" class="f" href="https://cs.uesp.net/wiki/ToggleSpecialAnim">ToggleSpecialAnim</a> - adds or removes an animation from the base actor's animation list. For creatures, the animations must appear in the creature's model folder; for NPCs they must be located in the Special Anims folder. Changes made using this command have no effect on the animations of reference's to the base actor which are currently in middle-high or high process.<br />
...
<p><a id="GetGroundSurfaceMaterial" class="f" href="https://cs.uesp.net/wiki/GetGroundSurfaceMaterial">GetGroundSurfaceMaterial</a> - returns the <a href="#Surface_Type">surface type</a> that the actor ref is currently standing on. Returns -1 if the ref is not in middle-high or high process.<br />
<code class="s">(surfaceType:int) <span class="op">reference.</span>GetGroundSurfaceMaterial</code></p>

<p><a id="GetFactions" class="f" href="https://cs.uesp.net/wiki/GetFactions">GetFactions</a> - returns an array containing the factions the calling ref or base actor is a member of.<br />
<code class="s">(factions:Array) <span class="op">reference.</span>GetFactions <span class="op">actorBase:ref</span></code></p>

<p><a id="GetActorSwimBreath" class="f" href="https://cs.uesp.net/wiki/GetActorSwimBreath">GetActorSwimBreath</a> - returns the calling high process actor's swimming breath level in seconds.<br />
<code class="s">(breathLevel:float) <span class="op">reference.</span>GetActorSwimBreath</code></p>

<p><a id="SetActorSwimBreath" class="f" href="https://cs.uesp.net/wiki/SetActorSwimBreath">SetActorSwimBreath</a> - sets the calling high process actor's swimming breath level.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetActorSwimBreath newBreath:float</code></p>

<p><a id="GetActorMaxSwimBreath" class="f" href="https://cs.uesp.net/wiki/GetActorMaxSwimBreath">GetActorMaxSwimBreath</a> - returns the calling high process actor's maximum swimming breath level  in seconds.<br />
<code class="s">(breathLevel:float) <span class="op">reference.</span>GetActorMaxSwimBreath</code></p>

<p><a id="SetActorMaxSwimBreath" class="f" href="https://cs.uesp.net/wiki/SetActorMaxSwimBreath">SetActorMaxSwimBreath</a> - sets the calling high process actor's maximum swimming breath level. Overrides are automatically cleared when the actor leaves the high process AI processing band.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetActorMaxSwimBreath newBreath:float</code></p>

<p><a id="OverrideActorSwimBreath" class="f" href="https://cs.uesp.net/wiki/OverrideActorSwimBreath">OverrideActorSwimBreath</a> - overrides the <a href="#Swim_Breath_State">swimming breath behaviour</a> of the calling high process actor. Overridden actors will revert to their normal behaviour when they leave the high process AI processing band.<br />
...
<p>Actor values are determined by several factors including the attributes defined for the base actor, several dynamic modifiers, and the effects of game settings. For a detailed description of how actor values are calculated see the <a href="https://cs.uesp.net/wiki/Category:Actor_Values">wiki entry</a>. OBSE provides commands to retrieve and modify the modifiers applied to an actor value, retrieve the actor value as defined for a base actor, and retrieve the maximum value of an actor value.</p>
<p><a id="GetAVMod" class="f" href="https://cs.uesp.net/wiki/GetAVMod">GetAVMod</a> - returns one of the calling actor's modifiers for the specified actor value. The modifier is specified as a string: "script" refers to the script (or "offset") modifier applied by the <strong>script</strong> versions of ModAV and ForceAV; "max" refers to the modifier applied by magic effects like feather, drain, and fortify; and "damage" refers to that applied by effects like damage and restore, and by the <strong>console</strong> version of ModAV/ForceAV as well as ModAV2.<br />
...
<p><a id="ModAVMod" class="f" href="https://cs.uesp.net/wiki/ModAVMod">ModAVMod</a> - modifies the value of one of the calling actor's modifiers for the specified actor value by the specified amount. The modifier is specified as a string: "script" refers to the script (or "offset") modifier applied by the <strong>script</strong> versions of ModAV and ForceAV; "max" refers to the modifier applied by magic effects like feather, drain, and fortify; and "damage" refers to that applied by effects like damage and restore, and by the <strong>console</strong> version of ModAV/ForceAV as well as ModAV2.<br />
...
<p><a id="GetMaxAV" class="f" href="https://cs.uesp.net/wiki/GetMaxAV">GetMaxAV</a> - returns the maximum possible value of the specified actor value for the calling actor.<br />
...
<p><a id="GetAVForBaseActor" class="f" href="https://cs.uesp.net/wiki/GetAVForBaseActor">GetAVForBaseActor</a> - returns the value of the specified actor value as defined for the base actor. If the second argument is omitted, the base object for the calling actor is used. Note that not all actor values are defined for base actors, in which case this command returns 0.<br />
...
<p><a id="GetActorValueC" class="f" href="https://cs.uesp.net/wiki/GetActorValueC">GetActorValueC</a> - returns the actor value specified by the actor value code<br />
...
<p><a id="ModActorValueC" class="f" href="https://cs.uesp.net/wiki/ModActorValueC">ModActorValueC</a> - modifies the actor value without changing the base value. Acts like a spell: a negative number reduces the value which can be restored and a positive value restores values without exceeding the maximum of the stat.<br />
...
<p><a id="SetActorValueC" class="f" href="https://cs.uesp.net/wiki/SetActorValueC">SetActorValueC</a> - sets the actor value specified by the actor value code<br />
...
<p><a id="ModActorValue2" class="f" href="https://cs.uesp.net/wiki/ModActorValue2">ModActorValue2</a> - modifies the current value without changing the base value. Acts like a spell: a negative number reduces the value which can be restored and a positive value restores values without exceeding the maximum of the stat.<br />
...
<p><a id="GetLuckModifiedSkill" class="f" href="https://cs.uesp.net/wiki/GetLuckModifiedSkill">GetLuckModifiedSkill</a> - the game applies a modifier to all skills based on an actor's luck attribute. This command takes an actual skill value and a luck attribute value and calculates the effective level of the skill after the luck modifier has been applied. The third parameter can be used to return an uncapped value - The result is capped at 100 by default.<br />
<code class="s">(modifiedSkill:int) GetLuckModifiedSkill skillLevel:int luck:int <span class="op">capped:bool</span></code></p>

<p><a id="GetAVSkillMasteryLevel" class="f" href="https://cs.uesp.net/wiki/GetAVSkillMasteryLevel">GetAVSkillMasteryLevel</a> - returns the current mastery level of an actor's skill. The mastery level is an integer from 0 (Novice) to 4 (Master).<br />
<code class="s">(masteryLevel:int) reference.GetAVSkillMasteryLevel skill:actorValue </code></p>

<p><a id="GetAVSkillMasteryLevelC" class="f" href="https://cs.uesp.net/wiki/GetAVSkillMasteryLevelC">GetAVSkillMasteryLevelC</a> - alternate version of GetAVSkillMasteryLevel taking an actor value for the skill.<br />
...
<p><a id="GetAttackDamage" class="f" href="https://cs.uesp.net/wiki/GetAttackDamage">GetAttackDamage</a> - returns the base attack damage<br />
<code class="s">(damage:int) <span class="op">reference.</span>GetAttackDamage <span class="op">objectID:ref</span></code></p>

<p><a id="SetAttackDamage" class="f" href="https://cs.uesp.net/wiki/SetAttackDamage">SetAttackDamage</a> - sets the base attack damage<br />
<code class="s">(nothing) <span class="op">reference.</span>SetAttackDamage nuDamage:int <span class="op">objectID:ref</span></code></p>

<p><a id="ModAttackDamage" class="f" href="https://cs.uesp.net/wiki/ModAttackDamage">ModAttackDamage</a> - modifies the base attack damage up or down<br />
<code class="s">(nothing) <span class="op">reference.</span>ModAttackDamage modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetWeaponSpeed" class="f" href="https://cs.uesp.net/wiki/GetWeaponSpeed">GetWeaponSpeed</a> - returns the weapon speed<br />
<code class="s">(speed:float) <span class="op">reference.</span>GetWeaponSpeed <span class="op">objectID:ref</span></code></p>

<p><a id="SetWeaponSpeed" class="f" href="https://cs.uesp.net/wiki/SetWeaponSpeed">SetWeaponSpeed</a> - sets the weapon speed<br />
<code class="s">(nothing) <span class="op">reference.</span>SetWeaponSpeed nuSpeed:float <span class="op">obejctID:ref</span></code></p>

<p><a id="ModWeaponSpeed" class="f" href="https://cs.uesp.net/wiki/ModWeaponSpeed">ModWeaponSpeed</a> - modifies the weapon speed up or down<br />
<code class="s">(nothing) <span class="op">reference.</span>ModWeaponSpeed modifyBy:float <span class="op">obejctID:ref</span></code></p>

<p><a id="GetIgnoresResistance" class="f" href="https://cs.uesp.net/wiki/GetIgnoresResistance">GetIgnoresResistance</a> - returns whether the object ignores normal damage resistance<br />
<code class="s">(ignores:bool) <span class="op">reference.</span>GetIgnoresResistance <span class="op">objectID:ref</span></code></p>

<p><a id="SetIgnoresResistance" class="f" href="https://cs.uesp.net/wiki/SetIgnoresResistance">SetIgnoresResistance</a> - sets whether the object ignores normal damage resistance<br />
...
<p><a id="GetOpenSound" class="f" href="https://cs.uesp.net/wiki/GetOpenSound">GetOpenSound</a> - Returns the "open" sound<br />
<code class="s">(sound:ref) <span class="op">reference.</span>GetOpenSound <span class="op">baseObject:ref</span></code></p>

<p><a id="GetCloseSound" class="f" href="https://cs.uesp.net/wiki/GetCloseSound">GetCloseSound</a> - Returns the "close" sound<br />
<code class="s">(sound:ref) <span class="op">reference.</span>GetCloseSound <span class="op">baseObject:ref</span></code></p>

<p><a id="GetLoopSound" class="f" href="https://cs.uesp.net/wiki/GetLoopSound">GetLoopSound</a> - Returns the looping sound<br />
<code class="s">(sound:ref) <span class="op">reference.</span>GetLoopSound <span class="op">baseObject:ref</span></code></p>

<p><a id="SetOpenSound" class="f" href="https://cs.uesp.net/wiki/SetOpenSound">SetOpenSound</a> - Sets the "open" sound<br />
<code class="s">(nothing) <span class="op">reference.</span>SetOpenSound sound:ref <span class="op">baseObject:ref</span></code></p>

<p><a id="SetCloseSound" class="f" href="https://cs.uesp.net/wiki/SetCloseSound">SetCloseSound</a> - Sets the "close" sound<br />
<code class="s">(nothing) <span class="op">reference.</span>SetCloseSound sound:ref <span class="op">baseObject:ref</span></code></p>

<p><a id="SetLoopSound" class="f" href="https://cs.uesp.net/wiki/SetLoopSound">SetLoopSound</a> - Sets the looping sound<br />
...
<p><a id="GetObjectHealth" class="f" href="https://cs.uesp.net/wiki/GetObjectHealth">GetObjectHealth</a> - returns the base object health<br />
<code class="s">(health:int) <span class="op">reference.</span>GetObjectHealth <span class="op">objectID:ref</span></code></p>

<p><a id="SetObjectHealth" class="f" href="https://cs.uesp.net/wiki/SetObjectHealth">SetObjectHealth</a> - sets the base object health<br />
<code class="s">(nothing) <span class="op">reference.</span>SetObjectHealth nuHealth:int <span class="op">objectID:ref</span></code></p>

<p><a id="ModObjectHealth" class="f" href="https://cs.uesp.net/wiki/ModObjectHealth">ModObjectHealth</a>  - modifies the base object health up or down<br />
<code class="s">(nothing) <span class="op">reference.</span>ModObjectHealth modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetCurrentHealth" class="f" href="https://cs.uesp.net/wiki/GetCurrentHealth">GetCurrentHealth</a> - returns the current health of the calling reference<br />
<code class="s">(health:float) reference.GetCurrentHealth</code></p>

<p><a id="SetCurrentHealth" class="f" href="https://cs.uesp.net/wiki/SetCurrentHealth">SetCurrentHealth</a> - sets the current health of the calling reference<br />
<code class="s">(nothing) reference.SetCurrentHealth nuHealth:float</code></p>

<p><a id="GetEquippedCurrentHealth" class="f" href="https://cs.uesp.net/wiki/GetEquippedCurrentHealth">GetEquippedCurrentHealth</a> -  gets the current health of the object in the specified equipment slot<br />
<code class="s">(health:float) reference.GetEquippedCurrentHealth <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="SetEquippedCurrentHealth" class="f" href="https://cs.uesp.net/wiki/SetEquippedCurrentHealth">SetEquippedCurrentHealth</a> - sets the current health of the object in the specified equipment slot<br />
<code class="s">(nothing) reference.SetEquippedCurrentHealth nuHealth:int <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="ModEquippedCurrentHealth" class="f" href="https://cs.uesp.net/wiki/ModEquippedCurrentHealth">ModEquippedCurrentHealth</a> - modifies the current health of the object in the specified equipment slot up or down <br />
...
<p><a id="GetClass" class="f" href="https://cs.uesp.net/wiki/GetClass">GetClass</a> - returns the class of the NPC <br />
<code class="s">(class:ref) <span class="op">reference.</span>GetClass <span class="op">npc:ref</span></code></p>

<p><a id="GetClassAttribute" class="f" href="https://cs.uesp.net/wiki/GetClassAttribute">GetClassAttribute</a> - returns the Nth attribute of the class. If called on a reference it will attempt to find the class from that referenced NPC and use that. If a class FormID is passed, that takes precedence.<br />
...
<p><a id="GetClassSkill" class="f" href="https://cs.uesp.net/wiki/GetClassSkill">GetClassSkill</a> - returns the Nth skill of the class. If called on a reference it will attempt to find the class from that referenced NPC and use that. If a class FormID is passed, that takes precedence.<br />
...
<p><a id="GetClassSpecialization" class="f" href="https://cs.uesp.net/wiki/GetClassSpecialization">GetClassSpecialization</a> - returns the class specialization. If called on a reference it will attempt to find the class from that referenced NPC and use that. If a class FormID is passed, that takes precedence.<br />
...
<p><a id="IsClassSkill" class="f" href="https://cs.uesp.net/wiki/IsClassSkill">IsClassSkill</a> - returns whether the passed skill is a skill of the class. If called on a reference it will attempt to find the class from that referenced NPC and use that. If a class FormID is passed, that takes precedence.<br />
...
<p><a id="IsMajorRef" class="f" href="https://cs.uesp.net/wiki/IsMajorRef">IsMajorRef</a> - returns whether the passed skill is a skill of the class of the called on a reference.<br />
<code class="s">(isClassSkill:bool) reference.IsMajorRef skill:string</code></p>

<p><a id="IsClassSkillC" class="f" href="https://cs.uesp.net/wiki/IsClassSkill">IsClassSkillC</a> - alternate version of IsClassSkill taking a skill code instead of the name of a skill.<br />
...
<p><a id="IsClassAttribute" class="f" href="https://cs.uesp.net/wiki/IsClassAttribute">IsClassAttribute</a> - returns whether the passed attribute is an attribute of the class. If called on a reference it will attempt to find the class from that referenced NPC and use that. If a class FormID is passed, that takes precedence. (available in v0011)<br />
...
<p><a id="IsClassAttributeC" class="f" href="https://cs.uesp.net/wiki/IsClassAttribute">IsClassAttributeC</a> - alternate version of <code>IsClassAttribute</code> taking an actor value code instead of the name of an actor value<br />
...
<p><a id="GetClassSkills" class="f" href="https://cs.uesp.net/wiki/GetClassSkills">GetClassSkills</a> - returns an Array containing the seven major skills associated with the class. If the parameter is omitted, the class of the calling NPC is used.<br />
<code class="s">(skills:Array) <span class="op">reference.</span>GetClassSkills <span class="op">class:ref</span></code></p>

<p><a id="SetClassSkills" class="f" href="https://cs.uesp.net/wiki/SetClassSkills">SetClassSkills</a> - accepts an Array of seven different skill codes and sets them as the class's major skills. If fewer or more than seven skills are found in the array or duplicate skills are found, the function will return zero with no changes made to the class. If the class argument is omitted, the calling NPC's class is used.<br />
...
<p><a id="SetClassSkills2" class="f" href="https://cs.uesp.net/wiki/SetClassSkills2">SetClassSkills2</a> - Identical to SetClassSkills, except it allows duplicate skills.<br />
...
<p><a id="SetClassSpecialization" class="f" href="https://cs.uesp.net/wiki/SetClassSpecialization">SetClassSpecialization</a> - sets the class specialization. If the class argument is omitted thecalling NPC's class is used.<br />
...
<p><a id="SetClassAttribute" class="f" href="https://cs.uesp.net/wiki/SetClassAttribute">SetClassAttribute</a> - sets one of the two favored attributes for the class. Both class attributes must be unique. If the class argument is omitted the calling NPC's class is used.<br />
...
<p><a id="SetClassAttributeC" class="f" href="https://cs.uesp.net/wiki/SetClassAttributeC">SetClassAttributeC</a> - as SetClassAttribute but takes an actor value code instead of an actor value string.<br />
...
<p><a id="GetNumItems" class="f" href="https://cs.uesp.net/wiki/GetNumItems">GetNumItems</a> - returns the number of different object types in the container or actor's inventory.<br />
...
<p><a id="GetInventoryObject" class="f" href="https://cs.uesp.net/wiki/GetInventoryObject">GetInventoryObject</a> - returns the objectID of the Nth item type in the container or actor's inventory<br />
...
<p><a id="IsContainer" class="f" href="https://cs.uesp.net/wiki/IsContainer">IsContainer</a> - returns whether the reference or passed objectID is a container.<br />
...
<p><a id="GetContainerRespawns" class="f" href="https://cs.uesp.net/wiki/GetContainerRespawns">GetContainerRespawns</a> - returns whether the container's contents repawn.<br />
...
<p><a id="SetContainerRespawns" class="f" href="https://cs.uesp.net/wiki/SetContainerRespawns">SetContainerRespawns</a> - sets whether the container's contents respawn.<br />
...
<p><a id="GetItems" class="f" href="https://cs.uesp.net/wiki/GetItems">GetItems</a> - returns an Array containing all of the items in a container's or actor's inventory. Up to 10 form types may be passed in to restrict the returned items to only include items matching those type(s).<br />
<code class="s">(items:Array) reference.GetItems <span class="op">type1:int type2:int ... type10:int</span></code></p>

<p><a id="GetBaseItems" class="f" href="https://cs.uesp.net/wiki/GetBaseItems">GetBaseItems</a> - returns an Array of StringMaps containing the items present in a base container or actor's inventory and the quantity of each. These are the items added to the base object in the editor and may include leveled items. Some, all, or none of the items may be present in the inventory of a specific reference to the base object. Each element of the returned Array is a StringMap with two elements:<br />
...
<p><a id="IsFood" class="f" href="https://cs.uesp.net/wiki/IsFood">IsFood</a> - returns whether the object is considered to be food<br />
<code class="s">(isFood:bool) <span class="op">reference</span>.IsFood <span class="op">objectID:ref</span></code></p>

<p><a id="SetIsFood" class="f" href="https://cs.uesp.net/wiki/SetIsFood">SetIsFood</a> - sets whether the object is considered to be food<br />
...
<p><a id="GetEnchantment" class="f" href="https://cs.uesp.net/wiki/GetEnchantment">GetEnchantment</a> - returns the specific enchantment on the object<br />
<code class="s">(enchantment:ref) <span class="op">reference.</span>GetEnchantment <span class="op">objectID:ref</span></code></p>

<p><a id="SetEnchantment" class="f" href="https://cs.uesp.net/wiki/SetEnchantment">SetEnchantment</a> - sets the specific enchantment on the object and returns any previous enchantment<br />
...
<p><a id="RemoveEnchantment" class="f" href="https://cs.uesp.net/wiki/RemoveEnchantment">RemoveEnchantment</a> - removes the enchantment from the object and returns any previous enchantment<br />
<code class="s">(oldEnchantment:ref) <span class="op">reference.</span>RemoveEnchantment <span class="op">objectID:ref</span></code></p>

<p><a id="GetObjectCharge" class="f" href="https://cs.uesp.net/wiki/GetObjectCharge">GetObjectCharge</a> - returns the max charge of the object<br />
<code class="s">(charge:int) <span class="op">reference.</span>GetObjectCharge <span class="op">objectID:ref</span></code></p>

<p><a id="SetObjectCharge" class="f" href="https://cs.uesp.net/wiki/SetObjectCharge">SetObjectCharge</a> - sets the max charge of the object<br />
<code class="s">(nothing) <span class="op">reference</span>.SetObjectCharge nuCharge:int <span class="op">objectID:ref</span></code></p>

<p><a id="ModObjectCharge" class="f" href="https://cs.uesp.net/wiki/ModObjectCharge">ModObjectCharge</a> - modifies the max charge of the object up or down<br />
<code class="s">(nothing) <span class="op">reference</span>.ModObjectCharge modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetCurrentCharge" class="f" href="https://cs.uesp.net/wiki/GetCurrentCharge">GetCurrentCharge</a> - returns the current charge of the calling reference<br />
<code class="s">(charge:float) <span class="op">reference.</span>GetCurrentCharge</code></p>

<p><a id="GetEquippedCurrentCharge" class="f" href="https://cs.uesp.net/wiki/GetEquippedCurrentCharge">GetEquippedCurrentCharge</a> - returns the current charge of the object in the specified slot<br />
<code class="s">(charge:float) reference.GetEquippedCurrentCharge <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="SetEquippedCurrentCharge" class="f" href="https://cs.uesp.net/wiki/SetEquippedCurrentCharge">SetEquippedCurrentCharge</a> - sets the current charge of the object in the specified slot<br />
<code class="s">(nothing) reference.SetEquippedCurrentCharge nuCharge:int <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="ModEquippedCurrentCharge" class="f" href="https://cs.uesp.net/wiki/ModEquippedCurrentCharge">ModEquippedCurrentCharge</a> - modifies the current charge of the object in the specified slot up or down<br />
<code class="s">(nothing) reference.ModEquippedCurrentCharge modifyBy:float <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="SetCurrentCharge" class="f" href="https://cs.uesp.net/wiki/SetCurrentCharge">SetCurrentCharge</a> - sets the current charge of the calling reference if it is less than or equal to the maximum charge<br />
<code class="s">(nothing) reference.SetCurrentCharge newCharge:int</code></p>

<p><a id="ModCurrentCharge" class="f" href="https://cs.uesp.net/wiki/ModCurrentCharge">ModCurrentCharge</a> - modifies the current charge of the calling reference by the specified amount. Will not modify the charge past its maximum or below zero.<br />
...
<p><a id="GetEquipmentSlot" class="f" href="https://cs.uesp.net/wiki/GetEquipmentSlot">GetEquipmentSlot</a> - returns the equipment slot or slots taken by the object<br />
...
<p><a id="SetEquipmentSlot" class="f" href="https://cs.uesp.net/wiki/SetEquipmentSlot">SetEquipmentSlot</a> - sets the equipment slot or slots taken by the object.<br />
...
<p><a id="UnequipMe" class="f" href="https://cs.uesp.net/wiki/UnequipMe">UnequipMe</a> - when called on an object in an actor's inventory, attempts to unequip the object on the actor and runs the object's <code>OnUnequip</code> script block if applicable<br />
...
<p><a id="GetBaseObject" class="f" href="https://cs.uesp.net/wiki/GetBaseObject">GetBaseObject</a> - returns the base object of the reference.<br />
...
<p><a id="GetObjectType" class="f" href="https://cs.uesp.net/wiki/GetObjectType">GetObjectType</a> - returns a type code for each type of object.<br />
...
<p><a id="IsWeapon" class="f" href="https://cs.uesp.net/wiki/IsWeapon">IsWeapon</a> - returns whether the object is a weapon.<br />
<code class="s">(isWeapon:bool) <span class="op">reference.</span>IsWeapon <span class="op">objectID:ref</span></code></p>

<p><a id="IsAmmo" class="f" href="https://cs.uesp.net/wiki/IsAmmo">IsAmmo</a> - returns whether the object is ammunition.<br />
<code class="s">(isAmmo:bool) <span class="op">reference.</span>IsAmmo <span class="op">objectID:ref</span></code></p>

<p><a id="IsArmor" class="f" href="https://cs.uesp.net/wiki/IsArmor">IsArmor</a> - returns whether the object is armor.<br />
<code class="s">(isArmor:bool) <span class="op">reference.</span>IsArmor <span class="op">objectID:ref</span></code></p>

<p><a id="IsBook" class="f" href="https://cs.uesp.net/wiki/IsBook">IsBook</a> - returns whether the object is a book.<br />
<code class="s">(isBook:bool) <span class="op">reference.</span>IsBook <span class="op">objectID:ref</span></code></p>

<p><a id="IsClothing" class="f" href="https://cs.uesp.net/wiki/IsClothing">IsClothing</a> - returns whether the object is clothing.<br />
<code class="s">(isClothing:bool) <span class="op">reference.</span>IsClothing <span class="op">objectID:ref</span></code></p>

<p><a id="IsIngredient" class="f" href="https://cs.uesp.net/wiki/IsIngredient">IsIngredient</a> - returns whether the object is an ingredient.<br />
<code class="s">(isIngredient:bool) <span class="op">reference.</span>IsIngredient <span class="op">objectID:ref</span></code></p>

<p><a id="IsKey" class="f" href="https://cs.uesp.net/wiki/IsKey">IsKey</a> - returns whether the object is a key.<br />
<code class="s">(isKey:bool) <span class="op">reference.</span>IsKey <span class="op">objectID:ref</span></code></p>

<p><a id="IsAlchemyItem" class="f" href="https://cs.uesp.net/wiki/IsAlchemyItem">IsAlchemyItem</a> - returns whether the object is an alchemy item (potion).<br />
...
<p><a id="IsApparatus" class="f" href="https://cs.uesp.net/wiki/IsApparatus">IsApparatus</a> - returns whether the object is an alchemy apparatus.<br />
<code class="s">(isApparatus:bool) <span class="op">reference.</span>IsApparatus <span class="op">objectID:ref</span></code></p>

<p><a id="IsSoulGem" class="f" href="https://cs.uesp.net/wiki/IsSoulGem">IsSoulGem</a> - returns whether the object is a soul gem.<br />
<code class="s">(isSoulGem:bool) <span class="op">reference.</span>IsSoulGem <span class="op">objectID:ref</span></code></p>

<p><a id="IsSigilStone" class="f" href="https://cs.uesp.net/wiki/IsSigilStone">IsSigilStone</a> - returns whether the object is a sigil stone.<br />
<code class="s">(isSigilStone:bool) <span class="op">reference.</span>IsSigilStone <span class="op">objectID:ref</span></code></p>

<p><a id="IsMiscItem" class="f" href="https://cs.uesp.net/wiki/IsMiscItem">IsMiscItem</a> - returns whether the object is a miscellaneous item.<br />
...
<p><a id="IsLight" class="f" href="https://cs.uesp.net/wiki/IsLight">IsLight</a> - returns whether the object is a light source.<br />
<code class="s">(isLight:bool) <span class="op">reference.</span>IsLight <span class="op">objectID:ref</span></code></p>

<p><a id="IsFlora" class="f" href="https://cs.uesp.net/wiki/IsFlora">IsFlora</a> - returns 1 if the object is a harvestable plant.<br />
<code class="s">(isFlora:bool) <span class="op">reference.</span>IsFlora <span class="op">objectID:ref</span></code></p>

<p><a id="GetWeight" class="f" href="https://cs.uesp.net/wiki/GetWeight">GetWeight</a> - returns the weight of the type.<br />
<code class="s">(weight:float) <span class="op">reference</span>.GetWeight <span class="op">objectID:ref</span></code></p>

<p><a id="SetWeight" class="f" href="https://cs.uesp.net/wiki/SetWeight">SetWeight</a> - sets the weight of the type.<br />
...
<p><a id="ModWeight" class="f" href="https://cs.uesp.net/wiki/ModWeight">ModWeight</a> - modifies the weight of the type up or down.<br />
<code class="s">(nothing) <span class="op">reference.</span>ModWeight modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetGoldValue" class="f" href="https://cs.uesp.net/wiki/GetGoldValue">GetGoldValue</a> - returns the base gold value of the type.<br />
<code class="s">(goldValue:int) <span class="op">reference</span>.GetGoldValue <span class="op">objectID:ref</span></code></p>

<p><a id="GetFullGoldValue" class="f" href="https://cs.uesp.net/wiki/GetFullGoldValue">GetFullGoldValue</a> - returns the full gold value of an item, including the value added by enchantments.<br />
<code class="s">(goldValue:int) <span class="op">reference.</span>GetFullGoldValue <span class="op">objectID:ref</span></code></p>

<p><a id="SetGoldValue" class="f" href="https://cs.uesp.net/wiki/SetGoldValue">SetGoldValue</a> - sets the base gold value of the type.<br />
<code class="s">(nothing) <span class="op">reference</span>.SetGoldValue nuGoldValue:int <span class="op">objectID:ref</span></code></p>

<p><a id="ModGoldValue" class="f" href="https://cs.uesp.net/wiki/ModGoldValue">ModGoldValue</a> - modifies the base gold value of the type up or down.<br />
<code class="s">(nothing) <span class="op">reference</span>.ModGoldValue modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="IsQuestItem" class="f" href="https://cs.uesp.net/wiki/IsQuestItem">IsQuestItem</a> - returns whether the type is a quest item.<br />
<code class="s">(isQuestItem:bool) <span class="op">reference</span>.IsQuestItem <span class="op">objectID:ref</span></code></p>

<p><a id="SetQuestItem" class="f" href="https://cs.uesp.net/wiki/SetQuestItem">SetQuestItem</a> - sets whether the type is a quest item.<br />
<code class="s">(nothing) <span class="op">reference</span>.SetQuestItem isQuestItem:bool <span class="op">objectID:ref</span></code></p>

<p><a id="SetCurrentSoulLevel" class="f" href="https://cs.uesp.net/wiki/SetCurrentSoulLevel">SetCurrentSoulLevel</a> - sets the current soul level of the calling soulgem reference.<br />
...
<p><a id="GetOpenKey" class="f" href="https://cs.uesp.net/wiki/GetOpenKey">GetOpenKey</a> - returns the key used to unlock the calling reference.<br />
...
<p><a id="SetOpenKey" class="f" href="https://cs.uesp.net/wiki/SetOpenKey">SetOpenKey</a> - sets the key used to unlock the reference to the specified key.<br />
...
<p><a id="GetMagicItemType" class="f" href="https://cs.uesp.net/wiki/GetMagicItemType">GetMagicItemType</a> - returns the magic item type.<br />
...
<p><a id="GetMagicItemEffectCount" class="f" href="https://cs.uesp.net/wiki/GetMagicItemEffectCount">GetMagicItemEffectCount</a> -  returns the number of magic effect items.<br />
...
<p><a id="MagicItemHasEffectCount" class="f" href="https://cs.uesp.net/wiki/MagicItemHasEffectCount">MagicItemHasEffectCount</a> - returns the count of the specified effects on the magic item. Has an optional actorValue name for use with effects like fortify skill and fortify attribute.<br />
<code class="s">(effectCount:int) MagicItemHasEffectCount effect:chars magicItem:ref actorValueName:chars</code></p>

<p><a id="MagicItemHasEffectCountCode" class="f" href="https://cs.uesp.net/wiki/MagicItemHasEffectCountCode">MagicItemHasEffectCountCode</a> -  returns the count of effects with the specified effect code on the magic item. Uses a long value returned from <code>GetNthEffectItemCode</code> or <code>GetMagicEffectCode</code>. Has an optional actorValueCode for use with effects like fortify skill and fortify attribute.<br />
...
<p><a id="GetNthEffectItemCode" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemCode">GetNthEffectItemCode</a> - returns the magic effect code of the specified effect item.<br />
...
<p><a id="GetNthEffectItemMagnitude" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemMagnitude">GetNthEffectItemMagnitude</a> - returns the magnitude of the specified effect item.<br />
...
<p><a id="SetNthEffectItemMagnitude" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemMagnitude">SetNthEffectItemMagnitude</a> - sets the magnitude of the specified effect item.<br />
...
<p><a id="ModNthEffectItemMagnitude" class="f" href="https://cs.uesp.net/wiki/ModNthEffectItemMagnitude">ModNthEffectItemMagnitude</a> - modifies the magnitude of the specified effect item up or down.<br />
<code class="s">(nothing) ModNthEffectItemMagnitude modifyBy:float magicItem:ref whichEffect:int</code><br />
<code class="s">(nothing) ModNthEIMagnitude modifyBy:float magicItem:ref whichEffect:int</code></p><p><a id="GetNthEffectItemArea" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemArea">GetNthEffectItemArea</a> - returns the area of the specified effect item.<br />
...
<p><a id="SetNthEffectItemArea" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemArea">SetNthEffectItemArea</a> - sets the area of the specified effect item.<br />
...
<p><a id="ModNthEffectItemArea" class="f" href="https://cs.uesp.net/wiki/ModNthEffectItemArea">ModNthEffectItemArea</a> - modifies the effect area of the specified effect item up or down.<br />
...
<p><a id="GetNthEffectItemDuration" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemDuration">GetNthEffectItemDuration</a> - returns the duration of the specified effect item.<br />
...
<p><a id="SetNthEffectItemDuration" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemDuration">SetNthEffectItemDuration</a> - sets the duration of the specified effect item.<br />
...
<p><a id="ModNthEffectItemDuration" class="f" href="https://cs.uesp.net/wiki/ModNthEffectItemDuration">ModNthEffectItemDuration</a> - modifies the duration of the specified effect item up or down.<br />
...
<p><a id="GetNthEffectItemRange" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemRange">GetNthEffectItemRange</a> - gets the range of the specified effect item.<br />
...
<p><a id="SetNthEffectItemRange" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemRange">SetNthEffectItemRange</a> - sets the range of the specified effect item.<br />
...
<p><a id="GetNthEffectItemActorValue" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemActorValue">GetNthEffectItemActorValue</a> - gets the actor value of the specified effect item.<br />
...
<p><a id="SetNthEffectItemActorValue" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemActorValue">SetNthEffectItemActorValue</a> - sets the actor value of the specified effect item.<br />
...
<p><a id="SetNthEffectItemActorValueC" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemActorValueC">SetNthEffectItemActorValueC</a> - sets the actor value of the specified effect item.<br />
...
<p><a id="RemoveNthEffectItem" class="f" href="https://cs.uesp.net/wiki/RemoveNthEffectItem">RemoveNthEffectItem</a> - removesthe specified effect item.<br />
...
<p><a id="RemoveAllEffectItems" class="f" href="https://cs.uesp.net/wiki/RemoveAllEffectItems">RemoveAllEffectItems</a> - removes all effect items from the magic item.<br />
<b>Note: </b>If a hostile effect is removed from a Spell so that it does not have any left, the Spell will not automatically become non-hostile. Use <code>SetSpellHostile</code> to update the hostility.<br />
<code class="s">(nothing) RemoveAllEffectItems magicItem:ref</code></p>

<p><a id="CopyNthEffectItem" class="f" href="https://cs.uesp.net/wiki/CopyNthEffectItem">CopyNthEffectItem</a> - copies the specified effect item from one magic item to another.<br />
...
<p><a id="CopyAllEffectItems" class="f" href="https://cs.uesp.net/wiki/CopyAllEffectItems">CopyAllEffectItems</a> - copies all effect items from one magic item to another.<br />
<b>Note: </b>When copying a scripted effect, the script, hostility flag, and school will copy, but not the visuals. Copied scripted effects are completely independent of the original scripted effect. <br />
<b>Note: </b>Adding a hostile effect to a Spell which previously had none will not make the Spell hostile. Use <code>SetSpellHostile</code> to update the hostility.<br />
<b>Note: </b>Effects will be added to copied-to magic item, even if that effect is already on the magic item, possibly resulting in two (or more) of the same effects.<br />
<code class="s">(nothing) CopyAllEffectItems fromObjectID:ref toObjectId:ref</code></p>

<p><a id="AddEffectItem" class="f" href="https://cs.uesp.net/wiki/AddEffectItem">AddEffectItem</a> - adds a basic, empty EffectItem of the specified MagicEffect to the magic item.<br />
<b>Note: </b>Adding a hostile effect to a Spell which previously had none will not make the Spell hostile. Use <code>SetSpellHostile</code> to update the hostility.<br />
...
<p><a id="AddFullEffectItem" class="f" href="https://cs.uesp.net/wiki/AddFullEffectItem">AddFullEffectItem</a> - adds a fully defined EffectItem to the magic item with the specified MagicEffect, magnitude, area, duration and range.<br />
<b>Note: </b>Adding a hostile effect to a Spell which previously had none will not make the Spell hostile. Use <code>SetSpellHostile</code> to update the hostility.<br />
...
<p><a id="IsMagicItemAutoCalc" class="f" href="https://cs.uesp.net/wiki/IsMagicItemAutoCalc">IsMagicItemAutoCalc</a> - returns 1 if the MagicItem determines magicka cost by autocalculation. Now works on all Magic Items (Spells, Alchemy, Ingredients, Enchantments).<br />
<code class="s">(isAutocalc:bool) IsMagicItemAutoCalc magicItem:ref</code></p>

<p><a id="SetMagicItemAutoCalc" class="f" href="https://cs.uesp.net/wiki/SetMagicItemAutoCalc">SetMagicItemAutoCalc</a> - sets whether the Magic Item determines cost by autocalculation. Currently works for Spells, AlchemyItems, Ingredients and Enchantments.<br />
<code class="s">(nothing) SetMagicItemAutoCalc isAutocalc:bool objectID:ref</code></p>

<p><a id="IsNthEffectItemScripted" class="f" href="https://cs.uesp.net/wiki/IsNthEffectItemScripted">IsNthEffectItemScripted</a> - returns whether the specified effect item is scripted.<br />
...
<p><a id="GetNthEffectItemScript" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemScript">GetNthEffectItemScript</a> - returns the refID of the script associated with the specified scripted effect.<br />
...
<p><a id="GetNthEffectItemScriptVisualEffect" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemScriptVisualEffect">GetNthEffectItemScriptVisualEffect</a> - returns the magic effect code for the scripted effect item's visual effect.<br />
...
<p><a id="SetNthEffectItemScriptVisualEffect" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemScriptVisualEffect">SetNthEffectItemScriptVisualEffect</a> - sets the scrited effect item's visual effect.<br />
...
<p><a id="GetNthEffectItemScriptSchool" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemScriptSchool">GetNthEffectItemScriptSchool</a> - returns the school of the scripted effect item.<br />
...
<p><a id="SetNthEffectItemScriptSchool" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemScriptSchool">SetNthEffectItemScriptSchool</a> - sets the school of the scripted effect item.<br />
...
<p><a id="IsNthEffectItemScriptHostile" class="f" href="https://cs.uesp.net/wiki/IsNthEffectItemScriptHostile">IsNthEffectItemScriptHostile</a> - returns whether the scripted effect is hostile.<br />
...
<p><a id="SetNthEffectItemScriptHostile" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemScriptHostile">SetNthEffectItemScriptHostile</a> - sets whether the scripted effect is hostile.<br />
...
<p><a id="GetNthEffectItemScriptName" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemScriptName">GetNthEffectItemScriptName</a> - returns the name of the nth effect item, provided that effect item is a script effect.<br />
...
<p><a id="SetNthEffectItemScriptName" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemScriptName">SetNthEffectItemScriptName</a> - sets the name of the scripted effect.<br />
...
<p><a id="SetNthEffectItemScriptNameEX" class="f" href="https://cs.uesp.net/wiki/SetNthEffectItemScriptNameEX">SetNthEffectItemScriptNameEX</a> - sets the name of the scripted effect.<br />
...
<p><a id="MagicItemHasEffectItemScript" class="f" href="https://cs.uesp.net/wiki/MagicItemHasEffectItemScript">MagicItemHasEffectItemScript</a> - returns 1 if the magic effect has a scripted item with the specified script.<br />
<code class="s">(hasScript:bool) MagicItemHasEffectItemScript script:ref magicItem:ref</code></p>

<p><a id="GetNthEffectItemName" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItemName">GetNthEffectItemName</a> - returns the name of the specified active effect, i.e. "Fortify Strength".<br />
...
<p><a id="GetNthEffectItem" class="f" href="https://cs.uesp.net/wiki/GetNthEffectItem">GetNthEffectItem</a> - returns a StringMap fully describing the specified effect item. The StringMap has the following key-value pairs:<br />
<pre>
...
<p><a id="GetActiveEffectCount" class="f" href="https://cs.uesp.net/wiki/GetActiveEffectCount">GetActiveEffectCount</a> - returns the number of ActiveEffects on the target<br />
<code class="s">(count:int) reference.GetActiveEffectCount</code></p>

<p><a id="GetNthActiveEffectCode" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectCode">GetNthActiveEffectCode</a> - returns the effect of the Nth ActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectMagnitude" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectMagnitude">GetNthActiveEffectMagnitude</a> - returns the magnitude of the Nth ActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectDuration" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectDuration">GetNthActiveEffectDuration</a> - returns the total duration of the Nth ActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectTimeElapsed" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectTimeElapsed">GetNthActiveEffectTimeElapsed</a> - returns the time that the Nth ActiveEffect has been applied to the target<br />
...
<p><a id="GetNthActiveEffectMagicItem" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectMagicItem">GetNthActiveEffectMagicItem</a> - returns the magic item which applied theNth ActiveEffect to the target<br />
...
<p><a id="GetNthActiveEffectCaster" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectCaster">GetNthActiveEffectCaster</a> - return the caster of the Nth ActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectData" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectData">GetNthActiveEffectData</a> - return the data of the NthActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectMagicItemIndex" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectMagicItemIndex">GetNthActiveEffectMagicItemIndex</a> - returns the index on its magic item of the Nth ActiveEffect on the target<br />
...
<p><a id="GetNthActiveEffectEnchantObject" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectEnchantObject">GetNthActiveEffectEnchantObject</a> - returns the equipped enchanted object, if any, responsible for the specified active effect<br />
...
<p><a id="SetNthActiveEffectMagnitude" class="f" href="https://cs.uesp.net/wiki/SetNthActiveEffectMagnitude">SetNthActiveEffectMagnitude</a> - sets the magnitude of the corresponding ActiveEffect<br />
...
<p><a id="ModNthActiveEffectMagnitude" class="f" href="https://cs.uesp.net/wiki/ModNthActiveEffectMagnitude">ModNthActiveEffectMagnitude</a> - modifies the magnitude of the corresponding ActiveEffect<br />
...
<p><a id="GetTotalActiveEffectMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalActiveEffectMagnitude">GetTotalActiveEffectMagnitude</a> - returns the total magnitude of all ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAENonAbilityMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAENonAbilityMagnitude">GetTotalAENonAbilityMagnitude</a> - returns the total magnitude of all non-ability ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAEAbilityMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEAbilityMagnitude">GetTotalAEAbilityMagnitude</a> - returns the total magnitude of all ability ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAESpellMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAESpellMagnitude">GetTotalAESpellMagnitude</a> - returns the total magniude of all spell ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAEDiseaseMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEDiseaseMagnitude">GetTotalAEDiseaseMagnitude</a> - returns the total magnitude of all disease ActiveEffects with a given code on the target.<br />
...
<p><a id="GetTotalAELesserPowerMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAELesserPowerMagnitude">GetTotalAELesserPowerMagnitude</a> - returns the total magnitude of all lesser power ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAEPowerMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEPowerMagnitude">GetTotalAEPowerMagnitude</a> - retuns the total magnidue of all greater power ActiveEffects with a given code on the target<br />
...
<p><a id="GetTotalAEAllSpellsMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEAllSpellsMagnitude">GetTotalAEAllSpellsMagnitude</a> - returns the total magnitude of all spells (Spell, Ability, Disease, Lesser Power, Power) with a given code on the target.<br />
...
<p><a id="GetTotalAEEnchantmentMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEEnchantmentMagnitude">GetTotalAEEnchantmentMagnitude</a> - retuns the total magnitude of all enchantments with a given code on the target.<br />
...
<p><a id="GetTotalAEAlchemyMagnitude" class="f" href="https://cs.uesp.net/wiki/GetTotalAEAlchemyMagnitude">GetTotalAEAlchemyMagnitude</a> - returns the total magnitude of all potions with a given code on the target.<br />
...
<p><a id="GetNthActiveEffectBoundItem" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectBoundItem">GetNthActiveEffectBoundItem</a> - returns the base object associated with the specified Bound Item active effect<br />
...
<p><a id="IsNthActiveEffectApplied" class="f" href="https://cs.uesp.net/wiki/IsNthActiveEffectApplied">IsNthActiveEffectApplied</a> - returns 1 if the active effect at the specified index is currently applied to the target. An active effect may exist on the target before its effects are applied (typically for one frame after a spell is cast), in which case this command would return zero.<br />
<code class="s">(isApplied:bool) reference.IsNthActiveEffectApplied whichEffect:short</code></p>

<p><a id="GetNthActiveEffectActorValue" class="f" href="https://cs.uesp.net/wiki/GetNthActiveEffectActorValue">GetNthActiveEffectActorValue</a> - returns the actor value associated with the active effect, if any.<br />
...
<p><a id="CompareNames" class="f" href="https://cs.uesp.net/wiki/CompareNames">CompareNames</a> - compares the names of two objects and returns -1 if the first occurs alphabetically before the second, 1 if the first occurs after the second, or 0 for equality. Comparison is case-insensitive.<br />
...
<p><a id="AppendToName" class="f" href="https://cs.uesp.net/wiki/AppendToName">AppendToName</a> - appends the passed string to the end of the name of the calling reference or passed objectID.<br />
<code class="s">(nothing) <span class="op">reference.</span>AppendToName toAppend:string <span class="op">toObject:ref</span></code></p>

<p><a id="HasName" class="f" href="https://cs.uesp.net/wiki/HasName">HasName</a> - returns 1 if the object has a id consisting of at least one character.<br />
<code class="s">(hasName:bool) <span class="op">reference.</span>HasName <span class="op">objectID:ref</span></code></p>

<p><a id="SetNameEx" class="f" href="https://cs.uesp.net/wiki/SetNameEx">SetNameEx</a> - sets the name of the base object. The new name is a string constructed from a format string using the same format specifiers used by OBSE's <a href="#Output_Functions">output functions</a>.<br />
...
<p><a id="GetOwner" class="f" href="https://cs.uesp.net/wiki/GetOwner">GetOwner</a> - returns the NPC or faction which owns the calling reference.<br />
...
<p><a id="GetParentCellOwner" class="f" href="https://cs.uesp.net/wiki/GetParentCellOwner">GetParentCellOwner</a> - returns the NPC or faction which owns the calling reference's parent cell.<br />
<code class="s">(owner:ref) reference.GetParentCellOwner</code></p>

<p><a id="GetOwningFactionRequiredRank" class="f" href="https://cs.uesp.net/wiki/GetOwningFactionRequiredRank">GetOwningFactionRequiredRank</a> - returns the rank in the owning faction required to legally activate the calling reference.<br />
...
<p><a id="GetParentCellOwningFactionRequiredRank" class="f" href="https://cs.uesp.net/wiki/GetParentCellOwningFactionRequiredRank">GetParentCellOwningFactionRequiredRank</a> - returns the rank required for ownership of the calling reference's parent cell.<br />
...
<p><a id="SetOwningFactionRequiredRank" class="f" href="https://cs.uesp.net/wiki/SetOwningFactionRequiredRank">SetOwningFactionRequiredRank</a> - set the rank in the owning faction required to legally activate the calling reference.<br />
<code class="s">reference.SetOwningFactionRequiredRank rank:int</code><br />
<code class="s">reference.SetOwningFactionRank rank:int</code></p>

<p><a id="SetParentCellOwningFactionRequiredRank" class="f" href="https://cs.uesp.net/wiki/SetParentCellOwningFactionRequiredRank">SetParentCellOwningFactionRequiredRank</a> - set the rank required for ownership of the calling reference's parent cell.<br />
<code class="s">reference.SetParentCellOwningFactionRequiredRank  rank:int</code><br />
<code class="s">reference.SetCellFactionRank   rank:int</code></p>

<p><a id="IsOffLimits" class="f" href="https://cs.uesp.net/wiki/IsOffLimits">IsOffLimits</a> - returns 1 if it is illegal for the specified actor to activate the calling reference, based on the calling reference's ownership. If the argument is omitted, the player is used by default.<br />
...
<p><a id="IsRaceBonusSkill" class="f" href="https://cs.uesp.net/wiki/IsRaceBonusSkill">IsRaceBonusSkill</a> - returns whether the specified skill is a bonus for the race. If called on a reference the function will determine the race of the reference. The C version specifies the skill by number rather than by name.<br />
...
<p><a id="GetRaceSpellCount" class="f" href="https://cs.uesp.net/wiki/GetRaceSpellCount">GetRaceSpellCount</a> - returns the number of spells provided by the race. If no race is specified, the race of the calling NPC is used.<br />
<code class="s">(numSpells:int) <span class="op">reference.</span>GetRaceSpellCount <span class="op">race:ref</span></code></p>

<p><a id="GetNthRaceSpell" class="f" href="https://cs.uesp.net/wiki/GetNthRaceSpell">GetNthRaceSpell</a> - returns the nth spell provided by the race, using the race of the calling NPC if none is specified.<br />
<code class="s">(spell:ref) <span class="op">reference.</span>GetNthRaceSpell whichSpell:int <span class="op">race:ref</span></code></p>

<p><a id="SetRaceAlias" class="f" href="https://cs.uesp.net/wiki/SetRaceAlias">SetRaceAlias</a> - creates an alias for a race. If a race has an alias, then calling <code>GetIsRace <span class="op">aliasRace</span></code> will return true for any actor of that race. For example, <code>SetRaceAlias Nord Argonian</code> will cause GetIsRace to recognize Nords as Argonians. However, Argonians will not be recognized as Nords. The third argument defaults to 1; pass 0 to clear a previously created alias.<br />
<code class="s">(nothing) SetRaceAlias actualRace:ref aliasRace:ref <span class="op">enableAlias:bool</span></code></p>

<p><a id="GetRaceVoice" class="f" href="https://cs.uesp.net/wiki/GetRaceVoice">GetRaceVoice</a> - returns the race which is used to provide the voice of the specified race and gender. Pass 0 for male or 1 for female. <br />
<code class="s">(voiceRace:ref) GetRaceVoice race:ref whichGender:int</code></p>

<p> <a id="SetRaceVoice" class="f" href="https://cs.uesp.net/wiki/SetRaceVoice">SetRaceVoice</a> - changes the voice of a race to the specified race. Specify 0 for male, 1 for female, or 2 for both genders.<br />
<code class="s">(nothing) SetRaceVoice actualRace:ref voiceRace:ref whichGender:int</code></p>

<p><a id="SetRacePlayable" class="f" href="https://cs.uesp.net/wiki/SetRacePlayable">SetRacePlayable</a> - flags a race as playable or unplayable. Unplayable races cannot speak most of the dialog defined in the game.<br />
<code class="s">(nothing) SetRacePlayable race:ref isPlayable:bool</code></p>

<p><a id="IsRacePlayable" class="f" href="https://cs.uesp.net/wiki/IsRacePlayable">IsRacePlayable</a> - returns 1 if the specified race is flagged as playable in the editor.<br />
<code class="s">(isPlayable:bool) IsRacePlayable race:ref</code></p>

<p><a id="GetRaceReaction" class="f" href="https://cs.uesp.net/wiki/GetRaceReaction">GetRaceReaction</a> - returns the race reaction between the target NPC/Race and the calling NPC reference or passed race. The target and from races are declared as NPCs, but you can also place a Race name into a ref variable and pass those in.<br />
<code class="s">(reaction:int) <span class="op">reference.</span>GetRaceReaction targetNPC:ref fromNPC:ref</code></p>

<p><a id="GetRaceScale" class="f" href="https://cs.uesp.net/wiki/GetRaceScale">GetRaceScale</a> - returns the default scale of the male or female members of the specified race.<br />
<code class="s">(scale:float) GetRaceScale race:ref forFemale:bool</code></p>

<p><a id="SetRaceScale" class="f" href="https://cs.uesp.net/wiki/SetRaceScale">SetRaceScale</a> - sets the scale for male or female members of the specified race.<br />
<code class="s">(nothing) SetRaceScale race:ref forFemale:bool scale:float</code></p>

<p><a id="GetRaceWeight" class="f" href="https://cs.uesp.net/wiki/GetRaceWeight">GetRaceWeight</a> - returns the default weight for male or female members of the specified race as defined in the editor.<br />
<code class="s">(weight:float) GetRaceWeight race:ref forFemale:bool</code></p>

<p><a id="SetRaceWeight" class="f" href="https://cs.uesp.net/wiki/SetRaceWeight">SetRaceWeight</a> - sets the weight for male or female members of the specified race.<br />
<code class="s">(nothing) SetRaceWeight race:ref forFemale:bool weight:float</code></p>

<p><a id="GetRaceDefaultHair" class="f" href="https://cs.uesp.net/wiki/GetRaceDefaultHair">GetRaceDefaultHair</a> - returns the default hair for male or female members of the specified race.<br />
<code class="s">(hair:ref) GetRaceDefaultHair race:ref forFemale:bool</code></p>

<p><a id="GetRaceHairs" class="f" href="https://cs.uesp.net/wiki/GetRaceHairs">GetRaceHairs</a> - returns an Array of all hairs (male and female) available to actors of the specified race as defined in the editor.<br />
<code class="s">(hairs:Array) GetRaceHairs race:ref</code></p>

<p><a id="GetRaceEyes" class="f" href="https://cs.uesp.net/wiki/GetRaceEyes">GetRaceEyes</a> - returns an Array of all eyes available to actors of the specified race as defined in the editor.<br />
<code class="s">(eyes:Array) GetRaceEyes race:ref</code></p>

<p><a id="HasTail" class="f" href="https://cs.uesp.net/wiki/HasTail">HasTail</a> - returns true if the specified race or the race of the calling npc ref or specified base npc has a tail.<br />
<code class="s">(hasTail:bool) <span class="op">reference.</span>HasTail <span class="op">raceOrNPC:ref</span> </code></p>

<p><a id="GetTailModelPath" class="f" href="https://cs.uesp.net/wiki/GetTailModelPath">GetTailModelPath</a> - returns the path to the tail model used by the specified gender of the specified race or the race of the specified NPC or calling reference, if the race has a tail.<br />
...
<p><a id="IsScripted" class="f" href="https://cs.uesp.net/wiki/IsScripted">IsScripted</a> - returns whether the scriptable object has a script attached to it or not.<br />
...
<p><a id="GetScript" class="f" href="https://cs.uesp.net/wiki/GetScript">GetScript</a> - returns the refID of the script attached to the object<br />
<code class="s">(script:refID) <span class="op">reference.</span>GetScript <span class="op">targetObjectID:ref</span></code></p>

<p><a id="RemoveScript" class="f" href="https://cs.uesp.net/wiki/RemoveScript">RemoveScript</a> - removes and returns the script attached to the object. The object is no longer scripted<br />
<code class="s">(script:refID) <span class="op">reference.</span>RemoveScript <span class="op">targetObjectID:ref</span></code></p>

<p><a id="SetScript" class="f" href="https://cs.uesp.net/wiki/SetScript">SetScript</a> - sets the specified script onto the calling object and returns any previous script. Note that Oblivion doesn't have a script variable type so you must assign the script to a ref variable for this to work.<br />
...
<p><a id="IsFormValid" class="f" href="https://cs.uesp.net/wiki/IsFormValid">IsFormValid</a> - returns 1 if the specified ref variable contains a valid object or reference.<br />
...
<p><a id="IsReference" class="f" href="https://cs.uesp.net/wiki/IsReference">IsReference</a> - returns 1 if the specified ref variable contains a reference, as opposed to a base object.<br />
<code class="s">(isReference:bool) IsReference refVar:var</code></p>

<p><a id="HasVariable" class="f" href="https://cs.uesp.net/wiki/HasVariable">HasVariable</a> - returns 1 if the calling reference or specified quest has a variable with the specified name.<br />
...
<p><a id="GetVariable" class="f" href="https://cs.uesp.net/wiki/GetVariable">GetVariable</a> - returns the value of a numeric variable by name, either from the calling reference's script or the specified quest.<br />
...
<p><a id="GetRefVariable" class="f" href="https://cs.uesp.net/wiki/GetRefVariable">GetRefVariable</a> - returns the reference stored in a ref variable by name, either from the calling reference's script or the specified quest.<br />
...
<p><a id="GetArrayVariable" class="f" href="https://cs.uesp.net/wiki/GetArrayVariable">GetArrayVariable</a> (GetArrayVar) - returns the value of an array variable by name, either from the calling reference's script or the specified quest.<br />
<code class="s">(array) <span class="op">reference.</span>GetArrayVariable varName:string <span class="op">questID:ref</span></code></p>

<p><a id="CompareScripts" class="f" href="https://cs.uesp.net/wiki/CompareScripts">CompareScripts</a> - compares the compiled code of two scripts and returns 1 if they are identical. Note that this doesn't mean the text of the scripts are identical, only that they call the same functions in the same order with the same parameters.<br />
<code class="s">(scriptsAreIdentical:bool) CompareScripts script:ref script:ref</code></p>

<p><a id="ResetAllVariables" class="f" href="https://cs.uesp.net/wiki/ResetAllVariables">ResetAllVariables</a> - sets all variables in the calling script to zero.<br />
...
<p><a id="GetNumExplicitRefs" class="f" href="https://cs.uesp.net/wiki/GetNumExplicitRefs">GetNumExplicitRefs</a> -  returns the number of explicit references in the calling object's script or in the passed script object. Explicit references are any objects mentioned by name in the script; for instance, if a script contains an "OnHit Player" block or a "Player.AddItem" command, its explicit references will include the player.<br />
<code class="s">(numRefs:int) <span class="op">reference.</span>GetNumExplicitRefs <span class="op">script:ref</span></code></p>

<p><a id="GetNthExplicitRef" class="f" href="https://cs.uesp.net/wiki/GetNthExplicitRef">GetNthExplicitRef</a> - returns the <span class="op">n</span>th explicit ref in the calling object's script or the passed script object. See GetNumExplicitRefs are a description of explicit references.<br />
<code class="s">(object:ref) <span class="op">reference.</span>GetNthExplicitRef index:int <span class="op">script:ref</span></code></p>

<p><a id="GetCurrentScript" class="f" href="https://cs.uesp.net/wiki/GetCurrentScript">GetCurrentScript</a> - returns the script which is currently executing.<br />
...
<p><a id="SetModelPath" class="f" href="https://cs.uesp.net/wiki/SetModelPath">SetModelPath</a> - sets the model path for the type.<br />
...
<p><a id="GetModelPath" class="f" href="https://cs.uesp.net/wiki/GetModelPath">GetModelPath</a> - returns the model path for the object.<br />
<code class="s">(path:string_var) <span class="op">reference.</span>GetModelPath <span class="op">object:ref</span></code></p>

<p><a id="SetIconPath" class="f" href="https://cs.uesp.net/wiki/SetIconPath">SetIconPath</a> - sets the icon path for the type.<br />
<code class="s">(nothing) <span class="op">reference</span>.SetIconPath iconPath:string <span class="op">objectID:ref</span></code></p>

<p><a id="GetIconPath" class="f" href="https://cs.uesp.net/wiki/GetIconPath">GetIconPath</a> - returns the icon path for the object.<br />
<code class="s">(path:string_var) <span class="op">reference.</span>GetIconPath <span class="op">object:Ref</span></code></p>

<p> <a id="CompareModelPath" class="f" href="https://cs.uesp.net/wiki/CompareModelPath">CompareModelPath</a> - returns whether the passed string is part of the model path. This is a case insensitive search.<br />
...
<p><a id="CompareIconPath" class="f" href="https://cs.uesp.net/wiki/CompareIconPath">CompareIconPath</a> - returns whether the passed string is part of the icon path. This is a case insensitive search.<br />
...
<p><a id="CopyModelPath" class="f" href="https://cs.uesp.net/wiki/CopyModelPath">CopyModelPath</a> - sets the model path of the calling reference or passed objectID to the model path offromObject<br />
<code class="s">(nothing) <span class="op">reference.</span>CopyModelPath fromObject:ref <span class="op">toObject:ref</span></code></p>

<p><a id="CopyIconPath" class="f" href="https://cs.uesp.net/wiki/CopyIconPath">CopyIconPath</a> - sets the icon path of the calling reference or passed objectID to the icon path of fromObject<br />
<code class="s">(nothing) <span class="op">reference.</span>CopyIconPath fromObject:ref <span class="op">toObject:ref</span></code></p>

<p><a id="ModModelPath" class="f" href="https://cs.uesp.net/wiki/ModModelPath">ModModelPath</a> - modifies the model path of the calling reference or passed objectID. The <code>toReplaceAndReplaceWith</code> string has the following format: <code>"toReplace|replaceWith"</code>. <code>ModModelPath</code> will do a case insensitve search for the <code>toReplace</code> portion and if found will replace it with the <code>replaceWith</code> portion. The <code>|</code> character is used to separate the portions of the string. If there is nothing before the <code>|</code> character, the <code>replaceWith</code> string is prepended to the model path. In the console, use <code>@</code> instead of <code>|</code>.<br />
...
<p><a id="IsModelPathValid" class="f" href="https://cs.uesp.net/wiki/IsModelPathValid">IsModelPathValid</a> - returns 1 if the model path for the object exists in the user's Data folder or within one of the BSA archives.<br />
<code class="s">(isPathValid:bool) <span class="op">reference.</span>IsModelPathValid <span class="op">object:ref</span></code></p>

<p><a id="IsIconPathValid" class="f" href="https://cs.uesp.net/wiki/IsIconPathValid">IsIconPathValid</a> - returns 1 if the icon path for the object exists in the user's Data folder or within one of the BSA archives.<br />
<code class="s">(isPathValid:bool) <span class="op">reference.</span>IsIconPathValid <span class="op">object:ref</span></code></p>

<p><a id="GetTexturePath" class="f" href="https://cs.uesp.net/wiki/GetTexturePath">GetTexturePath</a> - returns the texture path of an object. This command is identical to GetIconPath, but also works for other object types such as skills, classes, and miscellaneous objects.<br />
<code class="s">(string) <span class="op">reference.</span>GetTexturePath<span class="op"> object:ref</span></code></p>

<p><a id="SetTexturePath" class="f" href="https://cs.uesp.net/wiki/SetTexturePath">SetTexturePath</a> - sets the texture path of an object. This command works for a broader set of objects than SetIconPathEX.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetTexturePath path:string<span class="op"> object:ref</span></code></p>

<p><a id="GetEditorSize" class="f" href="https://cs.uesp.net/wiki/GetEditorSize">GetEditorSize</a> - returns the value contained in the hidden 'size' field of the editor's object window for the specified object. This is a rough scalar approximation of the dimensions of the object. Return value is typically similar to that of <a href="#GetBoundingRadius">GetBoundingRadius</a>. The game only calculates and stores this value for objects for which at least one reference exists in the game world.<br />
...
<p><a id="SetMaleBipedPath" class="f" href="https://cs.uesp.net/wiki/SetMaleBipedPath">SetMaleBipedPath</a> - sets the male NIF model path when worn<br />
...
<p><a id="SetFemaleBipedPath" class="f" href="https://cs.uesp.net/wiki/SetFemaleBipedPath">SetFemaleBipedPath</a> - sets the female NIF model path when worn<br />
...
<p><a id="SetMaleGroundPath" class="f" href="https://cs.uesp.net/wiki/SetMaleGroundPath">SetMaleGroundPath</a> - sets the male model path when dropped<br />
...
<p><a id="SetFemaleGroundPath" class="f" href="https://cs.uesp.net/wiki/SetFemaleGroundPath">SetFemaleGroundPath</a> - sets the female model path when dropped<br />
...
<p><a id="SetMaleIconPath" class="f" href="https://cs.uesp.net/wiki/SetMaleIconPath">SetMaleIconPath</a> - sets the male icon texture<br />
<code class="s">(nothing) <span class="op">reference</span>.SetMaleIconPath iconPath:string <span class="op">objectID:ref</span></code></p>

<p><a id="SetFemaleIconPath" class="f" href="https://cs.uesp.net/wiki/SetFemaleIconPath">SetFemaleIconPath</a> - sets the female icon texture<br />
...
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModMaleBipedPath">ModMaleBipedPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModFemaleBipedPath">ModFemaleBipedPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModMaleGroundPath">ModMaleGroundPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModFemaleGroundPath">ModFemaleGroundPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModMaleIconPath">ModMaleIconPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/ModFemaleIconPath">ModFemaleIconPath</a> toReplaceAndReplaceWith:string <span class="op">toObject:ref</span></code></p>
...
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleBipedPath">CompareMaleBipedPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleBipedPath">CompareFemaleBipedPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleGroundPath">CompareMaleGroundPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleGroundPath">CompareFemaleGroundPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleIconPath">CompareMaleIconPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleIconPath">CompareFemaleIconPath</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleBipedPath">MaleBipedPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleBipedPath">FemaleBipedPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleGroundPath">MaleGroundPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleGroundPath">FemaleGroundPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareMaleIconPath">MaleIconPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code><br />
<code class="s">(found:bool) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CompareFemaleIconPath">FemaleIconPathIncludes</a> toFind:string <span class="op">objectID:ref</span></code></p>
...
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyMaleBipedPath">CopyMaleBipedPath</a> fromObject:ref <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyFemaleBipedPath">CopyFemaleBipedPath</a> fromObject:ref <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyMaleGroundPath">CopyMaleGroundPath</a> fromObject:ref <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyFemaleGroundPath">CopyFemaleGroundPath</a> fromObject:ref <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyMaleIconPath">CopyMaleIconPath</a> fromObject:ref <span class="op">toObject:ref</span></code><br />
<code class="s">(nothing) <span class="op">reference.</span><a class="cf" href="https://cs.uesp.net/wiki/CopyFemaleIconPath">CopyFemaleIconPath</a> fromObject:ref <span class="op">toObject:ref</span></code></p>

<p><a id="IsPlayable" class="f" href="https://cs.uesp.net/wiki/IsPlayable">IsPlayable</a> - returns whether the specified object is playable or not. Returns true only if the object is of a type which can be flagged as playable in the editor.<br />
<code class="s">(isPlayable:bool) <span class="op">reference</span>.IsPlayable <span class="op">objectID:ref</span></code></p>

<p><a id="IsPlayable2" class="f" href="https://cs.uesp.net/wiki/IsPlayable2">IsPlayable2</a> - returns whether the specified object is playable or not. If the object is of a type which cannot be flagged as playable in the editor, this function returns true.<br />
<code class="s">(isPlayable:bool) <span class="op">reference.</span>IsPlayable2 <span class="op">objectID:ref</span></code></p>

<p><a id="SetIsPlayable" class="f" href="https://cs.uesp.net/wiki/SetIsPlayable">SetIsPlayable</a> - specifies whether the object can be used by the player<br />
<code class="s">(nothing) <span class="op">reference</span>.SetIsPlayable isPlayable:bool <span class="op">objectID:ref</span></code></p>

<p><a id="IsBipedIconPathValid" class="f" href="https://cs.uesp.net/wiki/IsBipedIconPathValid">IsBipedIconPathValid</a> - returns 1 if the icon path for the object exists in the user's Data folder or within one of the BSA archives.<br />
...
<p><a id="IsBipedModelPathValid" class="f" href="https://cs.uesp.net/wiki/IsBipedModelPathValid">IsBipedModelPathValid</a> - returns 1 if the model path for the object exists in the user's Data folder or within one of the BSA archives.<br />
...
<p><a id="GetBipedModelPath" class="f" href="https://cs.uesp.net/wiki/GetBipedModelPath">GetBipedModelPath</a> - returns the file path of one of the models for the specified biped object.<br />
...
<p><a id="SetBipedModelPathEX" class="f" href="https://cs.uesp.net/wiki/SetBipedModelPathEX">SetBipedModelPathEX</a> - sets the file path of the male or female model for the specified biped object.<br />
...
<p><a id="GetBipedIconPath" class="f" href="https://cs.uesp.net/wiki/GetBipedIconPath">GetBipedIconPath</a> - returns the file path of one of the icons for the specified biped object.<br />
...
<p><a id="SetBipedIconPathEX" class="f" href="https://cs.uesp.net/wiki/SetBipedIconPathEX">SetBipedIconPathEX</a> - sets the file path of the male or female icon for the specified biped object.<br />
...
<p><a id="GetHidesRings" class="f" href="https://cs.uesp.net/wiki/GetHidesRings">GetHidesRings</a> - returns 1 if the "hides rings" flag is set for the biped object.<br />
<code class="s">(hidesRings:bool) <span class="op">reference.</span>GetHidesRings <span class="op">object:ref</span></code></p>

<p><a id="GetHidesAmulet" class="f" href="https://cs.uesp.net/wiki/GetHidesAmulet">GetHidesAmulet</a> - returns 1 if the "hides amulet" flag is set for the biped object.<br />
<code class="s">(hidesAmulet:bool) <span class="op">reference.</span>GetHidesAmulet <span class="op">object:Ref</span></code></p>

<p><a id="SetHidesRings" class="f" href="https://cs.uesp.net/wiki/SetHidesRings">SetHidesRings</a> - modifies the "hides rings" flag.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetHidesRings hidesRings:bool <span class="op">object:ref</span></code></p>

<p><a id="SetHidesAmulet" class="f" href="https://cs.uesp.net/wiki/SetHidesAmulet">SetHidesAmulet</a> - modifies the "hides amulet" flag.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetHidesAmulet hidesAmulet:bool <span class="op">object:ref</span></code></p>

<p><a id="GetBipedSlotMask" class="f" href="https://cs.uesp.net/wiki/GetBipedSlotMask">GetBipedSlotMask</a> - returns the slots occupied by a biped object.<br />
...
<p><a id="SetBipedSlotMask" class="f" href="https://cs.uesp.net/wiki/SetBipedSlotMask">SetBipedSlotMask</a> - sets the slots occupied by a biped object.<br />
...
<p><a id="GetNumDetectedActors" class="f" href="https://cs.uesp.net/wiki/GetNumDetectedActors">GetNumDetectedActors</a> - returns the number of other actors of which the calling actor may detect. This includes actors detected at "Lost" or "Unseen" level.<br />
<code class="s">(numDetectedActors:int) reference.GetNumDetectedActors</code></p>

<p><a id="GetNthDetectedActor" class="f" href="https://cs.uesp.net/wiki/GetNthDetectedActor">GetNthDetectedActor</a> - returns the Nth actor in the calling actor's detection list<br />
<code class="s">(actor:ref) reference.GetNthDetectedActor index:short</code></p>

<p><a id="SetDetectionState" class="f" href="https://cs.uesp.net/wiki/SetDetectionState">SetDetectionState</a> - sets the <a href="#Detection_State">detection state</a> of the calling actor toward the specified actor reference. Note that Oblivion recalculates this value frequently for actors in high process; the function's main purpose is to reset the detection state of unconscious actors.<br />
<code class="s">(nothing) reference.SetDetectionState actor:ref <a href="#Detection_State">detection state</a>:int</code></p>

<p><a id="IsBlocking" class="f" href="https://cs.uesp.net/wiki/IsBlocking">IsBlocking</a> - returns 1 if the calling actor is blocking<br />
<code class="s">(isBlocking:bool) reference.IsBlocking</code></p>

<p><a id="IsAttacking" class="f" href="https://cs.uesp.net/wiki/IsAttacking">IsAttacking</a> - returns 1 if the calling actor is attacking<br />
...
<p><a id="IsRecoiling" class="f" href="https://cs.uesp.net/wiki/IsRecoiling">IsRecoiling</a> - returns 1 if the calling actor is recoiling<br />
<code class="s">(isRecoiling:bool) reference.IsRecoiling</code></p>

<p><a id="IsDodging" class="f" href="https://cs.uesp.net/wiki/IsDodging">IsDodging</a> - returns 1 if the calling actor is dodging<br />
<code class="s">(isDodging:bool) reference.IsDodging</code></p>

<p><a id="IsStaggered" class="f" href="https://cs.uesp.net/wiki/IsStaggered">IsStaggered</a> - returns 1 if the calling actor is staggered<br />
<code class="s">(isStaggered:bool) reference.IsStaggered</code></p>

<p><a id="IsMovingForward" class="f" href="https://cs.uesp.net/wiki/IsMovingForward">IsMovingForward</a> - returns 1 if the calling actor is attempting to move forward, even if his path is blocked.<br />
<code class="s">(isMovingForward:bool) reference.IsMovingForward</code></p>

<p><a id="IsMovingLeft" class="f" href="https://cs.uesp.net/wiki/IsMovingLeft">IsMovingLeft</a> - returns 1 if the calling actor is attempting to strafe left<br />
<code class="s">(isMovingLeft:bool) reference.IsMovingLeft</code></p>

<p><a id="IsMovingRight" class="f" href="https://cs.uesp.net/wiki/IsMovingRight">IsMovingRight</a> - returns 1 if the calling actor is attempting to strafe right<br />
<code class="s">(isMovingRight:bool) reference.IsMovingRight</code></p>

<p><a id="IsMovingBackward" class="f" href="https://cs.uesp.net/wiki/IsMovingBackward">IsMovingBackward</a> - returns 1 if the calling actor is attempting to move backwards<br />
<code class="s">(isMovingBackwards:bool) reference.IsMovingBackwards</code></p>

<p><a id="IsTurningLeft" class="f" href="https://cs.uesp.net/wiki/IsTurningLeft">IsTurningLeft</a> - returns 1 if the calling actor is turning left<br />
<code class="s">(isTurningLeft:bool) reference.IsTurningLeft</code></p>

<p><a id="IsTurningRight" class="f" href="https://cs.uesp.net/wiki/IsTurningRight">IsTurningRight</a> - returns 1 if the calling actor is turning right<br />
<code class="s">(isTurningRight:bool) reference.IsTurningRight</code></p>

<p><a id="IsInAir" class="f" href="https://cs.uesp.net/wiki/IsInAir">IsInAir</a> - returns 1 if the calling actor is airborne, whether jumping or falling<br />
<code class="s">(isInAir:bool) reference.IsInAir</code></p>

<p><a id="IsJumping" class="f" href="https://cs.uesp.net/wiki/IsJumping">IsJumping</a> - returns 1 if the calling actor is beginning to jump (playing the JumpStart anim group)<br />
<code class="s">(isJumping:bool) reference.IsJumping</code></p>

<p><a id="IsOnGround" class="f" href="https://cs.uesp.net/wiki/IsOnGround">IsOnGround</a> - returns 1 if the calling actor is on the ground<br />
<code class="s">(isOnGround:bool) reference.IsOnGround</code></p>

<p><a id="IsFlying" class="f" href="https://cs.uesp.net/wiki/IsFlying">IsFlying</a> - returns 1 if the calling actor is flying. Only creatures can fly.<br />
<code class="s">(isFlying:bool) reference.IsFlying</code></p>

<p><a id="IsPowerAttacking" class="f" href="https://cs.uesp.net/wiki/IsPowerAttacking">IsPowerAttacking</a> - returns 1 if the calling actor is executing a power attack. See also the note on <a href="#IsAttacking"><code>IsAttacking</code></a>.<br />
<code class="s">(isPowerAttacking:bool) reference.IsPowerAttacking</code></p>

<p><a id="IsCasting" class="f" href="https://cs.uesp.net/wiki/IsCasting">IsCasting</a> - returns 1 if the calling actor is casting a spell<br />
<code class="s">(isCasting:bool) reference.IsCasting</code></p>

<p><a id="GetFallTimer" class="f" href="https://cs.uesp.net/wiki/GetFallTimer">GetFallTimer</a> - returns the length of time for which the actor has been falling<br />
<code class="s">(fallTimer:float) reference.GetFallTimer</code></p>

<p><a id="IsAnimGroupPlaying" class="f" href="https://cs.uesp.net/wiki/IsAnimGroupPlaying">IsAnimGroupPlaying</a> - returns 1 if the specified <a href="#Animation_Group">animation group</a> is currently being played by the calling actor<br />
<code class="s">(playing:bool) reference.IsAnimGroupPlaying <a href="#Animation_Group">animationGroup</a>:chars</code></p>

<p><a id="AnimPathIncludes" class="f" href="https://cs.uesp.net/wiki/AnimPathIncludes">AnimPathIncludes</a> - returns 1 if one of the calling actor's currently playing animation paths includes the specified substring<br />
<code class="s">(includes:bool) reference.AnimPathIncludes pathString:string</code></p>

<p><a id="GetProcessLevel" class="f" href="https://cs.uesp.net/wiki/GetProcessLevel">GetProcessLevel</a> - returns the actor's current process level, or -1 if called on a non-actor. Process level determines how frequently the game updates an actor's AI. In general, high process actors are in the same cell as the player, while more distant actors are kept at a lower process level.<br />
<code class="s">(<a href="#Process_Level">processLevel</a>:int) reference.GetProcessLevel</code></p>

<p><a id="GetEquippedItems" class="f" href="https://cs.uesp.net/wiki/GetEquippedItems">GetEquippedItems</a> - returns an array containing all items currently equipped by the calling actor<br />
<code class="s">(items:Array) reference.GetEquippedItems</code></p>

<p><a id="GetSpells" class="f" href="https://cs.uesp.net/wiki/GetSpells">GetSpells</a> - returns an array containing all of the spells in an actor's spell list.<br />
<code class="s">(spells:Array) <span class="op">reference.</span>GetSpells <span class="op">baseActor:ref</span></code></p>

<p><a id="GetActorAlpha" class="f" href="https://cs.uesp.net/wiki/GetActorAlpha">GetActorAlpha</a> - actor references can be made more or less opaque or transparent by changing their alpha property via SetActorAlpha. This function returns the calling actor's current alpha as a floating point number between 0.0 and 1.0, with 0.0 corresponding to fully transparent and 1.0 to fully opaque.<br />
<code class="s">(alpha:float) reference.GetActorAlpha</code></p>

<p><a id="GetBaseActorValueC" class="f" href="https://cs.uesp.net/wiki/GetBaseActorValueC">GetBaseActorValueC</a> - identical to the game's GetBaseAV command, but accepts an integer actor value code.<br />
...
<p><a id="GetBaseAV3" class="f" href="https://cs.uesp.net/wiki/GetBaseAV3">GetBaseAV3</a> - returns the same value as the game's GetBaseAV command, but does not include the effects of Fortify abilities.<br />
<code class="s">(baseAV:int) reference.GetBaseAV3 actorValue:string</code></p>

<p><a id="GetBaseAV3C" class="f" href="https://cs.uesp.net/wiki/GetBaseAV3C">GetBaseAV3C</a> - as GetBaseAV3, but takes an actor value code instead of an actor value name.<br />
<code class="s">(baseAV:int) reference.GetBaseAV3C actorValueCode:int</code></p>

<p><a id="GetAllies" class="f" href="https://cs.uesp.net/wiki/GetAllies">GetAllies</a> -  for an actor in combat, returns an Array of other actors which the game considers allies of the calling actor at that particular moment.<br />
<code class="s">(allies:Array) reference.GetAllies</code></p>

<p><a id="GetTargets" class="f" href="https://cs.uesp.net/wiki/GetTargets">GetTargets</a> - for an actor in combat, returns an Array of actors which the game considers potential targets of the calling actor at that particular moment.<br />
<code class="s">(targets:Array) reference.GetTargets</code></p>

<p><a id="GetSelectedSpells" class="f" href="https://cs.uesp.net/wiki/GetSelectedSpells">GetSelectedSpells</a> - for an actor in combat, returns an Array containing zero to seven spells which the actor has selected from his full spell list (including spells resolved from leveled spell lists) for use. The list contains a maximum of one spell from each of the following categories: bound armor, bound weapon, "buff", melee, ranged, restorative, and summon spells.<br />
<code class="s">(spells:Array) reference.GetSelectedSpells</code></p>

<p><a id="GetCombatSpells" class="f" href="https://cs.uesp.net/wiki/GetCombatSpells">GetCombatSpells</a> - for an actor in combat, returns an Array of all the spells in the actor's spellbook, including spells resolved from leveled spells lists (which are resolved into actual spells when the actor enters combat). The actor will use a subset of these spells during combat; use GetSelectedSpells to determine which of these spells have been selected for use.<br />
<code class="s">(spells:Array) reference.GetCombatSpells</code></p>

<p><a id="PlayIdle" class="f" href="https://cs.uesp.net/wiki/PlayIdle">PlayIdle</a> - attempts to make the calling actor play the specified idle animation. The animation must be one defined in the editor's Gameplay &gt; Idle Animations window. Pass 1 for the forceIdle parameter to force the actor to play the idle regardless of any other animations currently playing.<br />
...
<p><a id="IsNaked" class="f" href="https://cs.uesp.net/wiki/IsNaked">IsNaked</a> - returns 1 if the calling actor is naked, 0 otherwise. Naked means without a lowerbody equipment. If requireUpperbody is 1 it also requires an upperbody equipment.<br />
...
<p><a id="GetPackageData" class="f" href="https://cs.uesp.net/wiki/GetPackageData">GetPackageData</a> - returns a stringmap containing info about a package. The returned stringmap contains the following keys:<br />
<ul>
...
<p><a id="GetPackageScheduleData" class="f" href="https://cs.uesp.net/wiki/GetPackageScheduleData">GetPackageScheduleData</a> - returns a stringmap containing info about a package schedule. The returned stringmap contains the following keys:<br />
<ul>
...
<p><a id="GetPackageLocationData" class="f" href="https://cs.uesp.net/wiki/GetPackageLocationData">GetPackageLocationData</a> - returns a stringmap containing info about a package location. The returned stringmap contains the following keys:<br />
<ul>
...
<p><a id="GetPackageTargetData" class="f" href="https://cs.uesp.net/wiki/GetPackageTargetData">GetPackageTargetData</a> - returns a stringmap containing info about a package target. The returned stringmap contains the following keys:<br />
<ul>
...
<p><a id="IsPoison" class="f" href="https://cs.uesp.net/wiki/IsPoison">IsPoison</a> - returns whether the alchemy item is a poison.<br />
...
<p><a id="GetApparatusType" class="f" href="https://cs.uesp.net/wiki/GetApparatusType">GetApparatusType</a> - returns the alchemy apparatus type of the calling reference or passed objectID<br />
...
<p><a id="SetApparatusType" class="f" href="https://cs.uesp.net/wiki/SetApparatusType">SetApparatusType</a> - sets the alchemy type of the calling reference or passed objectID<br />
...
<p><a id="GetQuality" class="f" href="https://cs.uesp.net/wiki/GetQuality">GetQuality</a> - returns the quality level of the calling reference or passed objectID<br />
...
<p><a id="SetQuality" class="f" href="https://cs.uesp.net/wiki/SetQuality">SetQuality</a> - sets the quality level of the calling reference or passed objectID<br />
...
<p><a id="ModQuality" class="f" href="https://cs.uesp.net/wiki/ModQuality">ModQuality</a> - modifies the quality of the calling reference or passed objectID<br />
...
<p><a id="GetArmorAR" class="f" href="https://cs.uesp.net/wiki/GetArmorAR">GetArmorAR</a> - returns the armor rating of the object<br />
...
<p><a id="SetArmorAR" class="f" href="https://cs.uesp.net/wiki/SetArmorAR">SetArmorAR</a> - sets the armor rating of the object<br />
<code class="s">(nothing) <span class="op">reference.</span>SetArmorAR nuArmorRating:int <span class="op">objectID:ref</span></code></p>

<p><a id="ModArmorAR" class="f" href="https://cs.uesp.net/wiki/ModArmorAR">ModArmorAR</a> - modifies the armor rating of the object up or down<br />
<code class="s">(nothing) <span class="op">reference.</span>ModArmorAR modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetArmorType" class="f" href="https://cs.uesp.net/wiki/GetArmorType">GetArmorType</a> - returns 0 if light armor and 1 if heavy armor<br />
...
<p><a id="SetArmorType" class="f" href="https://cs.uesp.net/wiki/SetArmorType">SetArmorType</a> - sets whether the armor is heavy or light<br />
...
<p><a id="GetBirthsignSpells" class="f" href="https://cs.uesp.net/wiki/GetBirthsignSpells">GetBirthsignSpells</a> - returns an Array containing the spells associated with the specified birthsign<br />
...
<p><a id="GetBookCantBeTaken" class="f" href="https://cs.uesp.net/wiki/GetBookCantBeTaken">GetBookCantBeTaken</a> - returns 1 if the book cannot be taken<br />
<code class="s">(cantBeTaken:bool) <span class="op">reference</span>.GetBookCantBeTaken <span class="op">objectID:ref</span></code></p>

<p><a id="GetBookIsScroll" class="f" href="https://cs.uesp.net/wiki/GetBookIsScroll">GetBookIsScroll</a> - returns whether the book is a scroll or not<br />
...
<p><a id="GetBookSkillTaught" class="f" href="https://cs.uesp.net/wiki/GetBookSkillTaught">GetBookSkillTaught</a> - returns the skill taught by the book. If no skill is taught, returns -1.<br />
...
<p><a id="SetBookCantBeTaken" class="f" href="https://cs.uesp.net/wiki/SetBookCantBeTaken">SetBookCantBeTaken</a> - sets whether the book can be taken<br />
...
<p><a id="SetBookIsScroll" class="f" href="https://cs.uesp.net/wiki/SetBookIsScroll">SetBookIsScroll</a> - sets whether the book is a scroll<br />
<code class="s">(nothing) <span class="op">reference.</span>SetBookIsScroll isScroll:bool <span class="op">objectID:ref</span></code></p>

<p><a id="SetBookSkillTaught" class="f" href="https://cs.uesp.net/wiki/SetBookSkillTaught">SetBookSkillTaught</a> - sets the skill the book teaches. The the skillTaught value is not one of the skills, sets the value to 255.<br />
...
<p><a id="GetBookText" class="f" href="https://cs.uesp.net/wiki/GetBookText">GetBookText</a> - returns the text of a book as a string. The result must be assigned to a string variable.<br />
<code class="s">(bookText:string_var) <span class="op">reference.</span>GetBookText <span class="op">book:ref</span></code></p>

<p><a id="GetBookLength" class="f" href="https://cs.uesp.net/wiki/GetBookLength">GetBookLength</a> - returns the number of characters in a book's text.<br />
...
<p><a id="GetCellMusicType" class="f" href="https://cs.uesp.net/wiki/GetCellMusicType">GetCellMusicType</a> - returns the music type of the player's current cell.<br />
<code class="s">(<a href="#Music_Type">musicType</a>:int) GetCellMusicType</code></p>

<p><a id="SetCellMusicType" class="f" href="https://cs.uesp.net/wiki/SetCellMusicType">SetCellMusicType</a> - sets the music type used in the specified cell.<br />
<code class="s">(nothing) SetCellMusicType cell:ref <a href="#Music_Type">musicType</a>:int </code></p>

<p><a id="SetCellWaterHeight" class="f" href="https://cs.uesp.net/wiki/SetCellWaterHeight">SetCellWaterHeight</a> - changes the water height of the specified cell. In order for the command to take full effect, the cell must be reloaded (con_PurgeCellBuffers can be used to forcibly unload it if it is still in memory). If used to alter the water height in a loaded cell, the water shader will reflect the new height and actors will switch between swimming and walking animations appropriately. However, floating physics and the water surface will not be updated until the cell is reloaded. This command has no effect in exteriors or in cells which have no water.<br />
<code class="s">(waterHeightChanged:bool) SetCellWaterHeight cell:ref newHeight:float</code></p>

<p><a id="GetCellDetachTime" class="f" href="https://cs.uesp.net/wiki/GetCellDetachTime">GetCellDetachTime</a> - returns the cell's detach time, described above.<br />
<code class="s">(detachTime:int) GetCellDetachTime cell:ref</code></p>

<p><a id="GetCellResetHours" class="f" href="https://cs.uesp.net/wiki/GetCellResetHours">GetCellResetHours</a> - returns the number of hours which must pass in the game before the cell is reset.<br />
<code class="s">(hours:int) GetCellResetHours cell:ref</code></p>

<p><a id="SetCellResetHours" class="f" href="https://cs.uesp.net/wiki/SetCellResetHours">SetCellResetHours</a> - sets the number of hours which mustpass before the cell is reset. This value must be less than the game setting iHoursToRespawnCell. Using this function to modify the reset hours for the current cell, or for exterior cells, has no effect.<br />
<code class="s">(bSucceeded:bool) SetCellResetHours cell:ref hours:int</code></p>

<p><a id="GetCellBehavesAsExterior" class="f" href="https://cs.uesp.net/wiki/GetCellBehavesAsExterior">GetCellBehavesAsExterior</a> - returns true if the "behaves as exterior" cell is checked for the specified interior cell.<br />
<code class="s">(behavesAsExterior:bool) GetCellBehavesAsExterior cell:ref</code></p>

<p><a id="IsCellPublic" class="f" href="https://cs.uesp.net/wiki/IsCellPublic">IsCellPublic</a> - returns 1 if the cell is marked as 'public'.<br />
<code class="s">(isPublic:bool) IsCellPublic</code></p>

<p><a id="SetCellIsPublic" class="f" href="https://cs.uesp.net/wiki/SetCellIsPublic">SetCellIsPublic</a> - sets the 'public' flag for the cell.<br />
<code class="s">(nothing) SetCellIsPublic cell:ref isPublic:bool</code></p>

<p><a id="SetCellHasWater" class="f" href="https://cs.uesp.net/wiki/SetCellHasWater">SetCellHasWater</a> - sets the flag indicating whether or not the interior cell has water. Only affects interior cells, and changes are not visible until the cell is reloaded. Has no effect if called while the player is inside the specified cell.<br />
<code class="s">(nothing) SetCellHasWater cell:ref hasWater:bool</code></p>

<p><a id="SetCellBehavesAsExterior" class="f" href="https://cs.uesp.net/wiki/SetCellBehavesAsExterior">SetCellBehavesAsExterior</a> - sets the 'behaves like exterior' flag for the interior cell. Has no effect if called while the player is inside the specified cell.<br />
<code class="s">(nothing) SetCellBehavesAsExterior cell:ref behavesAsExterior:bool</code></p>

<p><a id="GetCellClimate" class="f" href="https://cs.uesp.net/wiki/GetCellClimate">GetCellClimate</a> - returns the climate for the specified cell. <br />
<code class="s">(climate:ref) GetCellClimate cell:ref</code></p>

<p><a id="SetCellClimate" class="f" href="https://cs.uesp.net/wiki/SetCellClimate">SetCellClimate</a> - sets the climate for the specified cell.<br />
<code class="s">(nothing) SetCellClimate cell:ref climate:ref</code></p>

<p><a id="GetCellLighting" class="f" href="https://cs.uesp.net/wiki/GetCellLighting">GetCellLighting</a> - returns a StringMap describing the lighting properties for the interior cell. The StringMap contains the following key-value pairs corresponding to the fields in the editor's Cell Lighting tab, where 'RGB Array' is a 3-element Array with values from 0-255 in the order {red, green, blue}: <br />
<pre>
		"ambient" (RGB Array)
...
<p><a id="SetCellLighting" class="f" href="https://cs.uesp.net/wiki/SetCellLighting">SetCellLighting</a> - alters one or more of an interior cell's lighting fields, taking a StringMap of the same format as that returned by <a href="#GetCellLighting">GetCellLighting</a>. Include only the elements you wish to change; if a key is not found its value will not be modified.<br />
<code class="s">(nothing) SetCellLighting cell:ref newValues:StringMap</code></p>

<p><a id="GetTerrainHeight" class="f" href="https://cs.uesp.net/wiki/GetTerrainHeight">GetTerrainHeight</a> - returns the height of the terrain mesh at the specified x and y coordinates within the current exterior worldspace. X and Y are worldspace coordinates (e.g. as returned by GetPos). If the coordinates are outside of any loaded cells, returns 0.0. Note that this command does not check for collision with surfaces other than terrain.<br />
<code class="s">(height:float) GetTerrainHeight x:float y:float</code></p>

<p><a id="IsOblivionInterior" class="f" href="https://cs.uesp.net/wiki/IsOblivionInterior">IsOblivionInterior</a> - returns 1 if the "Oblivion interior" flag has been checked for the specified interior cell.<br />
<code class="s">(oblivionInterior:bool) IsOblivionInterior cell:ref</code></p>

<p><a id="IsOblivionWorld" class="f" href="https://cs.uesp.net/wiki/IsOblivionWorld">IsOblivionWorld</a> - returns 1 if the "Oblivion World" flag has been checked for the specified world space.<br />
<code class="s">(oblivionWorld:bool) IsOblivionWorld worldspace:ref</code></p>

<p><a id="CanFastTravelFromWorld" class="f" href="https://cs.uesp.net/wiki/CanFastTravelFromWorld">CanFastTravelFromWorld</a> - returns 1 if the player is allowed to fast-travel from the specified world space.<br />
<code class="s">(canFastTravel:bool) CanFastTravelFromWorld worldspace:ref</code></p>

<p><a id="SetCanFastTravelFromWorld" class="f" href="https://cs.uesp.net/wiki/SetCanFastTravelFromWorld">SetCanFastTravelFromWorld</a> - sets whether the player can fast-travel from the specified world space.<br />
<code class="s">(nothing) SetCanFastTravelFromWorld worldspace:ref canFastTravel:bool</code></p>

<p><a id="GetCellWaterType" class="f" href="https://cs.uesp.net/wiki/GetCellWaterType">GetCellWaterType</a> - returns the Water used by the interior cell. Returns zero if the cell has no water, or if the cell uses the default water type.<br />
<code class="s">(waterType:ref) GetCellWaterType cell:ref</code></p>

<p><a id="SetCellWaterType" class="f" href="https://cs.uesp.net/wiki/SetCellWaterType">SetCellWaterType</a> - sets the Water used by the interior cell. Changes will not be visible until the cell is reloaded.<br />
<code class="s">(nothing) SetCellWaterType cell:ref waterType:ref</code></p>

<p><a id="GetCellNorthRotation" class="f" href="https://cs.uesp.net/wiki/GetCellNorthRotation">GetCellNorthRotation</a> - returns the rotation on the Z axis of the north marker within the specified interior cell, if one is present. The game uses the north marker's Z rotation to determine what direction is considered "north". Rotation returned is in degrees and is 0.0 if no north marker is present in the specified cell.<br />
<code class="s">(rotation:float) GetCellNorthRotation cell:ref</code></p>

<p><a id="IsInvertFastTravel" class="f" href="https://cs.uesp.net/wiki/IsInvertFastTravel">IsInvertFastTravel</a> - returns true if the cell has InvertFastTravel flag <br />
<code class="s">(ret:bool) IsInvertFastTravel cell:ref</code></p>

<p><a id="SetInvertFastTravel" class="f" href="https://cs.uesp.net/wiki/SetInvertFastTravel">SetInvertFastTravel</a> - sets the InvertFastTravel flag on the provided cell, reversing the behaviour for the cell type regarding fast travel, allowing travel from interiors.<br />
<code class="s"> SetInvertFastTravel cell:ref  active:bool</code></p>

<p><a id="IsCantWait" class="f" href="https://cs.uesp.net/wiki/IsCantWait">IsCantWait</a> - returns true if the cell has CantWait flag <br />
<code class="s">(ret:bool) IsCantWait cell:ref</code></p>

<p><a id="SetCantWait" class="f" href="https://cs.uesp.net/wiki/SetCantWait">SetCantWait</a> - sets the CantWait flag on the provided cell, preventing waiting (and sleeping) inside. The change isn't backed into the savegame<br />
<code class="s"> SetCantWait cell:ref  active:bool</code></p>


<h3><a id="Climate">Climate</a></h3>

<p>Climate settings define weather, sun, and moon settings for a worldspace. Additional information about these settings can be found at the <a href="https://cs.uesp.net/wiki/Climates">Construction Set Wiki</a>.</p>
...
<p><a id="GetCurrentClimateID" class="f" href="https://cs.uesp.net/wiki/GetCurrentClimateID">GetCurrentClimateID</a> - returns the refID of the current climate.<br />
<code class="s">(currentClimate:ref) GetCurrentClimateID</code></p>

<p><a id="GetClimateSunriseBegin" class="f" href="https://cs.uesp.net/wiki/GetClimateSunriseBegin">GetClimateSunriseBegin</a> - returns the time sunrise begins specified as a number of 10 minute units since midnight.<br />
...
<p><a id="GetClimateSunriseEnd" class="f" href="https://cs.uesp.net/wiki/GetClimateSunriseEnd">GetClimateSunriseEnd</a> - returns the time sunrise ends specified as a number of 10 minute units since midnight.<br />
<code class="s">(sunriseEnd:int) GetSunriseEnd climate:ref</code></p>

<p><a id="GetClimateSunsetBegin" class="f" href="https://cs.uesp.net/wiki/GetClimateSunsetBegin">GetClimateSunsetBegin</a> - returns the time sunset begins specified as a number of 10 minute units since midnight.<br />
<code class="s">(sunsetBegin:int) GetSunsetBegin climate:ref</code></p>

<p><a id="GetClimateSunsetEnd" class="f" href="https://cs.uesp.net/wiki/GetClimateSunsetEnd">GetClimateSunsetEnd</a> - returns the time sunset ends specified as a number of 10 minute units since midnight.<br />
<code class="s">(sunsetEnd:int) GetSunsetEnd climate:ref</code></p>

<p><a id="GetClimateMoonPhaseLength" class="f" href="https://cs.uesp.net/wiki/GetClimateMoonPhaseLength">GetClimateMoonPhaseLength</a> - returns the number of days in the phase of the moons. The total moon cycle length is 8 x PhaseLength according to the CS.<br />
<code class="s">(phaseLength:int) GetClimateMoonPhaseLength climate:ref</code></p>

<p><a id="GetClimateHasMasser" class="f" href="https://cs.uesp.net/wiki/GetClimateHasMasser">GetClimateHasMasser</a> - returns 1 if the current climate shows the moon Masser.<br />
<code class="s">(hasMasser:bool) GetClimateHasMasser climate:ref</code></p>

<p><a id="GetClimateHasSecunda" class="f" href="https://cs.uesp.net/wiki/GetClimateHasSecunda">GetClimateHasSecunda</a> - returns 1 if the current climate shows the moon Secunda.<br />
<code class="s">(hasSecunda:bool) GetClimateHasSecunda climate:ref</code></p>

<p><a id="RefreshCurrentClimate" class="f" href="https://cs.uesp.net/wiki/RefreshCurrentClimate">RefreshCurrentClimate</a> - refreshes the climate info to reflect changes made by the SetClimateXXX functions.<br />
<code class="s">(nothing) RefreshCurrentClimate</code></p>

<p><a id="SetClimateSunriseBegin" class="f" href="https://cs.uesp.net/wiki/SetClimateSunriseBegin">SetClimateSunriseBegin</a> - sets the time sunrise begins as a number of 10 minute units since midnight.<br />
...
<p><a id="SetClimateSunriseEnd" class="f" href="https://cs.uesp.net/wiki/SetClimateSunriseEnd">SetClimateSunriseEnd</a> - sets the time sunrise ends as a number of 10 minute units since midnight,<br />
...
<p><a id="SetClimateSunsetBegin" class="f" href="https://cs.uesp.net/wiki/SetClimateSunsetBegin">SetClimateSunsetBegin</a> - sets the time sunset begins as a number of 10 minute units since midnight.<br />
...
<p><a id="SetClimateSunsetEnd" class="f" href="https://cs.uesp.net/wiki/SetClimateSunsetEnd">SetClimateSunsetEnd</a> - sets the time sunset ends as a number of 10 minute units since midnight.<br />
...
<p><a id="SetClimateMoonPhaseLength" class="f" href="https://cs.uesp.net/wiki/SetClimateMoonPhaseLength">SetClimateMoonPhaseLength</a> - sets the number of days in the phase of the moons<br />
<code class="s">(nothing) SetClimateMoonPhaseLength nuPhaseLength:int climate:ref</code></p>

<p><a id="SetClimateHasMasser" class="f" href="https://cs.uesp.net/wiki/SetClimateHasMasser">SetClimateHasMasser</a> - sets  whether the climate shows the moon Masser<br />
<code class="s">(nothing) SetClimateHasMasser hasMasser:bool climate:ref</code></p>

<p><a id="SetClimateHasSecunda" class="f" href="https://cs.uesp.net/wiki/SetClimateHasSecunda">SetClimateHasSecunda</a> - sets whether the climate shows the moon Secunda<br />
<code class="s">(nothing) SetClimateHasSecunda hasSecunda:bool climate:ref</code></p>

<p><a id="GetClimateVolatility" class="f" href="https://cs.uesp.net/wiki/GetClimateVolatility">GetClimateVolatility</a> - returns the volatility of the climate<br />
<code class="s">(volatility:int) GetClimateVolatility climate:ref</code></p>

<p><a id="SetClimateVolatility" class="f" href="https://cs.uesp.net/wiki/SetClimateVolatility">SetClimateVolatility</a> - sets the volatility of the climate<br />
...
<p><a id="IsCreature" class="f" href="https://cs.uesp.net/wiki/IsCreature">IsCreature</a> - returns whether the reference or passed id is a creature<br />
<code class="s">(isCreature:bool) <span class="op">reference.</span>IsCreature <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureType" class="f" href="https://cs.uesp.net/wiki/GetCreatureType">GetCreatureType</a> - returns the type of the creature (Undead, Humanoid, Daedrea etc)<br />
...
<p><a id="SetCreatureType" class="f" href="https://cs.uesp.net/wiki/SetCreatureType">SetCreatureType</a> - attempts to change the type of the creature.<br />
...
<p><a id="GetCreatureCombatSkill" class="f" href="https://cs.uesp.net/wiki/GetCreatureCombatSkill">GetCreatureCombatSkill</a> - returns the combat skill for the creature<br />
<code class="s">(combatSkill:int) <span class="op">reference</span>.GetCreatureCombatSkill <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureMagicSkill" class="f" href="https://cs.uesp.net/wiki/GetCreatureMagicSkill">GetCreatureMagicSkill</a> - returns the magic skill for the creature<br />
<code class="s">(magicSkill:int) <span class="op">reference</span>.GetCreatureMagicSkill <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureStealthSkill" class="f" href="https://cs.uesp.net/wiki/GetCreatureStealthSkill">GetCreatureStealthSkill</a> - returns the stealth skill for the creature<br />
...
<p><a id="SetCreatureSkill" class="f" href="https://cs.uesp.net/wiki/SetCreatureSkill">SetCreatureSkill</a> - sets the value of one of the creature's skills. Pass "stealth", "magic", or "combat" as the skill name. The skill value must be between 0 and 255.<br />
...
<p><a id="GetCreatureReach" class="f" href="https://cs.uesp.net/wiki/GetCreatureReach">GetCreatureReach</a> - returns the reach of the creature<br />
<code class="s">(reach:int) <span class="op">reference</span>.GetCreatureReach <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureSoulLevel" class="f" href="https://cs.uesp.net/wiki/GetCreatureSoulLevel">GetCreatureSoulLevel</a> - returns the soul level of the creature<br />
...
<p><a id="GetCreatureBaseScale" class="f" href="https://cs.uesp.net/wiki/GetCreatureBaseScale">GetCreatureBaseScale</a> - retuns the base scale of the creature<br />
<code class="s">(scale:float) <span class="op">reference</span>.GetCreatureBaseScale <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureWalks" class="f" href="https://cs.uesp.net/wiki/GetCreatureWalks">GetCreatureWalks</a> - returns 1 if the Walks flag is set on the creature<br />
<code class="s">(walks:bool) <span class="op">reference.</span>GetCreatureWalks <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureSwims" class="f" href="https://cs.uesp.net/wiki/GetCreatureSwims">GetCreatureSwims</a> - returns 1 if the Swims flag is set on the creature<br />
<code class="s">(swims:bool) <span class="op">reference.</span>GetCreatureSwims <span class="op">creature:ref</span></code></p>

<p><a id="GetCreatureFlies" class="f" href="https://cs.uesp.net/wiki/GetCreatureFlies">GetCreatureFlies</a> - returns 1 if the Flies flag is set on the creature<br />
<code class="s">(flies:bool) <span class="op">reference.</span>GetCreatureFlies <span class="op">creature:ref</span></code></p>

<p><a id="IsCreatureBiped" class="f" href="https://cs.uesp.net/wiki/IsCreatureBiped">IsCreatureBiped</a> - returns 1 if the Biped flag is set on the creature<br />
<code class="s">(biped:bool) <span class="op">reference.</span>isCreatureBiped <span class="op">creature:ref</span></code></p>

<p><a id="CreatureHasNoMovement" class="f" href="https://cs.uesp.net/wiki/CreatureHasNoMovement">CreatureHasNoMovement</a> - returns 1 if the No Movement flag is set on the creature<br />
<code class="s">(noMovement:bool) <span class="op">reference.</span>CreatureHasNoMovement <span class="op">creature:ref</span></code></p>

<p><a id="CreatureHasNoHead" class="f" href="https://cs.uesp.net/wiki/CreatureHasNoHead">CreatureHasNoHead</a> - returns 1 if the No Head flag is set on the creature<br />
<code class="s">(noHead:bool) <span class="op">reference.</span>CreatureHasNoHead <span class="op">creature:ref</span></code></p>

<p><a id="CreatureHasNoLeftArm" class="f" href="https://cs.uesp.net/wiki/CreatureHasNoLeftArm">CreatureHasNoLeftArm</a> - returns 1 if the No Left Arm flag is set on the creature.<br />
<code class="s">(noLeftArm:bool) <span class="op">reference.</span>CreatureHasNoLeftArm <span class="op">creature:ref</span></code></p>

<p><a id="CreatureHasNoRightArm" class="f" href="https://cs.uesp.net/wiki/CreatureHasNoRightArm">CreatureHasNoRightArm</a> - returns 1 if the No Right Arm flag is set on the creature.<br />
<code class="s">(noRightArm:bool) <span class="op">reference.</span>CreatureHasNoRightArm <span class="op">creature:ref</span></code></p>

<p><a id="CreatureNoCombatInWater" class="f" href="https://cs.uesp.net/wiki/CreatureNoCombatInWater">CreatureNoCombatInWater</a> - returns 1 if the No Combat In Water flag is set on the creature.<br />
<code class="s">(noCombat:bool) <span class="op">reference.</span>CreatureNoCombatInWater <span class="op">creature:ref</span></code></p>

<p><a id="CreatureUsesWeaponAndShield" class="f" href="https://cs.uesp.net/wiki/CreatureUsesWeaponAndShield">CreatureUsesWeaponAndShield</a> - returns 1 if the Uses Weapon and Shield flag is set on the creature.<br />
...
<p><a id="GetRider" class="f" href="https://cs.uesp.net/wiki/GetRider">GetRider</a> - returns the NPC currently riding the calling horse.<br />
...
<p><a id="GetCreatureSoundBase" class="f" href="https://cs.uesp.net/wiki/GetCreatureSoundBase">GetCreatureSoundBase</a> - returns the creature from which the specified creature's sounds are derived, if any.<br />
<code class="s">(creature:ref) <span class="op">reference.</span>GetCreatureSoundBase <span class="op">creature:ref</span></code></p>

<p><a id="SetCreatureSoundBase" class="f" href="https://cs.uesp.net/wiki/SetCreatureSoundBase">SetCreatureSoundBase</a> - sets the creature from which the creature inherits its sounds. The inheriting creature must not itself be a sound base (mustn't define its own sounds), and the creature specified as the sound base must be a sound base (defining its own sounds) or null.<br />
...
<p><a id="GetCreatureSound" class="f" href="https://cs.uesp.net/wiki/GetCreatureSound">GetCreatureSound</a> - returns the creature's sound associated with the specified action.<br />
...
<p><a id="GetCreatureModelPaths" class="f" href="https://cs.uesp.net/wiki/GetCreatureModelPaths">GetCreatureModelPaths</a> - returns an Array containing the set of model paths in the creature's model list. Only those models which are toggled on are included.<br />
...
<p><a id="GetCombatStyle" class="f" href="https://cs.uesp.net/wiki/GetCombatStyle">GetCombatStyle</a> - returns the combat style assigned to the calling reference.<br />
...
<p><a id="IsLoadDoor" class="f" href="https://cs.uesp.net/wiki/IsLoadDoor">IsLoadDoor</a> - returns 1 if the calling reference is a load door<br />
...
<p><a id="GetLinkedDoor" class="f" href="https://cs.uesp.net/wiki/GetLinkedDoor">GetLinkedDoor</a> - returns the door to which the calling load door is linked<br />
<code class="s">(linkedDoor:ref) reference.GetLinkedDoor</code></p>

<p><a id="GetTeleportCell" class="f" href="https://cs.uesp.net/wiki/GetTeleportCell">GetTeleportCell</a> - returns the cell to which the calling load door teleports<br />
<code class="s">(cell:ref) reference.GetTeleportCell</code></p>

<p><a id="IsOblivionGate" class="f" href="https://cs.uesp.net/wiki/IsOblivionGate">IsOblivionGate</a> -returns true if the door is flagged as an Oblivion gate in the editor.<br />
<code class="s">(isOBGate:bool) <span class="op">reference.</span>IsOblivionGate <span class="op">door:ref</span></code></p>

<p><a id="IsHiddenDoor" class="f" href="https://cs.uesp.net/wiki/IsHiddenDoor">IsHiddenDoor</a> - returns 1 if the "hidden" flag is set for the door.<br />
<code class="s">(isHidden:bool) <span class="op">reference.</span>IsHiddenDoor <span class="op">door:ref</span></code></p>

<p><a id="IsAutomaticDoor" class="f" href="https://cs.uesp.net/wiki/IsAutomaticDoor">IsAutomaticDoor</a> - returns 1 if the "Automatic" flag is set for the door.<br />
<code class="s">(isAutomatic:bool) <span class="op">reference.</span>IsAutomaticDoor <span class="op">door:ref</span></code></p>

<p><a id="IsMinimalUseDoor" class="f" href="https://cs.uesp.net/wiki/IsMinimalUseDoor">IsMinimalUseDoor</a> - returns 1 if the "Minimal Use" flag is set for the door.<br />
<code class="s">(isMinimalUse:bool) <span class="op">reference.</span>IsMinimalUseDoor <span class="op">door:ref</span></code></p>

<p><a id="SetIsHiddenDoor" class="f" href="https://cs.uesp.net/wiki/SetIsHiddenDoor">SetIsHiddenDoor</a> - sets or clears the "hidden" flag for the door.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetIsHiddenDoor setFlag:bool <span class="op">door:ref</span></code></p>

<p><a id="SetIsAutomaticDoor" class="f" href="https://cs.uesp.net/wiki/SetIsAutomaticDoor">SetIsAutomaticDoor</a> - sets or clears the "Automatic" flag for the door.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetIsAutomaticDoor setFlag:bool <span class="op">door:ref</span></code></p>

<p><a id="SetIsMinimalUseDoor" class="f" href="https://cs.uesp.net/wiki/SetIsMinimalUseDoor">SetIsMinimalUseDoor</a> - sets or clears the "Minimal Use" flag for the door.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetIsMinimalUseDoor setFlag:bool <span class="op">door:ref</span></code></p>

<p><a id="SetIsOblivionGate" class="f" href="https://cs.uesp.net/wiki/SetIsOblivionGate">SetIsOblivionGate</a> - sets or clears the "Oblivion Gate" flag for the door.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetIsOblivionGate setFlag:bool <span class="op">door:ref</span></code></p>

<p><a id="SetDoorTeleport" class="f" href="https://cs.uesp.net/wiki/SetDoorTeleport">SetDoorTeleport</a> - sets the reference, coordinates, and rotation to which the calling door teleports. Only the reference argument is required; the values for the others will be taken from the specified reference's coordinates and rotation if omitted. The bTemporary argument specifies that the change should not be saved in the savegame; by default, or if the argument is zero, the change will be saved.<br />
...
<p><a id="LinkToDoor" class="f" href="https://cs.uesp.net/wiki/LinkToDoor">LinkToDoor</a> - links the calling door reference to the specified door reference. This causes each of the doors to teleport to the other when activated. Both doors must be persistent references and neither can already be linked to another door. Actors will use the doors in their pathfinding. The change persists in the savegame.<br />
<code class="s">(linked:bool) reference.LinkToDoor otherDoor:ref</code></p>

<p><a id="GetDoorTeleportX" class="f" href="https://cs.uesp.net/wiki/GetDoorTeleportX">GetDoorTeleportX</a> - returns the x coordinate to which the calling door teleports.<br />
<code class="s">(coord:float) reference.GetDoorTeleportX</code></p>

<p><a id="GetDoorTeleportY" class="f" href="https://cs.uesp.net/wiki/GetDoorTeleportY">GetDoorTeleportY</a> - returns the y coordinate to which the calling door teleports.<br />
<code class="s">(coord:float) reference.GetDoorTeleportY</code></p>

<p><a id="GetDoorTeleportZ" class="f" href="https://cs.uesp.net/wiki/GetDoorTeleportZ">GetDoorTeleportZ</a> - returns the z coordinate to which the calling door teleports.<br />
<code class="s">(coord:float) reference.GetDoorTeleportZ</code></p>

<p><a id="GetDoorTeleportRot" class="f" href="https://cs.uesp.net/wiki/GetDoorTeleportRot">GetDoorTeleportRot</a> - returns the rotation to which the calling door teleports. This is the angle the player will be facing after activatingthe load door.<br />
<code class="s">(coord:float) reference.GetDoorTeleportRot</code></p>

<p><a id="GetTeleportCellName" class="f" href="https://cs.uesp.net/wiki/GetTeleportCellName">GetTeleportCellName</a> - when called on a teleporting door reference, returns the name of the cell or worldspace to which the door teleports<br />
...
<p><a id="GetEnchantmentType" class="f" href="https://cs.uesp.net/wiki/GetEnchantmentType">GetEnchantmentType</a> - returns the type of the enchantment<br />
<code class="s">(<a href="#Enchantment_Type">enchantType</a>:int) GetEnchantmentType objectID:ref</code></p>

<p><a id="SetEnchantmentType" class="f" href="https://cs.uesp.net/wiki/SetEnchantmentType">SetEnchantmentType</a> - sets the type of the enchantment<br />
<code class="s">(nothing) SetEnchantmentType <a href="#Enchantment_Type">enchantType</a>:int objectID:ref</code></p>

<p><a id="GetEnchantmentCharge" class="f" href="https://cs.uesp.net/wiki/GetEnchantmentCharge">GetEnchantmentCharge</a> - returns the charge of the enchantment. Of unknown and dubious use.<br />
...
<p><a id="SetEnchantmentCharge" class="f" href="https://cs.uesp.net/wiki/SetEnchantmentCharge">SetEnchantmentCharge</a> - sets the charge of the enchantment. Of unknown and dubious use.<br />
<b>Note: </b>While this value exists in the CS, it doesn't seem to do anything. Charge is determined by enchantment points on the weapon/enchantment cost of the enchantment.<br />
<code class="s">(nothing) SetEnchantmentCharge nuCharge:int objectID:ref</code></p>

<p><a id="ModEnchantmentCharge" class="f" href="https://cs.uesp.net/wiki/ModEnchantmentCharge">ModEnchantmentCharge</a> - modifies the charge of the enchantment. Of unknown and dubious use.<br />
<b>Note: </b>While this value exists in the CS, it doesn't seem to do anything. Charge is determined by enchantment points on the weapon/enchantment cost of the enchantment.<br />
<code class="s">(nothing) ModEnchantmentCharge modifyBy:float objectID:ref</code></p>

<p><a id="GetEnchantmentCost" class="f" href="https://cs.uesp.net/wiki/GetEnchantmentCost">GetEnchantmentCost</a> - returns the magicka charge cost for using the enchantment.<br />
<code class="s">(cost:int) GetEnchantmentCost objectID:ref</code></p>

<p><a id="SetEnchantmentCost" class="f" href="https://cs.uesp.net/wiki/SetEnchantmentCost">SetEnchantmentCost</a> - sets the cost for using the enchantment.<br />
...
<p><a id="ModEnchantmentCost" class="f" href="https://cs.uesp.net/wiki/ModEnchantmentCost">ModEnchantmentCost</a> - modifies the cost for using the enchantment up or down.<br />
<b>Note: </b>This has no effect if the enchantment has the Auto-Calculate flag, see <code><a href="#SetMagicItemAutoCalc">SetMagicItemAutoCalc</a></code>.<br />
...
<p><a id="FactionHasSpecialCombat" class="f" href="https://cs.uesp.net/wiki/FactionHasSpecialCombat">FactionHasSpecialCombat</a> - returns 1 if the Special Combat flag is set on the faction<br />
<code class="s">(hasSpecialCombat:bool) FactionHasSpecialCombat faction:ref</code></p>

<p><a id="IsFactionEvil" class="f" href="https://cs.uesp.net/wiki/IsFactionEvil">IsFactionEvil</a> - returns 1 if the faction is marked as evil.<br />
<code class="s">(isEvil:bool) IsFactionEvil faction:ref</code></p>

<p><a id="IsFactionHidden" class="f" href="https://cs.uesp.net/wiki/IsFactionHidden">IsFactionHidden</a> - returns 1 if the faction is not shown on the player's faction sheet.<br />
<code class="s">(isHidden:bool) IsFactionHidden faction:ref</code></p>

<p><a id="SetFactionEvil" class="f" href="https://cs.uesp.net/wiki/SetFactionEvil">SetFactionEvil</a> - changes the Evil flag on the faction. Changes are saved in the savegame.<br />
<code class="s">(nothing) SetFactionEvil faction:ref isEvil:int</code></p>

<p><a id="SetFactionHidden" class="f" href="https://cs.uesp.net/wiki/SetFactionHidden">SetFactionHidden</a> - changes the Hidden flag on the faction. Changes are saved in the savegame.<br />
<code class="s">(nothing) SetFactionHidden faction:ref isHidden:int</code></p>

<p><a id="SetFactionHasSpecialCombat" class="f" href="https://cs.uesp.net/wiki/SetFactionHasSpecialCombat">SetFactionHasSpecialCombat</a> - changes the Special Combat flag on the faction. Changes are saved in the savegame.<br />
<code class="s">(nothing) SetFactionHasSpecialCombat faction:ref hasSpecialCombat:int</code></p>

<p><a id="GetNumRanks" class="f" href="https://cs.uesp.net/wiki/GetNumRanks">GetNumRanks</a> - returns the number of ranks in the faction.<br />
<code class="s">(numRanks:int) GetNumRanks faction:ref</code></p>

<p><a id="GetNthFactionRankName" class="f" href="https://cs.uesp.net/wiki/GetNthFactionRankName">GetNthFactionRankName</a> - returns the title of the nth rank in a faction. Optionally returns the female rank name.<br />
<code class="s">(rankName:string_var) GetNthFactionRankName faction:ref whichRank:int <span class="op">female:bool</span></code></p>

<p><a id="SetNthFactionRankNameEX" class="f" href="https://cs.uesp.net/wiki/SetNthFactionRankNameEX">SetNthFactionRankNameEX</a> - sets the title of the nth rank in a faction. Optionally sets the female rank name.<br />
...
<p><a id="IsHarvested" class="f" href="https://cs.uesp.net/wiki/IsHarvested">IsHarvested</a> - returns 1 if the calling reference's ingredient has been harvested.<br />
<code class="s">(isHarvested:bool) reference.IsHarvested</code></p>

<p><a id="SetHarvested" class="f" href="https://cs.uesp.net/wiki/SetHarvested">SetHarvested</a> - mark or unmark the calling reference as having been harvested. Changes are saved in the savegame.<br />
...
<p><a id="GetIngredient" class="f" href="https://cs.uesp.net/wiki/GetIngredient">GetIngredient</a> - returns the ingredient contained in a plant.<br />
<code class="s">(ingredient:ref) <span class="op">reference.</span>GetIngredient <span class="op">flora:ref</span></code></p>

<p><a id="SetIngredient" class="f" href="https://cs.uesp.net/wiki/SetIngredient">SetIngredient</a> - sets the ingredient contained in a plant. Omit the ingredient parameter or pass an empty ref variable to set it to "no ingredient."<br />
<code class="s">(nothing) <span class="op">reference.</span>SetIngredient <span class="op">ingredient:ref flora:ref</span></code></p>

<p><a id="GetIngredientChance" class="f" href="https://cs.uesp.net/wiki/GetIngredientChance">GetIngredientChance</a> - returns the % chance of harvesting an ingredient from the plant for a specific season where 0 = spring, 1 = summer, 2 = autumn, and 3 = winter. Return value ranges from 0 to 100.<br />
...
<p><a id="SetIngredientChance" class="f" href="https://cs.uesp.net/wiki/SetIngredientChance">SetIngredientChance</a> - sets the %chance of harvesting an ingredient based on the specified season.<br />
...
<p><a id="AddToLeveledList" class="f" href="https://cs.uesp.net/wiki/AddToLeveledList">AddToLeveledList</a> - adds an object to a leveled creature, spell, or item list. <span class="op">Count</span> defaults to 1 if unspecified.<br />
<code class="s">(nothing) AddToLeveledList leveledList:ref object:ref level:int <span class="op">count:int</span></code></p>

<p><a id="RemoveFromLeveledList" class="f" href="https://cs.uesp.net/wiki/RemoveFromLeveledList">RemoveFromLeveledList</a> - removes all occurences of an object from a leveled list and returns the number of occurences removed.<br />
<code class="s">(numRemoved:int) RemoveFromLeveledList leveledList:ref object:ref</code></p>

<p><a id="CalcLeveledItem" class="f" href="https://cs.uesp.net/wiki/CalcLeveledItem">CalcLeveledItem</a> - returns one item from a leveled item list, selected randomly for a character of the specified level.<br />
...
<p><a id="CalcLevItemNR" class="f" href="https://cs.uesp.net/wiki/CalcLevItemNR">CalcLevItemNR</a> - does the same thing as CalcLeveledItem but will not recurse through nested leveled lists. This means that unlike CalcLeveledItem, CalcLevItemNR can return another leveled list rather than a real object.<br />
...
<p><a id="CalcLevItems" class="f" href="https://cs.uesp.net/wiki/CalcLevItems">CalcLevItems</a> - returns an Array of StringMaps representing items selected randomly from a leveled item list. This command uses the game code to select items, which means the items returned are the same as those the game would select for an actor of the specified level. Each entry in the returned Array is a StringMap with the key-value pairs: "item":item (form) and "count":count (integer). The optional "count" parameter is 1 by default.<br />
...
<p><a id="GetCalcAllLevels" class="f" href="https://cs.uesp.net/wiki/GetCalcAllLevels">GetCalcAllLevels</a> - returns 1 if the "calculate for all levels &lt;= PC level" flag is checked.<br />
<code class="s">(calcAllLevels:bool) GetCalcAllLevels leveledList:ref</code></p>

<p><a id="SetCalcAllLevels" class="f" href="https://cs.uesp.net/wiki/SetCalcAllLevels">SetCalcAllLevels</a> - sets the "calculate for all levels &lt;= PC level" flag on the leveled list.<br />
<code class="s">(nothing) SetCalcAllLevels leveledList:ref enabled:bool</code></p>

<p><a id="GetCalcEachInCount" class="f" href="https://cs.uesp.net/wiki/GetCalcEachInCount">GetCalcEachInCount</a> - returns 1 if the "calculate for each item in count" flag is checked.<br />
<code class="s">(calcEach:bool) GetCalcEachInCount leveledList:ref</code></p>

<p><a id="GetChanceNone" class="f" href="https://cs.uesp.net/wiki/GetChanceNone">GetChanceNone</a> - returns the chance from 0 to 100 that a leveled list returns no item.<br />
<code class="s">(chanceNone:int) GetChanceNone leveledList:ref</code></p>

<p><a id="GetNthLeveledItem" class="f" href="https://cs.uesp.net/wiki/GetNthLevItem">GetNthLevItem</a> - returns the Nth element in a leveled list, as ordered in the Construction Set.<br />
<code class="s">(element:ref) GetNthLevItem index:int leveledList:ref</code></p>

<p><a id="GetNthLevItemCount" class="f" href="https://cs.uesp.net/wiki/GetNthLevItemCount">GetNthLevItemCount</a> - returns the count of the Nth element of a leveled list.<br />
<code class="s">(count:int) GetNthLevItemCount index:int leveledList:ref</code></p>

<p><a id="GetNthLevItemLevel" class="f" href="https://cs.uesp.net/wiki/GetNthLevItemLevel">GetNthLevItemLevel</a> - returns the level of the Nth element of a leveled list.<br />
<code class="s">(level:int) GetNthLevItemLevel index:int leveledList:ref</code></p>

<p><a id="GetNumLevItems" class="f" href="https://cs.uesp.net/wiki/GetNumLevItems">GetNumLevItems</a> - returns the number of elements in a leveled list.<br />
<code class="s">(numItems:int) GetNumLevitems leveledList:ref</code></p>

<p><a id="GetLevItemByLevel" class="f" href="https://cs.uesp.net/wiki/GetLevItemByLevel">GetLevItemByLevel</a> - returns the first element of the specified level in the leveled list.<br />
<code class="s">(element:ref) GetLevItemByLevel whichLevel:int leveledList:ref</code></p>

<p><a id="RemoveLevItemByLevel" class="f" href="https://cs.uesp.net/wiki/RemoveLevItemByLevel">RemoveLevItemByLevel</a> - removes any elements of the specified level from a leveled list<br />
<code class="s">(numRemoved:int) RemoveLevItemByLevel whichLevel:int leveledList:ref</code></p>

<p><a id="ClearLeveledList" class="f" href="https://cs.uesp.net/wiki/ClearLeveledList">ClearLeveledList</a> - removes all elements from a leveled list.<br />
<code class="s">(nothing) ClearLeveledList leveledList:ref</code></p>

<p><a id="RemoveNthLevItem" class="f" href="https://cs.uesp.net/wiki/RemoveNthLevItem">RemoveNthLevItem</a> - removes the nth item from a leveled list.<br />
<code class="s">(nothing) RemoveNthLevItem index:int leveledList:ref</code></p>

<p><a id="GetLevItemIndexByLevel" class="f" href="https://cs.uesp.net/wiki/GetLevItemIndexByLevel">GetLevItemIndexByLevel</a> - returns the index of the first item of the specified level within a leveled list, or -1 if no item exists for that level.<br />
<code class="s">(index:int) GetLevItemIndexByLevel level:int leveledList:ref</code></p>

<p><a id="GetLevItemIndexByForm" class="f" href="https://cs.uesp.net/wiki/GetLevItemIndexByForm">GetLevItemIndexByForm</a> - returns the index of the first occurrence of the specified form in a leveled list, or -1 if the form is not found.<br />
<code class="s">(index:int) GetLevItemIndexByForm leveledList:ref formToFind:ref</code></p>

<p><a id="SetChanceNone" class="f" href="https://cs.uesp.net/wiki/SetChanceNone">SetChanceNone</a> - sets the chance that a leveled list generates no item.<br />
<code class="s">(nothing) SetChanceNone chance:int levlist:ref</code></p>

<p><a id="GetLevCreatureTemplate" class="f" href="https://cs.uesp.net/wiki/GetLevCreatureTemplate">GetLevCreatureTemplate</a> - gets the template actor of a leveled creature list.<br />
<code class="s">(template:ref) GetLevCreatureTemplate leveledCreature:ref</code></p>

<p><a id="SetLevCreatureTemplate" class="f" href="https://cs.uesp.net/wiki/SetLevCreatureTemplate">SetLevCreatureTemplate</a> - sets the template actor of a leveled creature. Omitting or passing a null ref as the second argument will remove any existing template.<br />
...
<p><a id="IsLightCarriable" class="f" href="https://cs.uesp.net/wiki/IsLightCarriable">IsLightCarriable</a> - returns 1 if the light may be placed in an inventory.<br />
<code class="s">(isCarriable:bool) <span class="op">reference.</span>IsLightCarriable <span class="op">light:ref</span></code></p>

<p><a id="GetLightRadius" class="f" href="https://cs.uesp.net/wiki/GetLightRadius">GetLightRadius</a> - returns the radius of the light.<br />
<code class="s">(radius:int) <span class="op">reference.</span>GetLightRadius <span class="op">light:ref</span></code></p>

<p><a id="SetLightRadius" class="f" href="https://cs.uesp.net/wiki/SetLightRadius">SetLightRadius</a> - sets the radius of the light. Changes are not saved in the savegame.<br />
...
<p><a id="GetLightRGB" class="f" href="https://cs.uesp.net/wiki/GetLightRGB">GetLightRGB</a> - returns the red, green, and blue components of the light's color as an Array of 3 elements of values 0 through 255. The first element corresponds to the red value, the second to green, and the third to blue.<br />
<code class="s">(rgb:Array) <span class="op">reference.</span>GetLightRGB <span class="op">light:ref</span></code></p>

<p><a id="SetLightRGB" class="f" href="https://cs.uesp.net/wiki/SetLightRGB">SetLightRGB</a> - sets the red, green, and blue components of the light's color, accepting the components as an Array of 3 elements of values 0 through 255. The first element corresponds to the red value, the second to green, and the third to blue.<br />
<code class="s">(colorChanged:bool) <span class="op">reference.</span>SetLightRGB rgb:Array <span class="op">light:ref</span></code></p>

<p><a id="GetLightDuration" class="f" href="https://cs.uesp.net/wiki/GetLightDuration">GetLightDuration</a> - returns the duration of the light as defined in the editor.<br />
<code class="s">(duration:int) <span class="op">reference</span>.GetLightDuration <span class="op">light:ref</span></code></p>

<p><a id="SetLightDuration" class="f" href="https://cs.uesp.net/wiki/SetLightDuration">SetLightDuration</a> - sets the duration of the light.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetLightDuration duration:int <span class="op">light:ref</span></code></p>

<p><a id="GetTimeLeft" class="f" href="https://cs.uesp.net/wiki/GetTimeLeft">GetTimeLeft</a> - returns the amount of time left before the calling light reference expires.<br />
<code class="s">(timeLeft:float) reference.GetTimeLeft</code></p>

<p><a id="GetEquippedTorchTimeLeft" class="f" href="https://cs.uesp.net/wiki/GetEquippedTorchTimeLeft">GetEquippedTorchTimeLeft</a> - returns the amount of time before the torch equipped by the calling actor expires.<br />
<code class="s">(timeLeft:float) reference.GetEquippedTorchTimeLeft</code></p>

<p><a id="SetTimeLeft" class="f" href="https://cs.uesp.net/wiki/SetTimeLeft">SetTimeLeft</a> - sets the amount of time before the calling light reference expires. <br />
...
<p><a id="GetMagicEffectCode" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectCode">GetMagicEffectCode</a> - returns the magic effect code of the effect.<br />
...
<p><a id="GetMagicEffectChars" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectChars">GetMagicEffectChars</a> - returns the 4-character code for a magic effect<br />
<code class="s">(chars:string) GetMagicEffectChars magicEffect:ref</code></p>

<p><a id="GetMagicEffectCharsC" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectCharsC">GetMagicEffectCharsC</a> - returns the 4-character code for a magic effect<br />
<code class="s">(chars:string) GetMagicEffectCharsC effectCode:int</code></p>

<p><a id="MagicEffectFromCode" class="f" href="https://cs.uesp.net/wiki/MagicEffectFromCode">MagicEffectFromCode</a> - given an effect code, returns the effect setting matching that code.<br />
<code class="s">(magicEffect:ref) MagicEffectFromCode effectCode:int</code></p>

<p><a id="MagicEffectFromChars" class="f" href="https://cs.uesp.net/wiki/MagicEffectFromChars">MagicEffectFromChars</a> - given a string representing a four-letter effect code (e.g. "REHE"), returns the effect setting matching that code<br />
<code class="s">(magicEffect:ref) MagicEffectFromChars effectChars:String</code></p>

<p><a id="MagicEffectCodeFromChars" class="f" href="https://cs.uesp.net/wiki/MagicEffectCodeFromChars">MagicEffectCodeFromChars</a> - given a string representing a four-letter effect code (e.g. "REHE"), returns the effect code for the associated effect setting.<br />
...
<p><a id="GetMagicEffectBaseCost" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectBaseCost">GetMagicEffectBaseCost(C)</a> - returns the base cost of the magic effect<br />
...
<p><a id="GetMagicEffectSchool" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectSchool">GetMagicEffectSchool(C)</a> - returns the controlling school of the magic effect<br />
...
<p><a id="GetMagicEffectProjectileSpeed" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectProjectileSpeed">GetMagicEffectProjectileSpeed(C)</a> - returns the projectile speed of the magic effect<br />
...
<p><a id="GetMagicEffectEnchantFactor" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectEnchantFactor">GetMagicEffectEnchantFactor(C)</a> - returns the constant effect enchantment factor of the magic effect<br />
...
<p><a id="GetMagicEffectBarterFactor" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectBarterFactor">GetMagicEffectBarterFactor(C)</a> - returns the constant effect barter factor of the magic effect<br />
...
<p><a id="IsMagicEffectHostile" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectHostile">IsMagicEffectHostile(C)</a> - returns whether the magic effect is hostile<br />
...
<p><a id="IsMagicEffectForSpellmaking" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectForSpellmaking">IsMagicEffectForSpellmaking(C)</a> - returns whether the magic effect can be used for spell making<br />
...
<p><a id="IsMagicEffectForEnchanting" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectForEnchanting">IsMagicEffectForEnchanting(C)</a> - returns whether the magic effect can be used when enchanting<br />
...
<p><a id="IsMagicEffectDetrimental" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectDetrimental">IsMagicEffectDetrimental(C)</a> - returns whether the magic effect harms the receipient<br />
...
<p><a id="IsMagicEffectCanRecover" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectCanRecover">IsMagicEffectCanRecover(C)</a> - returns whether the target can recover from the effect<br />
...
<p><a id="IsMagicEffectMagnitudePercent" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectMagnitudePercent">IsMagicEffectMagnitudePercent(C)</a> - returns whether the magic effect's magnitude is a percentage<br />
...
<p><a id="MagicEffectFXPersists" class="f" href="https://cs.uesp.net/wiki/MagicEffectFXPersists">MagicEffectFXPersists(C)</a> - returns whether the magic effect's graphics effects persist<br />
...
<p><a id="IsMagicEffectOnSelfAllowed" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectOnSelfAllowed">IsMagicEffectOnSelfAllowed(C)</a> - returns whether the magic effect can be cast on self<br />
...
<p><a id="IsMagicEffectOnTouchAllowed" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectOnTouchAllowed">IsMagicEffectOnTouchAllowed(C)</a> - returns whether the magic effect can be cast on touch<br />
...
<p><a id="IsMagicEffectOnTargetAllowed" class="f" href="https://cs.uesp.net/wiki/IsMagicEffectOnTargetAllowed">IsMagicEffectOnTargetAllowed(C)</a> - returns whether the magic effect can be cast on target<br />
...
<p><a id="MagicEffectHasNoDuration" class="f" href="https://cs.uesp.net/wiki/MagicEffectHasNoDuration">MagicEffectHasNoDuration(C)</a> - returns whether the magic effect doesn't use the duration value<br />
...
<p><a id="MagicEffectHasNoMagnitude" class="f" href="https://cs.uesp.net/wiki/MagicEffectHasNoMagnitude">MagicEffectHasNoMagnitude(C)</a> - returns whether the magic effect doesn't use the magnitude value<br />
...
<p><a id="MagicEffectHasNoArea" class="f" href="https://cs.uesp.net/wiki/MagicEffectHasNoArea">MagicEffectHasNoArea(C)</a> - returns whether the magic effect doesn't use the area value<br />
...
<p><a id="MagicEffectHasNoIngredient" class="f" href="https://cs.uesp.net/wiki/MagicEffectHasNoIngredient">MagicEffectHasNoIngredient(C)</a> - returns whether the magic effect has no ingredient<br />
...
<p><a id="MagicEffectHasNoHitEffect" class="f" href="https://cs.uesp.net/wiki/MagicEffectHasNoHitEffect">MagicEffectHasNoHitEffect(C)</a> - returns whether the magic effect has a graphic effect when it hits<br />
...
<p><a id="MagicEffectUsesWeapon" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesWeapon">MagicEffectUsesWeapon(C)</a> - returns whether the magic effect summons a weapon<br />
...
<p><a id="MagicEffectUsesArmor" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesArmor">MagicEffectUsesArmor(C)</a> - returns whether the magic effect summons armor<br />
...
<p><a id="MagicEffectUsesCreature" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesCreature">MagicEffectUsesCreature(C)</a> - returns whether the magic effect summons a creature<br />
...
<p><a id="MagicEffectUsesSkill" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesSkill">MagicEffectUsesSkill(C)</a> - returns whether the magic effect affects a skill<br />
...
<p><a id="MagicEffectUsesAttribute" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesAttribute">MagicEffectUsesAttribute(C)</a> - returns whether the magic effect affects an attribute<br />
...
<p><a id="MagicEffectUsesOtherActorValue" class="f" href="https://cs.uesp.net/wiki/MagicEffectUsesOtherActorValue">MagicEffectUsesOtherActorValue(C)</a> - returns whether the magic effect affects an actor value that is not a skill or an attribute<br />
...
<p><a id="GetMagicEffectOtherActorValue" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectOtherActorValue">GetMagicEffectOtherActorValue(C)</a> - returns the actor value (skill, attribute or other) affected by the magic effect<br />
...
<p><a id="GetMagicEffectUsedObject" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectUsedObject">GetMagicEffectUsedObject(C)</a> - returns the weapon, armor or creature summoned by the magic effect<br />
...
<p><a id="RemoveNthMagicEffectCounter" class="f" href="https://cs.uesp.net/wiki/RemoveNthMagicEffectCounter">RemoveNthMagicEffectCounter(C)</a> - removes the <span class="op">n</span>th counter-effect for the magic effect.<br />
...
<p><a id="AddMagicEffectCounter" class="f" href="https://cs.uesp.net/wiki/AddMagicEffectCounter">AddMagicEffectCounter(C)</a> - adds a counter-effect to the magic effect. The 'C' version accepts magic effect codes for both arguments.<br />
...
<p><a id="GetMagicEffectCounters" class="f" href="https://cs.uesp.net/wiki/GetMagicEffectCounters">GetMagicEffectCounters(C)</a> - returns an Array containing the effect codes of all counter-effects for the specified magic effect.<br />
...
<p><a id="IsMapMarkerVisible" class="f" href="https://cs.uesp.net/wiki/IsMapMarkerVisible">IsMapMarkerVisible</a> - returns 1 if the map marker can be seen on the player's map<br />
<code class="s">(visible:bool) reference.IsMapMarkerVisible</code></p>

<p><a id="SetMapMarkerVisible" class="f" href="https://cs.uesp.net/wiki/SetMapMarkerVisible">SetMapMarkerVisible</a> - sets whether the map marker can be seen on the player's map<br />
<code class="s">(nothing) reference.SetMapMarkerVisible visible:bool</code></p>

<p><a id="CanTravelToMapMarker" class="f" href="https://cs.uesp.net/wiki/CanTravelToMapMarker">CanTravelToMapMarker</a> - returns 1 if the player can travel to the map marker by clicking on it in the map menu<br />
<code class="s">(canTravel:bool) reference.CanTravelToMapMarker</code></p>

<p><a id="SetCanTravelToMapMarker" class="f" href="https://cs.uesp.net/wiki/SetCanTravelToMapMarker">SetCanTravelToMapMarker</a> - sets whether the player can travel to the map marker by clicking it in the map menu<br />
<code class="s">(nothing) reference.SetCanTravelToMapMarker canTravel:bool</code></p>

<p><a id="GetMapMarkerType" class="f" href="https://cs.uesp.net/wiki/GetMapMarkerType">GetMapMarkerType</a> - returns the type of icon used to represent the location on the map.<br />
...
<p><a id="SetMapMarkerType" class="f" href="https://cs.uesp.net/wiki/SetMapMarkerType">SetMapMarkerType</a> - sets the type of icon used to represent the location on the map.<br />
<b>Note: </b>Users of the Map Marker Overhaul mod will have more types available.<br />
<code class="s">(nothing) reference.SetMapMarkerType <a href="#Map_Marker_Types">markerType</a>:int</code></p>

<p><a id="GetMapMarkers" class="f" href="https://cs.uesp.net/wiki/GetMapMarkers">GetMapMarkers</a> - returns an Array containing all map marker references. The filter argument can be used to filter out markers based on their visibility and accessibility: pass 0 to include only visible markers which can be fast-traveled to, 1 to include all visible markers, and 2 to include all markers, including those which are not visible. The default filter value is 1. Pass a <a href="#Map_Marker_Types">markerType</a> parameter to include only markers of the specified type; omit it or pass zero to include all types.<br />
...
<p><a id="GetEquippedObject" class="f" href="https://cs.uesp.net/wiki/GetEquippedObject">GetEquippedObject</a> - returns the base object of the item equipped in the specified slot<br />
<code class="s">(objectID:ref) reference.GetEquippedObject <a href="#Equipment_Slot_IDs">slot</a>:int</code></p>

<p><a id="GetEquipmentSlotMask" class="f" href="https://cs.uesp.net/wiki/GetEquipmentSlotMask">GetEquipmentSlotMask</a> - Returns the base object of the first equipped object to match the specified equipment slot mask. If no 'value' parameter is specified, it is assumed to be the same value as the 'mask' parameter. For example, an object taking up the UpperBody, LowerBody, and Foot slots would have a mask of 4 + 8 + 32 = 44. See the "<a href="#Slot_Mask">equipment slot bit assignments</a>" list for more info.<br />
...
<p><a id="GetMerchantContainer" class="f" href="https://cs.uesp.net/wiki/GetMerchantContainer">GetMerchantContainer</a> - returns the reference to the NPC's merchant container<br />
<code class="s">(containerReference:ref) npc.GetMerchantContainer</code></p>

<p><a id="SetMerchantContainer" class="f" href="https://cs.uesp.net/wiki/SetMerchantContainer">SetMerchantContainer</a> - replaces the specified mechant's container and returns the old container. <br />
...
<p><a id="GetHorse" class="f" href="https://cs.uesp.net/wiki/GetHorse">GetHorse</a> - returns the horse currently ridden by the calling NPC.<br />
...
<p><a id="GetTravelHorse" class="f" href="https://cs.uesp.net/wiki/GetTravelHorse">GetTravelHorse</a> - returns a reference to the travel horse used by the calling reference.<br />
<code class="s">(horse:ref) reference.GetTravelHorse</code></p>

<p><a id="SetTravelHorse" class="f" href="https://cs.uesp.net/wiki/SetTravelHorse">SetTravelHorse</a> - Sets the travel horse used by the calling reference to the horse reference specified. Changes are not saved in the savegame.<br />
<code class="s">(nothing) reference.SetTravelHorse horse:ref</code></p>

<p><a id="IsFemale" class="f" href="https://cs.uesp.net/wiki/IsFemale">IsFemale</a> - returns 1 if the NPC is female.<br />
<code class="s">(isFemale:bool) <span class="op">reference.</span>IsFemale <span class="op">npc:ref</span></code></p>

<p><a id="CopyHair" class="f" href="https://cs.uesp.net/wiki/CopyHair">CopyHair</a> - Copies the hair style, length, and color from one NPC to another. Changes alter the base actor and are not saved in the savegame unless called on the player.<br/>
...
<p><a id="GetTrainerLevel" class="f" href="https://cs.uesp.net/wiki/GetTrainerLevel">GetTrainerLevel</a> - returns the level at which the NPC offers training.<br />
<code class="s">(level:int) <span class="op">reference.</span>GetTrainerLevel <span class="op">npc:ref</span></code></p>

<p><a id="GetTrainerSkill" class="f" href="https://cs.uesp.net/wiki/GetTrainerSkill">GetTrainerSkill</a> - returns the skill in which the NPC offers training as an <a href="#Actor_Value_Codes">actor value code.</a><br />
...
<p><a id="SetTrainerLevel" class="f" href="https://cs.uesp.net/wiki/SetTrainerLevel">SetTrainerLevel</a> - sets the level at which an NPC offers training.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetTrainerLevel newLevel:int <span class="op">npc:ref</span></code></p>

<p><a id="SetTrainerSkill" class="f" href="https://cs.uesp.net/wiki/SetTrainerSkill">SetTrainerSkill</a> - sets the skill in which an NPC offers training.<br />
<code class="s">(nothing) <span class="op">reference.</span>SetTrainerSkill newSkill:actorValue <span class="op">npc:ref</span></code></p>

<p><a id="GetServicesMask" class="f" href="https://cs.uesp.net/wiki/GetServicesMask">GetServicesMask</a> - returns an integer code representing the services offered by an NPC. The code is obtained by ORing (adding) <a href="#Service_Flags">service flags</a><br />
<code class="s">(servicesMask:int) <span class="op">reference.</span>GetServicesMask <span class="op">npc:ref</span></code></p>

<p><a id="OffersServicesC" class="f" href="https://cs.uesp.net/wiki/OffersServicesC">OffersServicesC</a> - returns 1 if the NPC offers all of the services specified by the services mask<br />
...
<p><a id="SetOffersServicesC" class="f" href="https://cs.uesp.net/wiki/SetOffersServicesC">SetOffersServicesC</a> - sets the services offered by the NPC to the specified services mask.<br />
...
<p><a id="GetPathNodesInRadius" class="f" href="https://cs.uesp.net/wiki/GetPathNodesInRadius">GetPathNodesInRadius</a> - returns an Array of all path nodes located within the circular area described by the center point (x, y) and the radius. By default, disabled nodes are ignored; pass 1 for the optional fourth argument to include them.<br />
...
<p><a id="GetPathNodePos" class="f" href="https://cs.uesp.net/wiki/GetPathNodePos">GetPathNodePos</a> - returns the x, y, or z coordinate of the specified path node. <br />
<code class="s">(pos:float) GetPathNodePos nodeID:int whichPos:axis</code></p>

<p><a id="IsPathNodeDisabled" class="f" href="https://cs.uesp.net/wiki/IsPathNodeDisabled">IsPathNodeDisabled</a> - returns 1 if the path node is disabled.<br />
<code class="s">(disabled:bool) IsPathNodeDisabled nodeID:int</code></p>

<p><a id="SetPathNodeDisabled" class="f" href="https://cs.uesp.net/wiki/SetPathNodeDisabled">SetPathNodeDisabled</a> - enables or disables the specified path node. This node will no longer be used in future pathfinding attempts, but actors who have already built a path including this node may continue along it normally. If this is undesirable, calling EvaluatePackage on the actor will force it to build a new path.<br />
<code class="s">(nothing) SetPathNodeDisabled nodeID:int disable:bool</code></p>

<p><a id="GetPathNodeLinkedRef" class="f" href="https://cs.uesp.net/wiki/GetPathNodeLinkedRef">GetPathNodeLinkedRef</a> - returns the persistent reference linked to this node in the editor, if any.<br />
<code class="s">(linked:ref) GetPathNodeLinkedRef nodeID:int</code></p>

<p><a id="PathEdgeExists" class="f" href="https://cs.uesp.net/wiki/PathEdgeExists">PathEdgeExists</a> - returns 1 if the two nodes are connected.<br />
...
<p><a id="GetPlayersLastRiddenHorse" class="f" href="https://cs.uesp.net/wiki/GetPlayersLastRiddenHorse">GetPlayersLastRiddenHorse</a> - returns a reference to the horse most recently ridden by the player.<br />
<code class="s">(horse:ref) GetPlayersLastRiddenHorse</code><br />
<code class="s">(horse:ref) GetPCLastHorse</code></p>

<p><a id="SetPlayersLastRiddenHorse" class="f" href="https://cs.uesp.net/wiki/SetPlayersLastRiddenHorse">SetPlayersLastRiddenHorse</a> - marks the specified horse as the horse most recently ridden by the player. This is the horse that will accompany the player when fast traveling while dismounted. The argument must be a Creature of type Horse. Additionally, in order for the new horse to fast travel with the player it must not be owned by anyone other than the player.<br />
<code class="s">(successfullySet:bool) SetPlayersLastRiddenHorse horse:ref</code></p>

<p><a id="ClearPlayersLastRiddenHorse" class="f" href="https://cs.uesp.net/wiki/ClearPlayersLastRiddenHorse">ClearPlayersLastRiddenHorse</a> - clears the game's memory of the horse last ridden by the player. This prevents any horse from accompanying the player when fast traveling, provided the player is not mounted on a horse when he travels.<br />
<code class="s">(nothing) ClearPlayersLastRiddenHorse</code></p>

<p><a id="GetPlayersLastActivatedLoadDoor" class="f" href="https://cs.uesp.net/wiki/GetPlayersLastActivatedLoadDoor">GetPlayersLastActivatedLoadDoor</a> - returns a reference to the load door most recently activated by the player.<br />
<code class="s">(loadDoor:ref) GetPlayersLastActivatedLoadDoor</code><br />
<code class="s">(loadDoor:ref) GetPCLastLoadDoor</code></p>

<p><a id="GetGodMode" class="f" href="https://cs.uesp.net/wiki/GetGodMode">GetGodMode</a> - returns 1 if the player has toggled god mode on.<br />
<code class="s">(godMode:bool) GetGodMode</code></p>

<p><a id="SetPCAMurderer" class="f" href="https://cs.uesp.net/wiki/SetPCAMurderer">SetPCAMurderer</a> - sets whether the PC is a murderer or not.<br />
<code class="s">(nothing) SetPCAMurderer isMurderer:bool</code></p>

<p><a id="GetPlayerSpell" class="f" href="https://cs.uesp.net/wiki/GetPlayerSpell">GetPlayerSpell</a> - returns the objectID of the player's current spell.<br />
...
<p><a id="GetPlayerSpellCount" class="f" href="https://cs.uesp.net/wiki/GetPlayerSpellCount">GetPlayerSpellCount</a> - returns the player spell count.<br />
<code class="s">(count:int) GetPlayerSpellCount</code><br/>
<code class="s">(count:int) GetSpellCount</code></p>

<p><a id="GetNthPlayerSpell" class="f" href="https://cs.uesp.net/wiki/GetNthPlayerSpell">GetNthPlayerSpell</a> - returns the nth player spell. whichSpell is an index that starts at 0 for the first spell in the list.<br/>
...
<p><a id="GetPCMajorSkillUps" class="f" href="https://cs.uesp.net/wiki/GetPCMajorSkillUps">GetPCMajorSkillUps</a> - returns the number of major skill advancements toward the player's next level.<br />
<code class="s">(skillUps:int) GetPCMajorSkillUps</code></p>

<p><a id="SetPCMajorSkillUps" class="f" href="https://cs.uesp.net/wiki/SetPCMajorSkillUps">SetPCMajorSkillUps</a> - sets the number of major skill advancements toward the player's next level<br />
<code class="s">(nothing) SetPCMajorSkillUps skillUps:int</code></p>

<p><a id="GetPCAttributeBonus" class="f" href="https://cs.uesp.net/wiki/GetPCAttributeBonus">GetPCAttributeBonus</a> - returns the number of skill advancements contributing to the specified attribute's bonus for the next level. Note that game setting multipliers applied to these values determine the actual bonus at level-up. Returns -1 if passed an invalid actor value, including Luck.<br />
<code class="s">(bonus:int) GetPCAttributeBonus <a href="#Actor_Value_Codes">actorValue</a>:string</code></p>

<p><a id="SetPCAttributeBonus" class="f" href="https://cs.uesp.net/wiki/SetPCAttributeBonus">SetPCAttributeBonus</a> - sets the number of skill advancements contributing to the specified attribute's bonus for the next level. Note that game setting multipliers applied to these values determine the actual bonus at level-up. Does not affect Luck bonus.<br />
<code class="s">(bonus:int) GetPCAttributeBonus <a href="#Actor_Value_Codes">actorValue</a>:string bonus:int</code></p>

<p><a id="GetTotalPCAttributeBonus" class="f" href="https://cs.uesp.net/wiki/GetTotalPCAttributeBonus">GetTotalPCAttributeBonus</a> - returns the sum of the player's attribute bonuses.<br />
<code class="s">(bonus:int) GetTotalPCAttributeBonus</code></p>

<p><a id="ModPCSpellEffectiveness" class="f" href="https://cs.uesp.net/wiki/ModPCSpellEffectiveness">ModPCSpellEffectiveness</a> - alters the script modifier applied to the player's spell effectiveness. This works similarly to Oblivion's ModAV command. Positive values increases the modifier, negative values decrease it. Any game calculations involving player spell effectiveness will use the modified value (base effectiveness + modifier). By default, the effects of this command persist until the end of the current game session. Pass 1 for the second parameter to save the amount modified in the savegame; it will then be applied every time the savegame is reloaded, and removed when reloading a different savegame.<br />
<code class="s">(nothing) ModPCSpellEffectiveness modBy:float <span class="op">persist:bool</span></code></p>

<p><a id="GetPCSpellEffectivenessModifier" class="f" href="https://cs.uesp.net/wiki/GetPCSpellEffectivenessModifier">GetPCSpellEffectivenessModifier</a> - returns the current value of the script modifier for player spell effectiveness. Subtract this value from the return value of Player.GetSpellEffectiveness to get the player's base spell effectiveness.<br />
<code class="s">(modifier:float) GetPCSpellEffectivenessModifier</code></p>

<p><a id="GetPCTrainingSessionsUsed" class="f" href="https://cs.uesp.net/wiki/GetPCTrainingSessionsUsed">GetPCTrainingSessionsUsed</a> - returns the number of times the player has trained during his current level.<br />
<code class="s">(numSessions:int) GetPCTrainingSessionsUsed</code></p>

<p><a id="SetPCTrainingSessionsUsed" class="f" href="https://cs.uesp.net/wiki/SetPCTrainingSessionsUsed">SetPCTrainingSessionsUsed</a> - sets the number of times the player has trained during his current level.<br />
<code class="s">(nothing) SetPCTrainingSessionsUsed numSessions:int</code></p>

<p><a id="ModPCMovementSpeed" class="f" href="https://cs.uesp.net/wiki/ModPCMovementSpeed">ModPCMovementSpeed</a> - applies a positive or negative modifier to the player's speed attribute as used in calculating his movement speed while swimming, walking, or running. The actual attribute is not modified, but movement calculations use the attribute value plus the modifier. Positive modifiers well above the maximum value of the speed attribute are permitted and effective; minimum speed including the modifier is limited to zero. By default, the effects of this command persist until the end of the current game session. Pass 1 for the second parameter to save the amount modified in the savegame; it will then be applied every time the savegame is reloaded, and removed when reloading a different savegame.<br />
<code class="s">(nothing) ModPCMovementSpeed modBy:float <span class="op">persist:bool</span></code></p>

<p> <a id="GetPCMovementSpeedModifier" class="f" href="https://cs.uesp.net/wiki/GetPCMovementSpeedModifier">GetPCMovementSpeedModifier</a> - returns the current modifier applied to the player's speed for use in movement speed calculations. Because multiple mods may change the modifier this command returns the sum of all calls to ModPCMovementSpeed.<br />
<code class="s">(modifier:float) GetPCMovementSpeedModifier</code></p>

<p><a id="GetPlayerBirthsign" class="f" href="https://cs.uesp.net/wiki/GetPlayerBirthsign">GetPlayerBirthsign</a> - returns the birthsign chosen by the player.<br />
<code class="s">(birthsign:ref) GetPlayerBirthsign</code></p>

<p><a id="SetPlayerBirthsign" class="f" href="https://cs.uesp.net/wiki/SetPlayerBirthsign">SetPlayerBirthsign</a> - changes the player's birthsign to the one specified. This removes all effects of the previous birthsign and applies the effects of the new one.<br />
<code class="s">(nothing) SetPlayerBirthsign birthsign:ref</code></p>

<p><a id="GetTelekinesisRef" class="f" href="https://cs.uesp.net/wiki/GetTelekinesisRef">GetTelekinesisRef</a> - returns a reference to the object being manipulated by the player through telekinesis, if any.<br />
<code class="s">(telekinesisRef:ref) GetTelekinesisRef</code></p>

<p><a id="GetCurrentRegions" class="f" href="https://cs.uesp.net/wiki/GetCurrentRegions">GetCurrentRegions</a> - returns an Array of all the regions in which the player is currently located, if any. In interior cells generally returns 0. Regions in exterior cells can overlap, therefore it's possible for the player to be in several regions simultaneously.<br />
<code class="s">(regions:Array) GetCurrentRegions</code></p>

<p><a id="GetPCLastDroppedItem" class="f" href="https://cs.uesp.net/wiki/GetPCLastDroppedItem">GetPCLastDroppedItem</a> - returns the base object of the item most recently dropped by the player.<br />
<code class="s">(item:ref) GetPCLastDroppedItem</code></p>

<p><a id="GetPCLastDroppedItemRef" class="f" href="https://cs.uesp.net/wiki/GetPCLastDroppedItemRef">GetPCLastDroppedItemRef</a> - returns the reference of the item most recently dropped by the player.<br />
<code class="s">(item:ref) GetPCLastDroppedItemRef</code></p>

<p><a id="GetPCAttributeBonusC" class="f" href="https://cs.uesp.net/wiki/GetPCAttributeBonusC">GetPCAttributeBonusC</a> - returns the level-up bonus for the specified attribute.<br />
<code class="s">(short) GetPCAttributeBonusC <a href="#Actor_Value_Codes">actorValue</a>:int</code></p>

<p><a id="SetPCAttributeBonusC" class="f" href="https://cs.uesp.net/wiki/SetPCAttributeBonusC">SetPCAttributeBonusC</a> - sets the level-up bonus for the specified attribute.<br />
<code class="s">(nothing) SetPCAttributeBonusC <a href="#Actor_Value_Codes">actorValue</a>:int</code></p>

<p><a id="GetLastUsedSigilStone" class="f" href="https://cs.uesp.net/wiki/GetLastUsedSigilStone">GetLastUsedSigilStone</a> - returns the sigil stone most recently used to enchant an item during the current game session.<br />
<code class="s">(usedSigilStone:ref) GetLastUsedSigilStone</code><br/>
<code class="s">(usedSigilStone:ref) GetLastSS</code></p>

<p><a id="GetLastSigilStoneEnchantedItem" class="f" href="https://cs.uesp.net/wiki/GetLastSigilStoneEnchantedItem">GetLastSigilStoneEnchantedItem</a> - returns the unenchanted item most recently enchanted with a sigil stone during the current game session.<br />
<code class="s">(item:ref) GetLastSigilStoneEnchantedItem</code><br/>
<code class="s">(item:ref) GetLastSSItem</code></p>

<p><a id="GetLastSigilStoneCreatedItem" class="f" href="https://cs.uesp.net/wiki/GetLastSigilStoneCreatedItem">GetLastSigilStoneCreatedItem</a> - returns the enchanted item most recently created with a sigil stone during the current game session.<br />
<code class="s">(item:ref) GetLastSigilStoneCreatedItem</code><br/>
<code class="s">(item:ref) GetLastSSCreated</code></p>

<p><a id="SetFlyCameraSpeedMult" class="f" href="https://cs.uesp.net/wiki/SetFlyCameraSpeedMult">SetFlyCameraSpeedMult</a> - changes the speed multiplier for the player's camera when in fly camera mode.<br />
<code class="s">(nothing) SetFlyCameraSpeedMult multiplier:float</code></p>

<p><a id="SetPlayerSkeletonPath" class="f" href="https://cs.uesp.net/wiki/SetPlayerSkeletonPAth">SetPlayerSkeletonPath</a> - Set the specific path as the player's skeleton.<br />
...
<p><a id="GetProjectileType" class="f" href="https://cs.uesp.net/wiki/GetProjectileType">GetProjectileType</a> - returns the type of the projectile.<br />
<code class="s">(<a href="#Projectile_Type">projectileType</a>:int) reference.GetProjectileType</code></p>

<p><a id="GetProjectileSource" class="f" href="https://cs.uesp.net/wiki/GetProjectileSource">GetProjectileSource</a> - returns the caster of a magic projectile or the archer who fired an arrow projectile.<br />
<code class="s">(source:ref) reference.GetProjectileSource</code></p>

<p><a id="GetMagicProjectileSpell" class="f" href="https://cs.uesp.net/wiki/GetMagicProjectileSpell">GetMagicProjectileSpell</a> - returns the spell attached to a magic projectile.<br />
<code class="s">(spell:ref) reference.GetMagicProjectileSpell</code><br />
<code class="s">(spell:ref) reference.GetMPSpell</code></p>

<p><a id="SetMagicProjectileSpell" class="f" href="https://cs.uesp.net/wiki/SetMagicProjectileSpell">SetMagicProjectileSpell</a> - changes the spell attached to a magic projectile.<br />
...
<p><a id="GetArrowProjectileEnchantment" class="f" href="https://cs.uesp.net/wiki/GetArrowProjectileEnchantment">GetArrowProjectileEnchantment</a> - returns the enchantment on an arrow projectile.<br />
...
<p><a id="GetArrowProjectileBowEnchantment" class="f" href="https://cs.uesp.net/wiki/GetArrowProjectileBowEnchantment">GetArrowProjectileBowEnchantment</a> - returns the enchantment on an arrow derived from the bow from which it was fired.<br />
...
<p><a id="GetArrowProjectilePoison" class="f" href="https://cs.uesp.net/wiki/GetArrowProjectilePoison">GetArrowProjectilePoison</a> - returns the poison on an arrow projectile.<br />
<code class="s">(poison:ref) reference.GetArrowProjectilePoison</code><br />
<code class="s">(poison:ref) reference.GetAPPoison</code></p>

<p><a id="SetPlayerProjectile" class="f" href="https://cs.uesp.net/wiki/SetPlayerProjectile">SetPlayerProjectile</a> - sets the player as the source of the projectile. Actors hit by the projectile will react as if the player had cast the spell or fired the arrow.<br />
<code class="s">(nothing) reference.SetPlayerProjectile</code></p>

<p><a id="SetProjectileSource" class="f" href="https://cs.uesp.net/wiki/SetProjectileSource">SetProjectileSource</a> - sets the source of a projectile. If an actor other than the player is set as the source, the target of the projectile will not necessarily respond to the attack.<br />
<code class="s">(nothing) reference.SetProjectileSource actor:ref</code></p>

<p><a id="SetArrowProjectileEnchantment" class="f" href="https://cs.uesp.net/wiki/SetArrowProjectileEnchantment">SetArrowProjectileEnchantment</a> - sets the arrow enchantment associated with the calling projectile.<br />
<code class="s">(nothing) reference.SetArrowProjectileEnchantment enchantment:ref</code></p>

<p><a id="SetArrowProjectileBowEnchantment" class="f" href="https://cs.uesp.net/wiki/SetArrowProjectileBowEnchantment">SetArrowProjectileBowEnchantment</a> - sets the bow enchantment associated with the calling projectile.<br />
<code class="s">(nothing) reference.SetArrowProjectileBowEnchantment enchantment:ref</code></p>

<p><a id="SetArrowProjectilePoison" class="f" href="https://cs.uesp.net/wiki/SetArrowProjectilePoison">SetArrowProjectilePoison</a> - sets the poison on the calling projectile.<br />
<code class="s">(nothing) reference.SetArrowProjectilePoison poison:ref</code></p>

<p><a id="GetProjectileSpeed" class="f" href="https://cs.uesp.net/wiki/GetProjectileSpeed">GetProjectileSpeed</a> - returns the speed of the projectile.<br />
<code class="s">(speed:float) reference.GetProjectileSpeed</code></p>

<p><a id="GetProjectileDistanceTraveled" class="f" href="https://cs.uesp.net/wiki/GetProjectileDistanceTraveled">GetProjectileDistanceTraveled</a> - returns the total distance traveled by the calling projectile. Currently does not work for arrow projectiles.<br />
<code class="s">(distance:float) reference.GetProjectileDistanceTraveled</code></p>

<p><a id="GetProjectileLifetime" class="f" href="https://cs.uesp.net/wiki/GetProjectileLifetime">GetProjectileLifetime</a> - returns the number of seconds for which the calling projectile has existed.<br />
<code class="s">(lifetime:float) reference.GetProjectileLifetime</code></p>

<p><a id="SetProjectileSpeed" class="f" href="https://cs.uesp.net/wiki/SetProjectileSpeed">SetProjectileSpeed</a> - sets the speed of the projectile. Note that other factors affect the movement of a projectile so a speed of zero does not necessarily completely halt the projectile.<br />
<code class="s">(nothing) reference.SetProjectileSpeed speed:float</code></p>

<p><a id="GetProjectile" class="f" href="https://cs.uesp.net/wiki/GetProjectile">GetProjectile</a> - returns the projectile most recently fired by the calling actor. Optionally specify the type (1 for arrows, 2 for magic, 0 for either) and the arrow, spell, or staff enchantment to match. The minLifetime parameter specifies how old (in seconds) a projectile can be before it is ignored.<br />
...
<h3><a id="Quest" href="https://cs.uesp.net/wiki/Quest">Quest</a></h3>

<h4>Functions</h4>

<p><a id="SetActiveQuest" class="f" href="https://cs.uesp.net/wiki/SetActiveQuest">SetActiveQuest</a> - sets the players active quest.<br />
<code class="s">(nothing) SetActiveQuest quest:ref</code></p>

<p><a id="GetActiveQuest" class="f" href="https://cs.uesp.net/wiki/GetActiveQuest">GetActiveQuest</a> - returns the player's active quest, if any.<br />
<code class="s">(ref) GetActiveQuest</code></p>

<p><a id="ClearActiveQuest" class="f" href="https://cs.uesp.net/wiki/ClearActiveQuest">ClearActiveQuest</a> - clears the player's active quest, if any.<br />
<code class="s">(nothing) ClearActiveQuest</code></p>

<p><a id="GetCurrentQuests" class="f" href="https://cs.uesp.net/wiki/GetCurrentQuests">GetCurrentQuests</a> - returns a list of all currently active (uncompleted) quests. Note that this list includes quests which do not appear in the journal.<br />
<code class="s">(Array) GetCurrentQuests</code></p>

<p><a id="GetCompletedQuests" class="f" href="https://cs.uesp.net/wiki/GetCompletedQuests">GetCompletedQuests</a> - returns a list of all completed quests.<br />
<code class="s">(Array) GetCompletedQuests</code></p>

<p><a id="IsQuestComplete" class="f" href="https://cs.uesp.net/wiki/IsQuestComplete">IsQuestComplete</a> - returns 1 if the specified quest is marked as 'completed'.<br />
<code class="s">(completed:bool) IsQuestComplete quest:ref</code></p>

<p><a id="UncompleteQuest" class="f" href="https://cs.uesp.net/wiki/UncompleteQuest">UncompleteQuest</a> - removes the 'completed' flag from the specified quest.<br />
<code class="s">(nothing) UncompleteQuest quest:ref</code></p>

<p><a id="QuestExists" class="f" href="https://cs.uesp.net/wiki/QuestExists">QuestExists</a> - returns 1 if a quest exists with the specified editorID.<br />
<code class="s">(questExists:bool) QuestExists questEditorID:string</code></p>

<p><a id="GetStageIDs" class="f" href="https://cs.uesp.net/wiki/GetStageIDs">GetStageIDs</a> - returns an Array containing the numeric index of each quest stage associated with the specified quest.<br />
<code class="s">(stageIDs:array) GetStageIDs quest:ref</code></p>

<p><a id="GetStageEntries" class="f" href="https://cs.uesp.net/wiki/GetStageEntries">GetStageEntries</a> - returns an Array of all of the entries associated with the specified quest stage. Each element of the array is a Stringmap containing the following fields: "day" (1-31), "month" (1-12), and "year", representing the date at which the entry was added to the player's journal, and "text" containing the log text for the entry. If the entry has not been added to the player's journal, the date fields will all be zero.<br />
<code class="s">(entries:Array) GetStageEntries quest:ref stageID:int</code></p>

<p><a id="SetStageText" class="f" href="https://cs.uesp.net/wiki/SetStageText">SetStageText</a> - sets the log text associated with the specified quest stage entry for the specified quest. The change remains in effect for the duration of the game session or until undone with UnsetStageText.<br />
<code class="s">(textModified:bool) SetStageText quest:ref stageIndex:int entryIndex:int text:string</code></p>

<p><a id="UnsetStageText" class="f" href="https://cs.uesp.net/wiki/UnsetStageText">UnsetStageText</a> - reverses any modification made to the specified log entry text using SetStageText.<br />
<code class="s">(nothing) UnsetStageText quest:ref stageIndex:int entryIndex:int</code></p>

<p><a id="SetStageDate" class="f" href="https://cs.uesp.net/wiki/SetStageDate">SetStageDate</a> - for a quest stage entry which has already been added to the player's journal, modifies the date at which the entry was added. Specify the day of the month (1-31), month (1-12), and year.<br />
...
<p><a id="GetParentCell" class="f" href="https://cs.uesp.net/wiki/GetParentCell">GetParentCell</a> - returns the objectID of the parent cell of the calling reference.<br />
...
<p><a id="GetParentWorldspace" class="f" href="https://cs.uesp.net/wiki/GetParentWorldspace">GetParentWorldspace</a> - returns the worldspace to which the calling reference's cell belongs, if any. In interior cells this generally returns 0.<br />
<code class="s">(parentWorldspace:ref) reference.GetParentWorldspace</code></p>

<p><a id="ParentCellHasWater" class="f" href="https://cs.uesp.net/wiki/ParentCellHasWater">ParentCellHasWater</a> - returns 1 if the reference's parent cell can contain water.<br />
...
<p><a id="GetParentCellWaterHeight" class="f" href="https://cs.uesp.net/wiki/GetParentCellWaterHeight">GetParentCellWaterHeight</a> - returns the water height of the references parent cell.<br />
...
<p><a id="IsActivatable" class="f" href="https://cs.uesp.net/wiki/IsActivatable">IsActivatable</a> - returns 1 if the calling reference can be activated under normal circumstances.<br />
...
<p><a id="IsUnderWater" class="f" href="https://cs.uesp.net/wiki/IsUnderWater">IsUnderWater</a> - returns 1 if the calling reference's Z position is less than 120 units under its parent cell's water height.<br />
<code class="s">(isUnderWater:bool) reference.IsUnderWater</code></p>

<p><a id="GetNumChildRefs" class="f" href="https://cs.uesp.net/wiki/GetNumChildRefs">GetNumChildRefs</a> - returns the number of reference for which the calling reference behaves as an enable-state parent.<br />
<code class="s">(numChildren:int) reference.GetNumChildRefs</code></p>

<p><a id="GetNthChildRef" class="f" href="https://cs.uesp.net/wiki/GetNthChildRef">GetNthChildRef</a> - returns the nth child reference associated with the calling reference. Child references are stored in no particular order.<br />
<code class="s">(childRef:ref) reference.GetNthChildRef whichChild:int</code></p>

<p><a id="GetNumFollowers" class="f" href="https://cs.uesp.net/wiki/GetNumFollowers">GetNumFollowers</a> - returns the number of actors currently following the calling actor. Summoned creatures are excluded.<br />
<code class="s">(numFollowers:int) reference.GetNumFollowers</code></p>

<p><a id="GetNthFollower" class="f" href="https://cs.uesp.net/wiki/GetNthFollower">GetNthFollower</a> - returns a reference to the nth actor currently following the calling actor. Does not include summoned creatures.<br />
<code class="s">(follower:ref) reference.GetNthFollower whichFollower:int</code></p>

<p><a id="GetFollowers" class="f" href="https://cs.uesp.net/wiki/GetFollowers">GetFollowers</a> - returns an array containing all actors currently following the calling actor, including summoned creatures.<br />
<code class="s">(followers:array) reference.GetFollowers</code></p>

<p><a id="IsPersistent" class="f" href="https://cs.uesp.net/wiki/IsPersistent">IsPersistent</a> - returns 1 if the calling reference is a persistent reference.<br />
<code class="s">(isPersistent:bool) reference.IsPersistent</code></p>

<p><a id="SetScaleEX" class="f" href="https://cs.uesp.net/wiki/SetScaleEX">SetScaleEX</a> - sets the scale of the calling reference. Unlike SetScale, the scale is not limited to a certain range. The reference should be disabled and then enabled after calling this function in order to update its scale and collision properties. The new scale is saved in the savegame.<br />
...
<p><a id="HasBeenPickedUp" class="f" href="https://cs.uesp.net/wiki/HasBeenPickedUp">HasBeenPickedUp</a> - returns true if the calling reference is currently inactive due to having been picked up by an actor or otherwise transferred to an inventory<br />
...
<p><a id="GetRefCount" class="f" href="https://cs.uesp.net/wiki/GetRefCount">GetRefCount</a> - returns the number of items in a stack of items in the world.<br />
<code class="s">(refCount:int) reference.GetRefCount</code></p>

<p><a id="SetRefCount" class="f" href="https://cs.uesp.net/wiki/SetRefCount">SetRefCount</a> - sets the number of items in a stack of items in the world.<br />
...
<p><a id="DeleteReference" class="f" href="https://cs.uesp.net/wiki/DeleteReference">DeleteReference</a> - attempts to delete the calling object from the game and returns true if successful. In order for a reference to be deleted, it must:</p><ul>
	<li>- be disabled</li>
...
<p><a id="GetBoundingBox" class="f" href="https://cs.uesp.net/wiki/GetBoundingBox">GetBoundingBox</a> - returns a stringmap representing the calling objects axis-aligned bounding box. This command only works for mobile objects (projectiles and actors). The stringmap returned contains two stringmaps: "center" has keys "x", "y", and "z" representing the coordinates of the center of the bounding box, and "extent" has the same keys representing the extent of the box along each axis. For example, the height of the box is equal to GetBoundingBox-&gt;extent-&gt;z * 2. Similarly the bottom of the box is equal to GetBoundingBox-&gt;center-&gt;z - GetBoundingBox-&gt;extent-&gt;z<br />
...
<p><a id="GetBoundingRadius" class="f" href="https://cs.uesp.net/wiki/GetBoundingRadius">GetBoundingRadius</a> - returns the radius of a sphere large enough to entirely contain the 3D geometry of the calling object.<br />
<code class="s">(radius:float) reference.GetBoundingRadius</code></p>

<p><a id="Update3D" class="f" href="https://cs.uesp.net/wiki/Update3D">Update3D</a> - updates the visual representation of the calling actor or object reference. This can be called immediately after commands like SetModelPath and SetEyes to make the changes visible and should work in any instance where instructions tell you to <code>disable</code> and <code>enable</code> a reference to make changes visible.<br />
...
<p><a id="GetSigilStoneUses" class="f" href="https://cs.uesp.net/wiki/GetSigilStoneUses">GetSigilStoneUses</a> - returns the number of uses for a sigil stone.<br />
<code class="s">(short) <span class="op">reference.</span>GetSigilStoneUses<span class="op"> sigilStone:ref</span></code></p>

<p><a id="SetSigilStoneUses" class="f" href="https://cs.uesp.net/wiki/SetSigilStoneUses">SetSigilStoneUses</a> - sets the number of uses for a sigil stone.<br />
...
<p><a id="ModSigilStoneUses" class="f" href="https://cs.uesp.net/wiki/ModSigilStoneUses">ModSigilStoneUses</a> - mods the number of uses for a sigil stone.<br />
...
<p><a id="GetPlayerSkillUse" class="f" href="https://cs.uesp.net/wiki/GetPlayerSkillUse">GetPlayerSkillUse</a> - returns the current experience towards the next level of the skill<br />
<code class="s">(skillExperience:float) GetPlayerSkillUse <a href="#Actor_Value_Codes">skill</a>:actorValue</code></p>

<p><a id="GetPlayerSkillUseC" class="f" href="https://cs.uesp.net/wiki/GetPlayerSkillUseC">GetPlayerSkillUseC</a> - alternatve version of GetPlayerSkillUse taking an actor value code for the skill<br />
<code class="s">(skillExperience:float) GetPlayerSkillUseC skillCode:int</code></p>

<p><a id="IncrementPlayerSkillUse" class="f" href="https://cs.uesp.net/wiki/IncrementPlayerSkillUse">IncrementPlayerSkillUse</a> - records some additional uses of one of the skill actions<br />
...
<p><a id="GetSkillUseIncrement" class="f" href="https://cs.uesp.net/wiki/GetSkillUseIncrement">GetSkillUseIncrement</a> - gets the experience point increase for one use of a skill action<br />
...
<p><a id="SetSkillUseIncrement" class="f" href="https://cs.uesp.net/wiki/SetSkillUseIncrement">SetSkillUseIncrement</a> - sets the experience point increase for one use of a skill action<br />
...
<p><a id="IncrementPlayerSkillUseC" class="f" href="https://cs.uesp.net/wiki/IncrementPlayerSkillUseC">IncrementPlayerSkillUseC</a> - records some additional uses of one of the skill actions<br />
...
<p><a id="TriggerPlayerSkillUse" class="f" href="https://cs.uesp.net/wiki/TriggerPlayerSkillUse">TriggerPlayerSkillUse</a> - records positive or negative uses of one of the specified skill actions. Enough skill uses will increment or decrement the skill itself, and adjust the log of the number of increases for that skill.<br />
...
<p><a id="ModPlayerSkillExp" class="f" href="https://cs.uesp.net/wiki/ModPlayerSkillExp">ModPlayerSkillExp</a> - directly adjusts the experience for a skill. A large enough adjustment will increment or decrement the skill itself, and adjust the log of the number of increase for that skill.<br />
...
<p><a id="GetSkillUseIncrementC" class="f" href="https://cs.uesp.net/wiki/GetSkillUseIncrementC">GetSkillUseIncrementC</a> - gets the experience point increase for one use of a skill action<br />
<code class="s">(useRate:float) GetSkillUseIncrement skill:actorValueCode <span class="op">whichAction:int</span></code></p>

<p><a id="SetSkillUseIncrementC" class="f" href="https://cs.uesp.net/wiki/SetSkillUseIncrementC">SetSkillUseIncrementC</a> - sets the experience point increase for one use of a skill action<br />
<code class="s">(nothing) SetSkillUseIncrement nuRate:float skill:actorValueCode <span class="op">whichAction:int</span></code></p>

<p><a id="GetSkillGoverningAttribute" class="f" href="https://cs.uesp.net/wiki/GetSkillGoverningAttribute">GetSkillGoverningAttribute</a> - returns the governing attribute for the skill as an actor value code<br />
<code class="s">(skillCode:int) GetSkillGoverningAttribute skillName:string</code></p>

<p><a id="SetSkillGoverningAttribute" class="f" href="https://cs.uesp.net/wiki/SetSkillGoverningAttribute">SetSkillGoverningAttribute</a> - sets the governing attribute for the skill<br />
<code class="s">(nothing) SetSkillGoverningAttribute skillName:string attributeName:string</code></p>

<p><a id="GetSkillGoverningAttributeC" class="f" href="https://cs.uesp.net/wiki/GetSkillGoverningAttributeC">GetSkillGoverningAttributeC</a> - alternate version of GetSkillGoverningAttribute taking an actor value code for the skill<br />
<code class="s">(skillCode:int) GetSkillGoverningAttributeC skillCode:int</code></p>

<p><a id="SetSkillGoverningAttributeC" class="f" href="https://cs.uesp.net/wiki/SetSkillGoverningAttributeC">SetSkillGoverningAttributeC</a> - alternate version of SetSkillGoverningAttribute taking actor value codes for the skill and attribute<br />
<code class="s">(nothing) SetSkillGoverningAttributeC skillCode:int attributeCode:int</code></p>

<p><a id="GetPlayerSkillAdvances" class="f" href="https://cs.uesp.net/wiki/GetPlayerSkillAdvances">GetPlayerSkillAdvances</a> - returns the number of times the skill level has advanced for that skill<br />
...
<p><a id="SetPlayerSkillAdvances" class="f" href="https://cs.uesp.net/wiki/SetPlayerSkillAdvances">SetPlayerSkillAdvances</a> - sets the number of times the skill has been advanced<br />
...
<p><a id="GetRequiredSkillExp" class="f" href="https://cs.uesp.net/wiki/GetRequiredSkillExp">GetRequiredSkillExp</a> - returns the total skill use required for the player to advance the specified skill. To get the <strong>remaining</strong> skill use required, subtract the value of <a href="#GetPlayerSkillUse">GetPlayerSkillUse</a> from this value.<br />
<code class="s">(skillUse:float) GetRequiredSkillExp skill:actorValue</code></p>

<p><a id="GetRequiredSkillExpC" class="f" href="https://cs.uesp.net/wiki/GetRequiredSkillExpC">GetRequiredSkillExpC</a> - alternate version of GetRequiredSkillExp taking an actor value code for the skill.<br />
<code class="s">(skillUse:float) GetRequiredSkillExpC skillCode:int</code></p>

<p><a id="GetSkillSpecialization" class="f" href="https://cs.uesp.net/wiki/GetSkillSpecialization">GetSkillSpecialization</a> - returns the skill's specialization as an integer. 0: Combat, 1: Magic, or 2: Stealth. <br />
<code class="s">(specialization:int) GetSkillSpecialization skill:actorValue</code></p>

<p><a id="GetSkillSpecializationC" class="f" href="https://cs.uesp.net/wiki/GetSkillSpecializationC">GetSkillSpecializationC</a> - alternate version of GetSkillSpecialization taking an actor value code for the skill.<br />
<code class="s">(specialization:int) GetSkillSpecializationC skillCode:int</code></p>

<p><a id="SetSkillSpecialization" class="f" href="https://cs.uesp.net/wiki/SetSkillSpecialization">SetSkillSpecialization</a> - sets the skill's specialization as an integer. 0: Combat, 1: Magic, or 2: Stealth. <br />
<code class="s">(nothing) SetSkillSpecialization skill:actorValue specialization:int</code></p>

<p><a id="SetSkillSpecializationC" class="f" href="https://cs.uesp.net/wiki/SetSkillSpecializationC">SetSkillSpecializationC</a> - alternate version of SetSkillSpecialization taking an actor value code for the skill<br />
<code class="s">(specialization:int) SetSkillSpecializationC skillCode:int specialization:int</code></p>

<p><a id="ToggleSkillPerk" class="f" href="https://cs.uesp.net/wiki/ToggleSkillPerk">ToggleSkillPerk</a> - turns the perk associated with the specified skill at the specified mastery level on or off. Currently, this command only supports toggling the Journeyman Block perk. Support for additional perks and skills may be added in the future. The mastery level is an integer from 0 (Novice) to 4 (Master).<br />
...
<p><a id="GetSoulLevel" class="f" href="https://cs.uesp.net/wiki/GetSoulLevel">GetSoulLevel</a> - returns the soul level currently in the soul gem<br />
<code class="s">(<a href="#Soul_Level">soulLevel</a>:int) GetSoulLevel objectID:ref</code></p>

<p><a id="GetSoulGemCapacity" class="f" href="https://cs.uesp.net/wiki/GetSoulGemCapacity">GetSoulGemCapacity</a> - returns the max soul level the soul gem can contain<br />
<code class="s">(<a href="#Soul_Level">soulLevel</a>:int) GetSoulGemCapacity objectID:ref</code></p>

<p><a id="SetSoulLevel" class="f" href="https://cs.uesp.net/wiki/SetSoulLevel">SetSoulLevel</a> - set the soul level of the soul gem<br />
<code class="s">(nothing) SetSoulLevel <a href="#Soul_Level">soulLevel</a>:int <span class="op">objectID:ref</span></code></p>

<p><a id="SetSoulGemCapacity" class="f" href="https://cs.uesp.net/wiki/SetSoulGemCapacity">SetSoulGemCapacity</a> - set the capacity level of the soul gem<br />
 <code class="s">(nothing) SetSoulGemCapacity <a href="#Soul_Level">soulLevel</a>:int objectID:ref</code></p>

<p><a id="GetCurrentSoulLevel" class="f" href="https://cs.uesp.net/wiki/GetCurrentSoulLevel">GetCurrentSoulLevel</a> - returns the current soul level of the calling actor reference<br />
...
<p><a id="GetSoundAttenuation" class="f" href="https://cs.uesp.net/wiki/GetSoundAttenuation">GetSoundAttenuation</a> - returns the specified attenuation value for the specified sound, where the attenuation is "max", "min", or "static"<br />
<code class="s">(attenuation:float) GetSoundAttenuation sound:ref whichAttenuation:string </code></p>

<p><a id="SetSoundAttenuation" class="f" href="https://cs.uesp.net/wiki/SetSoundAttenuation">SetSoundAttenuation</a> - sets the specified attenuation value for the specified sound, where the attenuation is "max", "min", or "static"<br />
...
<p><a id="GetSpellType" class="f" href="https://cs.uesp.net/wiki/GetSpellType">GetSpellType</a> - returns the spell type<br />
<code class="s">(<a href="#Spell_Type">spellType</a>:int) GetSpellType spell:ref</code></p>

<p><a id="SetSpellType" class="f" href="https://cs.uesp.net/wiki/SetSpellType">SetSpellType</a> - sets the spell type<br />
<code class="s">(nothing) SetSpellType <a href="#Spell_Type">nuType</a>:int spell:ref</code></p>

<p><a id="GetSpellMagickaCost" class="f" href="https://cs.uesp.net/wiki/GetSpellMagickaCost">GetSpellMagickaCost</a> - returns the magicka casting cost according to the Oblivion formula. If called on a reference it will use the reference's magic skill values to determine the actual magicka cost of the spell. Without a reference it will return the base cost of the spell as reported in the CS.<br />
<code class="s">(magickaCost:int) <span class="op">reference.</span>GetSpellMagickaCost spell:ref</code></p>

<p><a id="SetSpellMagickaCost" class="f" href="https://cs.uesp.net/wiki/SetSpellMagickaCost">SetSpellMagickaCost</a> - sets the magicka casting cost<br />
<code class="s">(nothing) SetSpellMagickaCost nuMagickaCost:int spell:ref</code></p>

<p><a id="ModSpellMagickaCost" class="f" href="https://cs.uesp.net/wiki/ModSpellMagickaCost">ModSpellMagickaCost</a> - modifies the magicka casting cost up or down<br />
<code class="s">(nothing) ModSpellMagickaCost modifyBy:float spell:ref</code></p>

<p><a id="GetSpellMasteryLevel" class="f" href="https://cs.uesp.net/wiki/GetSpellMasteryLevel">GetSpellMasteryLevel</a> - returns the mastery level of the spell<br />
<code class="s">(<a href="#Spell_Mastery_Level">masteryLevel</a>:int) GetSpellMasteryLevel spell:ref</code></p>

<p><a id="SetSpellMasteryLevel" class="f" href="https://cs.uesp.net/wiki/SetSpellMasteryLevel">SetSpellMasteryLevel</a> - sets the mastery level of the spell<br />
<code class="s">(nothing) SetSpellMasteryLevel <a href="#Spell_Mastery_Level">masteryLevel</a>:int objectID:ref</code></p>

<p><a id="GetSpellSchool" class="f" href="https://cs.uesp.net/wiki/GetSpellSchool">GetSpellSchool</a> - returns the school of the spell, determined by the most expensive effect item<br />
<code class="s">(magicSchool:int) GetSpellSchool spell:ref</code></p>

<p><a id="GetSpellExplodesWithNoTarget" class="f" href="https://cs.uesp.net/wiki/GetSpellExplodesWithNoTarget">GetSpellExplodesWithNoTarget</a> - returns whether the touch spell explodes without a target<br />
<code class="s">(spellExplodesWithNoTarget:bool) GetSpellExplodesWithNoTarget spell:ref</code></p>

<p><a id="SetSpellExplodesWithNoTarget" class="f" href="https://cs.uesp.net/wiki/SetSpellExplodesWithNoTarget">SetSpellExplodesWithNoTarget</a> - sets whether the touch spell will explode without a target<br />
<code class="s">(nothing) SetSpellExplodesWithNoTarget doesSpellExpode:bool spell:ref</code></p>

<p><a id="GetSpellHostile" class="f" href="https://cs.uesp.net/wiki/IsSpellHostile">IsSpellHostile</a> - returns 1 if the spell is considered hostile<br />
<code class="s">(isHostile:bool) IsSpellHostile spell:ref</code></p>

<p><a id="SetSpellHostile" class="f" href="https://cs.uesp.net/wiki/SetSpellHostile">SetSpellHostile</a> - toggles whether or not a spell is considered hostile<br />
<code class="s">(nothing) SetSpellHostile spell:ref isHostile:bool</code></p>

<p><a id="GetSpellPCStart" class="f" href="https://cs.uesp.net/wiki/GetSpellPCStart">GetSpellPCStart</a> - returns true if the PC Start flag is set for the specified spell<br />
<code class="s">(bool) GetSpellPCStart spell:ref</code></p>

<p><a id="GetSpellImmuneToSilence" class="f" href="https://cs.uesp.net/wiki/GetSpellImmuneToSilence">GetSpellImmuneToSilence</a> - returns true if the Immune to Silence flag is set for the specified spell<br />
<code class="s">(bool) GetSpellImmuneToSilence spell:ref</code></p>

<p><a id="GetSpellAreaEffectIgnoresLOS" class="f" href="https://cs.uesp.net/wiki/GetSpellAreaEffectIgnoresLOS">GetSpellAreaEffectIgnoresLOS</a> - returns true if the AE Ignores LOS flag is set for the specified spell<br />
<code class="s">(bool) GetSpellAreaEffectIgnoresLOS spell:ref</code></p>

<p><a id="GetSpellScriptEffectAlwaysApplies" class="f" href="https://cs.uesp.net/wiki/GetSpellScriptEffectAlwaysApplies">GetSpellScriptEffectAlwaysApplies</a> - returns true if the SEFF Always Applies flag is set for the specified spell<br />
<code class="s">(bool) GetSpellScriptEffectAlwaysApplies spell:ref</code></p>

<p><a id="GetSpellDisallowAbsorbReflect" class="f" href="https://cs.uesp.net/wiki/GetSpellDisallowAbsorbReflect">GetSpellDisallowAbsorbReflect</a> - returns true if the Disallow Absorb Reflect flag is set for the specified spell<br />
<code class="s">(bool) GetSpellDisallowAbsorbReflect spell:ref</code></p>

<p><a id="SetSpellPCStart" class="f" href="https://cs.uesp.net/wiki/SetSpellPCStart">SetSpellPCStart</a> - sets the PC Start flag for the specified spell<br />
<code class="s">(nothing) SetSpellPCStart value:integer spell:ref</code></p>

<p><a id="SetSpellImmuneToSilence" class="f" href="https://cs.uesp.net/wiki/SetSpellImmuneToSilence">SetSpellImmuneToSilence</a> - sets the Immune to Silence flag for the specified spell<br />
<code class="s">(nothing) SetSpellImmuneToSilence value:integer spell:ref</code></p>

<p><a id="SetSpellAreaEffectIgnoresLOS" class="f" href="https://cs.uesp.net/wiki/SetSpellAreaEffectIgnoresLOS">SetSpellAreaEffectIgnoresLOS</a> - sets the AE Ignores LOS flag for the specified spell<br />
<code class="s">(nothing) SetSpellAreaEffectIgnoresLOS value:integer spell:ref</code></p>

<p><a id="SetSpellScriptEffectAlwaysApplies" class="f" href="https://cs.uesp.net/wiki/SetSpellScriptEffectAlwaysApplies">SetSpellScriptEffectAlwaysApplies</a> - sets the SEFF Always Applies flag for the specified spell<br />
<code class="s">(nothing) SetSpellScriptEffectAlwaysApplies value:integer spell:ref</code></p>

<p><a id="SetSpellDisallowAbsorbReflect" class="f" href="https://cs.uesp.net/wiki/SetSpellDisallowAbsorbReflect">SetSpellDisallowAbsorbReflect</a> - sets the Disallow Absorb Reflect flag for the specified spell<br />
...
<p><a id="GetWeaponReach" class="f" href="https://cs.uesp.net/wiki/GetWeaponReach">GetWeaponReach</a> - returns the reach of the weapon<br />
<code class="s">(reach:float) <span class="op">reference</span>.GetWeaponReach <span class="op">objectID:ref</span></code></p>

<p><a id="SetWeaponReach" class="f" href="https://cs.uesp.net/wiki/SetWeaponReach">SetWeaponReach</a> - sets the reach of the weapon<br />
<code class="s">(nothing) <span class="op">reference</span>.SetWeaponReach nuReach:float <span class="op">objectID:ref</span></code></p>

<p><a id="ModWeaponReach" class="f" href="https://cs.uesp.net/wiki/ModWeaponReach">ModWeaponReach</a> - modifies the reach of the weapon up or down<br />
<code class="s">(nothing) <span class="op">reference</span>.ModWeaponReach modifyBy:float <span class="op">objectID:ref</span></code></p>

<p><a id="GetWeaponType" class="f" href="https://cs.uesp.net/wiki/GetWeaponType">GetWeaponType</a> - retuns the weapon type<br />
...
<p><a id="SetWeaponType" class="f" href="https://cs.uesp.net/wiki/SetWeaponType">SetWeaponType</a> - sets the weapon type<br />
...
<p><a id="GetEquippedWeaponPoison" class="f" href="https://cs.uesp.net/wiki/GetEquippedWeaponPoison">GetEquippedWeaponPoison</a> - returns the poison applied to the equipped weapon. Called on the weapon holder.<br />
<code class="s">(poison:ref) reference.GetEquippedWeaponPoison</code></p>

<p><a id="SetEquippedWeaponPoison" class="f" href="https://cs.uesp.net/wiki/SetEquippedWeaponPoison">SetEquippedWeaponPoison</a> - sets the poison applied to the equipped weapon and returns the previous poison.Called on the weapon holder.<br />
<code class="s">(oldPoison:ref) reference.SetEquippedWeaponPoison nuPoison:ref</code></p>

<p><a id="RemoveEquippedWeaponPoison" class="f" href="https://cs.uesp.net/wiki/RemoveEquippedWeaponPoison">RemoveEquippedWeaponPoison</a> - removes and returns the poison applied to the equipped weapon. Called on the weapon holder.<br />
...
<strong><a href="#HDR_Value">HDR Values</a></strong> (<span class="op">float</span>) - see the <a href="https://cs.uesp.net/wiki/Weather#HDR">CS Wiki page</a> for more information about these settings<br />
...
<p><a id="GetCurrentWeatherID" class="f" href="https://cs.uesp.net/wiki/GetCurrentWeatherID">GetCurrentWeatherID</a> - returns the refID of the current weather<br />
<code class="s">(currentWeather:ref) GetCurrentWeatherID </code></p>

<p><a id="GetWeatherOverride" class="f" href="https://cs.uesp.net/wiki/GetWeatherOverride">GetWeatherOverride</a> - returns the weather which is overriding the current weather as a result of the ForceWeather or SetWeather command with a non-zero "override" argument (for example, in the scripts which control weather near Oblivion gates), or zero if the weather is not being overridden. <br />
<code class="s">(override:ref) GetWeatherOverride </code></p>

<p><a id="GetWeatherWindSpeed" class="f" href="https://cs.uesp.net/wiki/GetWeatherWindSpeed">GetWeatherWindSpeed</a> - returns the wind speed of the specified weather<br />
...
<p><a id="SetWeatherWindSpeed" class="f" href="https://cs.uesp.net/wiki/SetWeatherWindSpeed">SetWeatherWindSpeed</a> - sets the wind speed of the specified weather<br />
...
<p><a id="GetWeatherCloudSpeedLower" class="f" href="https://cs.uesp.net/wiki/GetWeatherCloudSpeedLower">GetWeatherCloudSpeedLower</a> - returns the speed of the lower cloud layer<br />
...
<p><a id="SetWeatherCloudSpeedLower" class="f" href="https://cs.uesp.net/wiki/SetWeatherCloudSpeedLower">SetWeatherCloudSpeedLower</a> - sets the speed of the lower cloud layer<br />
...
<p><a id="GetWeatherCloudSpeedUpper" class="f" href="https://cs.uesp.net/wiki/GetWeatherCloudSpeedUpper">GetWeatherCloudSpeedUpper</a> - returns the speed of the upper cloud layer<br />
...
<p><a id="SetWeatherCloudSpeedUpper" class="f" href="https://cs.uesp.net/wiki/SetWeatherCloudSpeedUpper">SetWeatherCloudSpeedUpper</a> - sets the speed of the upper cloud layer<br />
...
<p><a id="GetWeatherTransDelta" class="f" href="https://cs.uesp.net/wiki/GetWeatherTransDelta">GetWeatherTransDelta</a> - returns the transition delta of the weather<br />
...
<p><a id="SetWeatherTransDelta" class="f" href="https://cs.uesp.net/wiki/SetWeatherTransDelta">SetWeatherTransDelta</a> - sets the transition delta of the weather<br />
...
<p><a id="GetWeatherSunGlare" class="f" href="https://cs.uesp.net/wiki/GetWeatherSunGlare">GetWeatherSunGlare</a> - returns the sun glare<br />
...
<p><a id="SetWeatherSunGlare" class="f" href="https://cs.uesp.net/wiki/SetWeatherSunGlare">SetWeatherSunGlare</a> - sets the sun glare<br />
...
<p><a id="GetWeatherSunDamage" class="f" href="https://cs.uesp.net/wiki/GetWeatherSunDamage">GetWeatherSunDamage</a> - returns the sun damage<br />
...
<p><a id="SetWeatherSunDamage" class="f" href="https://cs.uesp.net/wiki/SetWeatherSunDamage">SetWeatherSunDamage</a> - sets the sun damage<br />
...
<p><a id="GetWeatherFogDayNear" class="f" href="https://cs.uesp.net/wiki/">GetWeatherFogDayNear</a> - returns the daytime near fog distance<br />
...
<p><a id="SetWeatherFogDayNear" class="f" href="https://cs.uesp.net/wiki/SetWeatherFogDayNear">SetWeatherFogDayNear</a> - sets the daytime near fog distance<br />
...
<p><a id="GetWeatherFogDayFar" class="f" href="https://cs.uesp.net/wiki/GetWeatherFogDayFar">GetWeatherFogDayFar</a> - returns the daytime far fog distance<br />
...
<p><a id="SetWeatherFogDayFar" class="f" href="https://cs.uesp.net/wiki/SetWeatherFogDayFar">SetWeatherFogDayFar</a>- sets the daytime far fog distance<br />
...
<p><a id="GetWeatherFogNightNear" class="f" href="https://cs.uesp.net/wiki/GetWeatherFogNightNear">GetWeatherFogNightNear</a> - returns the nighttime near fog distance<br />
...
<p><a id="SetWeatherFogNightNear" class="f" href="https://cs.uesp.net/wiki/SetWeatherFogNightNear">SetWeatherFogNightNear</a> - sets the nighttime near fog distance<br />
...
<p><a id="GetWeatherFogNightFar" class="f" href="https://cs.uesp.net/wiki/GetWeatherFogNightFar">GetWeatherFogNightFar</a> - returns the nighttime far fog distance<br />
...
<p><a id="SetWeatherFogNightFar" class="f" href="https://cs.uesp.net/wiki/SetWeatherFogNightFar">SetWeatherFogNightFar</a> - sets the nighttime far fog distance<br />
...
<p><a id="GetWeatherHDRValue" class="f" href="https://cs.uesp.net/wiki/GetWeatherHDRValue">GetWeatherHDRValue</a> - returns the specified HDR value for the weather<br />
...
<p><a id="SetWeatherHDRValue" class="f" href="https://cs.uesp.net/wiki/SetWeatherHDRValue">SetWeatherHDRValue</a> - sets the specified HDR value for the weather<br />
...
<p><a id="GetWeatherColor" class="f" href="https://cs.uesp.net/wiki/GetWeatherColor">GetWeatherColor</a> - returns the red, green or blue value of the specified weather color at the specified weather time<br />
...
<p><a id="SetWeatherColor" class="f" href="https://cs.uesp.net/wiki/SetWeatherColor">SetWeatherColor</a> - sets the red, green and blue values for the specified weather color at the specified weather time<br />
...
<p><a id="GetWeatherLightningFrequency" class="f" href="https://cs.uesp.net/wiki/GetWeatherLightningFrequency">GetWeatherLightningFrequency</a> - returns the frequency of the lightning<br />
...
<p><a id="SetWeatherLightningFrequency" class="f" href="https://cs.uesp.net/wiki/SetWeatherLightningFrequency">SetWeatherLightningFrequency</a> - sets the frequency of the lightning<br />
...
<p><a id="GetWeatherClassification" class="f" href="https://cs.uesp.net/wiki/GetWeatherClassification">GetWeatherClassification</a> - returns the precipitation <a href="#Weather_Classifications">classification</a> of the weather as defined in the editor<br />
...
<p><a id="IsDoor" class="f" href="https://cs.uesp.net/wiki/IsDoor">IsDoor</a> - returns whether the calling reference or passed objectID is a door<br />
<code class="s">(isDoor:bool) <span class="op">reference</span>.IsDoor <span class="op">objectID:ref</span></code></p>

<p><a id="IsFurniture" class="f" href="https://cs.uesp.net/wiki/IsFurniture">IsFurniture</a> - returns whether the calling reference or passed objectID is furniture<br />
<code class="s">(isFurniture:bool) <span class="op">reference</span>.IsFurniture <span class="op">objectID:ref</span></code></p>

<p><a id="IsActivator" class="f" href="https://cs.uesp.net/wiki/IsActivator">IsActivator</a> - returns whether the calling reference or passed objectID is an activator<br />
<code class="s">(isActivator:bool) <span class="op">reference</span>.IsActivator <span class="op">objectID:ref</span></code></p>

<p><a id="GetGameLoaded" class="f" href="https://cs.uesp.net/wiki/GetGameLoaded">GetGameLoaded</a> - returns 1 if a saved game was loaded or a new game was started since the last time this call was made. This command returns true once per game load/start for each script that uses it.<br />
<code class="s">(gameLoaded:bool) GetGameLoaded</code></p>

<p><a id="GetGameRestarted" class="f" href="https://cs.uesp.net/wiki/GetGameRestarted">GetGameRestarted</a> - returns 1 if Oblivion was exited and restarted since the last time this call was made from the calling script. Use this condition to reset or undo changes made by OBSE functions which are not stored in the savegame.<br />
<code class="s">(gameRestarted:bool) GetGameRestarted</code></p>

<p><a id="GetOBSEVersion" class="f" href="https://cs.uesp.net/wiki/GetOBSEVersion">GetOBSEVersion</a> - returns the version number of OBSE<br />
<code class="s">(obseVersion:int) GetOBSEVersion</code></p>

<p><a id="GetOBSERevision" class="f" href="https://cs.uesp.net/wiki/GetOBSERevision">GetOBSERevision</a> - returns the minor version number of OBSE. For instance, when running the second released version of v0014, this function returns 2.<br />
<code class="s">(obseRevision:int) GetOBSERevision</code></p>

<p><a id="SetNumericGameSetting" class="f" href="https://cs.uesp.net/wiki/SetNumericGameSetting">SetNumericGameSetting</a> - sets the specified game setting to the following variable or direct value<br />
<code class="s">(nothing) SetNumericGameSetting gameSettingName:string value:float</code></p>

<p><a id="GetStringGameSetting" class="f" href="https://cs.uesp.net/wiki/GetStringGameSetting">GetStringGameSetting</a> - returns the string value of a game setting<br />
<code class="s">(setting:string_var) GetStringGameSetting settingName:string</code></p>

<p><a id="SetStringGameSettingEX" class="f" href="https://cs.uesp.net/wiki/SetStringGameSettingEX">SetStringGameSettingEX</a> - sets the string value of a game setting. The new string value is contained within the format string, following the setting name and separated by a pipe character, i.e. <code>"nameOfGameSetting|newValueOfGameSetting"</code>. When calling from the console, use '@' instead of the pipe character.<br />
<code class="s">(nothing) SetStringGameSettingEX settingNameAndNewValue:<a href="#Format_Specifiers">formatString</a></code></p>

<p><a id="GetNumericINISetting" class="f" href="https://cs.uesp.net/wiki/GetNumericINISetting">GetNumericINISetting</a> - returns the specified ini setting<br />
<code class="s">(setting:float) GetNumericINISetting iniSettingName:string</code></p>

<p><a id="SetNumericINISetting" class="f" href="https://cs.uesp.net/wiki/SetNumericINISetting">SetNumericINISetting</a> - sets the specified ini setting to the following variable or direct value<br />
<code class="s">(nothing) SetNumericINISetting iniSettingName:string value:float</code></p>

<p><a id="GetStringIniSetting" class="f" href="https://cs.uesp.net/wiki/GetStringINISetting">GetStringINISetting</a> - returns the value of a string ini setting<br />
<code class="s">(setting:string_var) GetStringINISetting settingName:<a href="#Format_Specifiers">formatString</a></code></p>

<p><a id="SetStringIniSetting" class="f" href="https://cs.uesp.net/wiki/SetStringINISetting">SetStringINISetting</a> - sets the ini setting to the specified string. Pass both arguments as a single string of the format "settingName|newValue". If called from the console, use the "@" character in place of the pipe character.<br />
<code class="s">(nothing) SetStringINISetting settingNameAndValue:<a href="#Format_Specifiers">formatString</a></code></p>

<p><a id="GetFPS" class="f" href="https://cs.uesp.net/wiki/GetFPS">GetFPS</a> - returns the frames per second of the game<br />
<code class="s">(fps:float) GetFPS</code></p>

<p><a id="IsThirdPerson" class="f" href="https://cs.uesp.net/wiki/IsThirdPerson">IsThirdPerson</a> - returns whether the point of view is 3rd person or not<br />
<code class="s">(isThirdPerson:bool) IsThirdPerson</code></p>

<p><a id="IsGlobalCollisionDisabled" class="f" href="https://cs.uesp.net/wiki/IsGlobalCollisionDisabled">IsGlobalCollisionDisabled</a> - returns whether collision is disabled<br />
<code class="s">(isDisabled:bool) IsGlobalCollisionDisabled</code></p>

<p><a id="SetDisableGlobalCollision" class="f" href="https://cs.uesp.net/wiki/SetDisableGlobalCollision">SetDisableGlobalCollision</a> - sets whether to disable the global collision or not<br />
<code class="s">(nothing) SetDisableGlobalCollision toDisableOrNot:bool</code></p>

<p><a id="RunBatchScript" class="f" href="https://cs.uesp.net/wiki/RunBatchScript">RunBatchScript</a> - runs a specified text file under the Oblivion directory as a script. Works the same as the console function <code>bat.</code> The optional second parameter causes the script to execute on the calling object, if any. The optional third parameter prevents any output from appearing in the console while the script executes.<br />
...
<p><a id="GetFormFromMod" class="f" href="https://cs.uesp.net/wiki/GetFormFromMod">GetFormFromMod</a> - attempts to look up and return a form defined in another mod, prepending the two-digit mod index to the formID. The formID is passed in hexadecimal format, i.e. 0001A46B. The first two digits of the formID are ignored and can be omitted. The file name must include the file extension. Pass "NONE" as the file name to look up a dynamic form in the saved game (mod index 0xFF, for example cloned forms).<br />
<code class="s">(form:ref) GetFormFromMod modFileName:string formID:hexString</code></p>

<p><a id="ToggleFirstPerson" class="f" href="https://cs.uesp.net/wiki/ToggleFirstPerson">ToggleFirstPerson</a> - toggles the player's POV to first or third person. Passing 1 enables first person view, 0 enables third person.<br />
<code class="s">(nothing) ToggleFirstPerson toFirstPerson:bool</code></p>

<p><a id="GetLastCreatedSpell" class="f" href="https://cs.uesp.net/wiki/GetLastCreatedSpell">GetLastCreatedSpell</a> - returns the spell most recently created by the player during the current game session<br />
<code class="s">(spell:ref) GetLastCreatedSpell</code></p>

<p><a id="GetLastEnchantedItem" class="f" href="https://cs.uesp.net/wiki/GetLastEnchantedItem">GetLastEnchantedItem</a> - returns the enchanted item most recently created by the player during the current game session<br />
<code class="s">(item:ref) GetLastEnchantedItem</code></p>

<p><a id="GetLastCreatedPotion" class="f" href="https://cs.uesp.net/wiki/GetLastCreatedPotion">GetLastCreatedPotion</a> - returns the potion most recently created by the player during the current game session<br />
<code class="s">(potion:ref) GetLastCreatedPotion</code></p>

<p><a id="GetLastUniqueCreatedPotion" class="f" href="https://cs.uesp.net/wiki/GetLastUniqueCreatedPotion">GetLastUniqueCreatedPotion</a> - returns the last <span class="op">unique</span> potion created by the player. The game remembers which potions the player has created in the past. The first time the player creates apotion of a given magnitude and effects, that potion will be returned by GetLastUniqueCreatedPotion. Subsequently, creating a potion of the same effects and magnitude will not create a unique potion and so the potion will not be returned by this command.<br />
<code class="s">(potion:ref) GetLastUniqueCreatedPotion</code></p>

<p><a id="IsConsoleOpen" class="f" href="https://cs.uesp.net/wiki/IsConsoleOpen">IsConsoleOpen</a> - returns 1 if the console is currently open<br />
<code class="s">(open:bool) IsConsoleOpen</code></p>

<p><a id="LoadGameEx" class="f" href="https://cs.uesp.net/wiki/LoadGameEx">LoadGameEx</a> - attempts to load the saved game with the specified name<br />
<code class="s">(nothing) LoadGameEx <a href="#Format_Specifiers">formatString</a>:string <span class="op">var1 var2 ... var20</span></code></p>

<p><a id="ActorValueToString" class="f" href="https://cs.uesp.net/wiki/ActorValueToString">ActorValueToString</a> - converts an actor value to its localized name<br />
...
<p><a id="ActorValueToStringC" class="f" href="https://cs.uesp.net/wiki/ActorValueToStringC">ActorValueToStringC</a> - converts an <a href="#Actor_Value_Codes">actor value code</a> to its localized name<br />
<code class="s">(actorValueName:string) ActorValueToStringC toConvert:actorValueCode</code></p>

<p><a id="StringToActorValue" class="f" href="https://cs.uesp.net/wiki/StringToActorValue">StringToActorValue</a> - converts the name of an actor value into the actor value code itself<br />
...
<p><a id="GetEditorID" class="f" href="https://cs.uesp.net/wiki/GetEditorID">GetEditorID</a> - attempts to retrieve the editorID for the specified object. EditorIDs for most forms are not loaded at run-time. Currently this function only returns editor IDs for cells and quests - for other types, returns the formID as a string. If the second argument is non-zero, however, returns an empty string instead of the formID.<br />
<code class="s">(editorID:string) GetEditorID object:ref <span class="op">noFormID:bool</span></code></p>

<p><a id="GetEditorID2" class="f" href="https://cs.uesp.net/wiki/GetEditorID2">GetEditorID2</a> - attempts to retrieve the editorID for the specified object. If REID is installed it interrogate it's Interface (TODO more plugins management).<br />
<code class="s">(editorID:string) GetEditorID2 object:ref</code></p>

<p><a id="GetFormIDString" class="f" href="https://cs.uesp.net/wiki/GetFormIDString">GetFormIDString</a> - returns the formID of the specified object as a hexadecimal string. If the object cannot be found in memory (for example, a non-persistent reference), returns "00000000"<br />
<code class="s">(formID:string) <span class="op">reference.</span>GetFormIDString <span class="op">object:ref</span></code></p>

<p><a id="GetRawFormIDString" class="f" href="https://cs.uesp.net/wiki/GetRawFormIDString">GetRawFormIDString</a> (GetFormIDString2) - returns the formID stored in an array element or ref variable as a hexadecimal string. Unlike GetFormIDString, this command does not care if  the formID is valid.<br />
<code class="s">(formID:string) GetRawFormIDString object:ref</code></p>

<p><a id="GetUserTime" class="f" href="https://cs.uesp.net/wiki/GetUserTime">GetUserTime</a> - returns a StringMap containing information about the time and date on the player's system<br />
...
<p><a id="ActorValueToCode" class="f" href="https://cs.uesp.net/wiki/ActorValueToCode">ActorValueToCode</a> - given an actor value name, returns the corresponding <a href="#Actor_Value_Codes">actor value code</a><br />
<code class="s">(code:int) ActorValueToCode toConvert:actorValue</code></p>

<p><a id="GetGameDifficulty" class="f" href="https://cs.uesp.net/wiki/GetGameDifficulty">GetGameDifficulty</a> - returns the current difficulty level of the game as a float from -1.0 to 1.0, with higher values corresponding to greater difficulty.<br />
<code class="s">(difficulty:float) GetGameDifficulty</code></p>

<p><a id="SetGameDifficulty" class="f" href="https://cs.uesp.net/wiki/SetGameDifficulty">SetGameDifficulty</a> - sets the current difficulty level of the game as a float from -1.0 to 1.0, with higher values corresponding to greater difficulty. Values outside of the valid range are ignored.<br />
<code class="s">(nothing) SetGameDifficulty difficulty:float</code></p>

<p><a id="GetOblivionDirectory" class="f" href="https://cs.uesp.net/wiki/GetOblivionDirectory">GetOblivionDirectory</a> - returns the full path to the user's Oblivion install<br />
<code class="s">(directory:string) GetOblivionDirectory</code></p>

<p><a id="GetWaterShader" class="f" href="https://cs.uesp.net/wiki/GetWaterShader">GetWaterShader</a> - returns information about the current water shader given a string representing one of the water shader properties. Supports the same property names as the ModWaterShader console command: "direction", "velocity", "frequency", "amplitude", "fresnel", "reflectivity", "opacity", "blend", "scrollx", "scrolly", "rainforce", "rainvelocity", "rainfalloff", "rainsize", "displaceforce", "displacevelocity", "displacefalloff", and "displacedampener".<br />
<code class="s">(shaderValue:float) GetWaterShader propertyName:string</code></p>

<p><a id="GetGridsToLoad" class="f" href="https://cs.uesp.net/wiki/GetGridsToLoad">GetGridsToLoad</a> - returns the effective value of the uGridsToLoad ini setting. This value is specified in Oblivion.ini but adjusted by the game during play.<br />
<code class="s">(gridsToLoad:int) GetGridsToLoad</code></p>

<p><a id="SetOLMPGrids" class="f" href="https://cs.uesp.net/wiki/SetOLMPGrids">SetOLMPGrids</a> - specifies the number of grids that a call to OutputLocalMapPicturesOverride should use when generating local map pictures. The value passed in must be smaller than the effective value of the uGridsToLoad ini setting, which can be obtained with GetGridsToLoad. All subsequent calls to OutputLocalMapPicturesOverride will use the new value.<br />
<code class="s">(valueSet:bool) SetOLMPGrids grids:int</code></p>

<p><a id="OutputLocalMapPicturesOverride" class="f" href="https://cs.uesp.net/wiki/OutputLocalMapPicturesOverride">OutputLocalMapPicturesOverride</a> - this command is identical to the console command OutputLocalMapPictures, except it uses the number of grids specified by the last call to SetOLMPGrids when generating the maps.<br />
<code class="s">(nothing) OutputLocalMapPicturesOverride</code><br />
<code class="s">(nothing) OLMPOR</code></p>

<p><a id="GetWorldSpaceParentWorldSpace" class="f" href="https://cs.uesp.net/wiki/GetWorldSpaceParentWorldSpace">GetWorldSpaceParentWorldSpace</a> - returns a worldspace's parent worldspace<br />
...
<p><a id="GlobalVariableExists" class="f" href="https://cs.uesp.net/wiki/GlobalVariableExists">GlobalVariableExists</a> - returns 1 if a global variable exists with the specified editorID<br />
<code class="s">(globalVariableExists:bool) GlobalVariableExists variableEditorID:string</code></p>

<p><a id="GetCellChanged" class="f" href="https://cs.uesp.net/wiki/GetCellChanged">GetCellChanged</a> -returns 1 if the player has entered a new cell since the last time the command was called from the calling script, including transitioning from one exterior cell to another.<br />
<code class="s">(cellChanged:bool) GetCellChanged</code></p>

<p><a id="ResolveModIndex" class="f" href="https://cs.uesp.net/wiki/ResolveModIndex">ResolveModIndex</a> - Attempts to resolve a mod index which was stored during a previous game session to account for any changes to the user's load order. Given the stored mod index for a mod, returns the mod index currently associated with that same mod, or -1 if the index could not be resolved (for instance, because the mod is no longer loaded).<br />
<code class="s">(resolvedModIndex:int) ResolveModIndex storedModIndex:int</code></p>

<p><a id="SetCameraFOV2" class="f" href="https://cs.uesp.net/wiki/SetCameraFOV2">SetCameraFOV2</a> - Set Camera FOV without constraints.<br />
<code class="s"> SetCameraFOV2 FOV:int</code></br>
<code class="s"> SetFOV2 FOV:int</code></p>

<p><a id="GetLoadedTypeArray" class="f" href="https://cs.uesp.net/wiki/GetLoadedTypeArray">GetLoadedTypeArray</a> - Return an array with all Loaded form of type and optionally with specific mod index.<br />
<code class="s"> (forms:array) GetLoadedTypeArray formType:int  <span class="op">modid:int</span></code></br>
<code class="s"> (forms:array) GLTA formType:int  <span class="op">modid:int</span></code></p>
...
<p><a id="CloneForm" class="f" href="https://cs.uesp.net/wiki/CloneForm">CloneForm</a> - creates and returns a new base object that is an exact copy of the passed objectID<br />
...
<p><a id="IsClonedForm" class="f" href="https://cs.uesp.net/wiki/IsClonedForm">IsClonedForm</a> - returns whether the passed objectID is a cloned form or not. A cloned form is saved as part of the save game. Instances of cloned forms are player created potions, spells and enchanted items<br />
...
<p><a id="SaveIP" class="f" href="https://cs.uesp.net/wiki/SaveIP">Label</a> - save the location of the command following the <code>SaveIP</code> command<br />
...
<p><a id="RestoreIP" class="f" href="https://cs.uesp.net/wiki/RestoreIP">Goto</a> - jump to a previously saved location<br />
...
<p><a id="GetNumRefsInCell" class="f" href="https://cs.uesp.net/wiki/GetNumRefsInCell">GetNumRefsInCell</a> - Works the same as <code>GetNumRefs</code> but takes an additional parameter specifying the cell to scan. Only counts persistent references if the cell is not loaded in memory.<br />
...
<p><a id="GetHighActors" class="f" href="https://cs.uesp.net/wiki/GetHighActors">GetHighActors</a> - returns an Array containing all actors currently in high AI processing. Generally this is equivalent to all the actors in the currently loaded interior cell or set of exterior cells adjacent to and including the player's current cell. This command is more efficient than using GetFirst/NextRef.<br />
<code class="s">(actors:Array) GetHighActors</code></p>

<p><a id="GetMiddleHighActors" class="f" href="https://cs.uesp.net/wiki/GetMiddleHighActors">GetMiddleHighActors</a> - returns an Array containing all actors currently in middle high AI processing. This generally includes all actors in cells that are not currently loaded but which have recently been visited by the player. This command is more efficient than using GetFirst/NextRef.<br />
<code class="s">(actors:Array) GetMiddleHighActors</code></p>

<p><a id="GetLowActors" class="f" href="https://cs.uesp.net/wiki/GetLowActors">GetLowActors</a> - returns an Array containing all actors currently in low AI processing. This generally includes actors on unloaded cells. This command is more efficient than using GetFirst/NextRef.<br />
...
<p><a id="IsKeyPressed" class="f" href="https://cs.uesp.net/wiki/IsKeyPressed">IsKeyPressed</a> - returns whether the specified key is currently pressed. Uses standard windows key codes.<br />
<code class="s">(isKeyPressed:bool) IsKeyPressed windowsKeyCode:int</code></p>

<p><a id="IsKeyPressed2" class="f" href="https://cs.uesp.net/wiki/IsKeyPressed2">IsKeyPressed2</a> - returns whether the specified key is currently pressed. Uses DX scancodes. Detect Tapped/Hold/Hammered keys but not Disabled keys<br />
<code class="s">(isKeyPressed:bool) IsKeyPressed2 dxScanCode:int</code></p>

<p><a id="GetKeyPress" class="f" href="https://cs.uesp.net/wiki/GetKeyPress">GetKeyPress</a> - returns the DX scan code of the key being pressed. If more than one key is pressed use whichIndex to choose which keycode to return.<br />
<code class="s">(keyPressed:int) GetKeyPress <span class="op">whichIndex:int</span></code></p>

<p><a id="GetNumKeysPressed" class="f" href="https://cs.uesp.net/wiki/GetNumKeysPressed">GetNumKeysPressed</a> - returns the number of keys currently pressed<br />
<code class="s">(count:int) GetNumKeysPressed</code></p>

<p><a id="DisableKey" class="f" href="https://cs.uesp.net/wiki/DisableKey">DisableKey</a> - disables the key with the specified dx scancode<br />
<code class="s">(nothing) DisableKey dxScanCode:int</code></p>

<p><a id="EnableKey" class="f" href="https://cs.uesp.net/wiki/EnableKey">EnableKey</a> - enables the key with the specified dx scancode. Turns off DisableKey.<br />
<code class="s">(nothing) EnableKey dxScanCode:int</code></p>

<p><a id="HoldKey" class="f" href="https://cs.uesp.net/wiki/HoldKey">HoldKey</a> - holds down the key with the specified dx scancode<br />
<code class="s">(nothing) HoldKey dxScanCode:int</code></p>

<p><a id="ReleaseKey" class="f" href="https://cs.uesp.net/wiki/ReleaseKey">ReleaseKey</a> - releases a held key with the specified dx scancode<br />
<code class="s">(nothing) ReleaseKey dxScanCode:int</code></p>

<p><a id="TapKey" class="f" href="https://cs.uesp.net/wiki/TapKey">TapKey</a> - presses the key with the specidied dx scancode once<br />
<code class="s">(nothing) TapKey dxScanCode:int</code></p>

<p><a id="HammerKey" class="f" href="https://cs.uesp.net/wiki/HammerKey">HammerKey</a> - fakes keypresses every other frame of the key with the specified dx scancode<br />
<code class="s">(nothing) HammerKey dxScanCode:int</code></p>

<p><a id="AHammerKey" class="f" href="https://cs.uesp.net/wiki/AHammerKey">AHammerKey</a> - fakes keypresses every other frame on the alternate frames from HammerKey of the key with the specified dx scancode<br />
<code class="s">(nothing) AHammerKey dxScanCode:int</code></p>

<p><a id="UnHammerKey" class="f" href="https://cs.uesp.net/wiki/UnHammerKey">UnHammerKey</a> - stops hammering the key with the specified dx scancode<br />
<code class="s">(nothing) UnHammerKey dxScanCode:int</code></p>

<p><a id="GetControl" class="f" href="https://cs.uesp.net/wiki/GetControl">GetControl</a> - returns the dx scancode of the key used for the specified control<br />
<code class="s">(dxScanCode:int) GetControl <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="GetAltControl2" class="f" href="https://cs.uesp.net/wiki/GetAltControl2">GetAltControl2</a> - returns the dx scancode of the alternate key used for the specified control. Unlike GetAltControl, the return value of this function is a valid DX scan code which requires no further calculation for use with other input functions.<br />
<code class="s">(dxScanCode:int) GetAltControl2 <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="GetMouseButtonPress" class="f" href="https://cs.uesp.net/wiki/GetMouseButtonPress">GetMouseButtonPress</a> - returns the dx scancode of the mouse button being pressed. If more than one mouse button is pressed, use whichIndex to choose which code to return<br />
<code class="s">(dxScanCode:int) GetMouseButtonPress whichIndex:int</code></p>

<p><a id="GetNumMouseButtonsPressed" class="f" href="https://cs.uesp.net/wiki/GetNumMouseButtonsPressed">GetNumMouseButtonsPressed</a> - returns the number of mouse buttons pressed<br />
<code class="s">(count:int) GetNumMouseButtonsPressed</code></p>

<p><a id="DisableMouse" class="f" href="https://cs.uesp.net/wiki/DisableMouse">DisableMouse</a> - prevents the mouse from moving<br />
<code class="s">(nothing) DisableMouse</code></p>

<p><a id="EnableMouse" class="f" href="https://cs.uesp.net/wiki/EnableMouse">EnableMouse</a> - turns off <code>DisableMouse</code><br />
<code class="s">(nothing) EnableMouse</code></p>

<p><a id="MoveMouseX" class="f" href="https://cs.uesp.net/wiki/MoveMouseX">MoveMouseX</a> - moves the mouse horizontally the specified number of pixels<br />
<code class="s">(nothing) MoveMouseX pixels:int</code></p>

<p><a id="MoveMouseY" class="f" href="https://cs.uesp.net/wiki/MoveMouseY">MoveMouseY</a> - moves the mouse veritcally the specified number of pixels<br />
<code class="s">(nothing) MoveMouseY pixels:int</code></p>

<p><a id="SetMouseSpeedX" class="f" href="https://cs.uesp.net/wiki/SetMouseSpeedX">SetMouseSpeedX</a> - moves the mouse in the horizontal axis at the specified number of pixels per second<br />
<code class="s">(nothing) SetMouseSpeedX pixels:float</code></p>

<p><a id="SetMouseSpeedY" class="f" href="https://cs.uesp.net/wiki/SetMouseSpeedY">SetMouseSpeedY</a> - moves the mouse in the vertical axis at the specified number of pixels per second<br />
<code class="s">(nothing) SetMouseSpeedY pixels:float</code></p>

<p><a id="IsKeyPressed3" class="f" href="https://cs.uesp.net/wiki/IsKeyPressed3">IsKeyPressed3</a> - returns 1 if the key or mouse button specified is currently pressed. Just like IsKeyPressed2, but detects disabled keys.<br />
<code class="s">(isPressed:bool) IsKeyPressed3 dxScanCode:int</code></p>

<p><a id="IsControlPressed" class="f" href="https://cs.uesp.net/wiki/IsControlPressed">IsControlPressed</a> - returns 1 if either the key or mouse button assigned to the specified control code is currently pressed. Detects disabled keys.<br />
<code class="s">(isPressed:bool) IsControlPressed <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="DisableControl" class="f" href="https://cs.uesp.net/wiki/DisableControl">DisableControl</a> - disables both the key and mouse buton assigned to the specified control<br />
<code class="s">(nothing) DisableControl <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="EnableControl" class="f" href="https://cs.uesp.net/wiki/EnableControl">EnableControl</a> - enables the key and mouse button for a control disabled with <code>DisableControl</code><br />
<code class="s">(nothing) EnableControl <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="OnKeyDown" class="f" href="https://cs.uesp.net/wiki/OnKeyDown">OnKeyDown</a> - registers a script as a listener for input events. Returns 1 for one frame when the passed key or mouse button is pressed. If used by multiple scripts, each script will be informed of the key's state. Will not return true again until the key is released and then pressed again.<br />
<code class="s">(keyPressed:bool) OnKeyDown dxScanCode:int</code></p>

<p><a id="OnControlDown" class="f" href="https://cs.uesp.net/wiki/OnControlDown">OnControlDown</a> - works like <code>OnKeyDown</code>, but takes a control code and returns 1 when the key or mouse buttonassigned to that control is pressed<br />
<code class="s">(controlPressed:bool) OnControlDown <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="TapControl" class="f" href="https://cs.uesp.net/wiki/TapControl">TapControl</a> - presses the key or mouse button associated with the specified control once<br />
<code class="s">(nothing) TapControl <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="SetControl" class="f" href="https://cs.uesp.net/wiki/SetControl">SetControl</a> - assigns a new key to the specified control. If the specified control already has a key assigned, the key mappings are swapped.<br />
<code class="s">(nothing) SetControl <a href="#Input_Control_IDs">whichControl</a>:int dxScanCode:int</code></p>

<p><a id="SetAltControl2" class="f" href="https://cs.uesp.net/wiki/SetAltControl2">SetAltControl2</a> - assigns a new mouse button to the specified control. If the specified control already has a mouse button assigned, the button mappings are swapped.<br />
<code class="s">(nothing) SetAltControl2 <a href="#Input_Control_IDs">whichControl</a>:int dxScanCode:int</code></p>

<p><a id="GetCursorPos" class="f" href="https://cs.uesp.net/wiki/GetCursorPos">GetCursorPos</a> - returns the current X or Y coordinate of the mouse cursor in menu mode. Minumum coordinate is zero, maximum is determined by the user's screen resolution. Specify 'X' or 'Y' for the axis.<br />
<code class="s">(cursorPos:int) GetCursorPos axis:char</code></p>

<p><a id="SetIsControl" class="f" href="https://cs.uesp.net/wiki/SetIsControl">SetIsControl</a> - allows mods to register or unregister keys or mouse buttons as custom controls. Other mods can then use <code>IsControl</code> to detect conflicts between custom controls.<br />
<code class="s">(nothing) SetIsControl keyCode:int isControl:bool</code></p>

<p><a id="IsControl" class="f" href="https://cs.uesp.net/wiki/IsControl">IsControl</a> - returns 1 if the specified key or mouse button is assigned to a game control, 2 if it has been registered as a custom control by a mod via <code>SetIsControl</code>, or 0 otherwise.<br />
<code class="s">(isControl:int) IsControl keyCode:int</code></p>

<p><a id="IsKeyDisabled" class="f" href="https://cs.uesp.net/wiki/IsKeyDisabled">IsKeyDisabled</a> - returns 1 if the key has been disabled using <code>DisableKey</code><br />
<code class="s">(isDisabled:bool) IsKeyDisabled keycode:int</code></p>

<p><a id="IsControlDisabled" class="f" href="https://cs.uesp.net/wiki/IsControlDisabled">IsControlDisabled</a> - returns 1 if thecontrol has been disabled by a call to <code>DisableControl</code>. Note that this only keeps track of calls to <code>DisableControl</code> and <code>EnableControl</code>; it does not check if the disabled state of the key or mouse button has been affected by <code>DisableKey</code><br />
<code class="s">(isDisabled:bool) IsControlDisabled <a href="#Input_Control_IDs">whichControl</a>:int</code></p>

<p><a id="GetMouseButtonsSwapped" class="f" href="https://cs.uesp.net/wiki/GetMouseButtonsSwapped">GetMouseButtonsSwapped</a> - returns true if the user has configured his operating system to swap the left and right mouse buttons. Input functions respect the swap configuration.<br />
<code class="s">(swapped:bool) GetMouseButtonsSwapped</code></p>

<h2><a id="Math_Functions">Math Functions</a></h2>

<p><a id="Abs" class="f" href="https://cs.uesp.net/wiki/Abs">Abs</a> - returns the absolute value of the argument<br />
<code class="s">(absoluteValue:float) abs arg:float</code></p>

<p><a id="Ceil" class="f" href="https://cs.uesp.net/wiki/Ceil">Ceil</a> - returns the nearest whole number above the argument<br />
<code class="s">(ceil:float) ceil arg:float</code></p>

<p><a id="Exp" class="f" href="https://cs.uesp.net/wiki/Exp">Exp</a> - returns e to the power of the argument<br />
<code class="s">(exp:float) exp arg:float</code></p>

<p><a id="Floor" class="f" href="https://cs.uesp.net/wiki/Floor">Floor</a> - returns the nearest whole number less than the argument<br />
<code class="s">(floor:float) floor arg:float</code></p>

<p><a id="Log" class="f" href="https://cs.uesp.net/wiki/Log">Log</a> - returns the natural logarithm of the number<br />
<code class="s">(log:float) log arg:float</code></p>

<p><a id="Log10" class="f" href="https://cs.uesp.net/wiki/Log10">Log10</a> - returns the base 10 logarithm of the number<br />
<code class="s">(log10:float) log10 arg:float</code></p>

<p><a id="Pow" class="f" href="https://cs.uesp.net/wiki/Pow">Pow</a> - returns the base raised to the exponents power<br />
<code class="s">(pow:float) pow base:float exponent:float</code></p>

<p><a id="Rand" class="f" href="https://cs.uesp.net/wiki/Rand">Rand</a> - returns a random number between min and max<br />
<code class="s">(rand:float) rand min:float max:float</code></p>

<p><a id="SquareRoot" class="f" href="https://cs.uesp.net/wiki/SquareRoot">SquareRoot</a> - returns the square root of the argument<br />
<code class="s">(sqrt:float) squareroot arg:float</code><br />
<code class="s">(sqrt:float) sqrt arg:float</code></p>

<p><a id="Fmod" class="f" href="https://cs.uesp.net/wiki/Fmod">Fmod</a> - returns the floating point modulus of dividend in the given base. This differs from <code>dividend % base</code> in the scripting language as <code>%</code> is a strictly integer function. When base is positive, <code>0 &lt;= result &lt; base</code>. The <em>optional</em> offset shifts the range of the result to <code>offset &lt;= result &lt; base+offset</code>.</p>
...
<p><a id="ACos" class="f" href="https://cs.uesp.net/wiki/ACos">ACos</a> - returns the arccosine of the argument. <code>ACos</code> and <code>DACos</code> use degrees. <code>RACose</code> uses radians.<br />
...
<p><a id="ASin" class="f" href="https://cs.uesp.net/wiki/ASin">ASin</a> - returns the arcsine of the argument. <code>ASin</code> and <code>DASin</code> use degrees. <code>RASin</code> uses radians.<br />
...
<p><a id="ATan" class="f" href="https://cs.uesp.net/wiki/ATan">ATan</a> - returns the arctangent of the argument. <code>ATan</code> and <code>DATan</code> use degrees. <code>RATan</code> uses radians.<br />
...
<p><a id="ATan2" class="f" href="https://cs.uesp.net/wiki/ATan2">ATan2</a> - returns the arctangent of the arguments. <code>ATan2</code> and <code>DATan2</code> use degrees. <code>RATan2</code> uses radians.<br />
...
<p><a id="Cos" class="f" href="https://cs.uesp.net/wiki/Cos">Cos</a> - returns the cosine of the angle. <code>Cos</code> and <code>DCos</code> use degrees. <code>RCos</code> uses radians.<br />
...
<p><a id="Cosh" class="f" href="https://cs.uesp.net/wiki/Cosh">Cosh</a> - returns the hyperbolic cosine of the angle. <code>Cosh</code> and <code>DCosh</code> use degrees. <code>RCosh</code> uses radians.<br />
...
<p><a id="Sin" class="f" href="https://cs.uesp.net/wiki/Sin">Sin</a> - returns the sine of the angle. <code>Sin</code> and <code>DSin</code> use degrees. <code>RSinh</code> uses radians.<br />
...
<p><a id="Sinh" class="f" href="https://cs.uesp.net/wiki/Sinh">Sinh</a> - returns the hyperbolic sine of the angle. <code>Sinh</code> and <code>DSinh</code> use degrees. <code>RSinh</code> uses radians.<br />
...
<p><a id="Tan" class="f" href="https://cs.uesp.net/wiki/Tan">Tan</a> - returns the tangent of the angle. <code>Tan</code> and <code>DTan</code> use degrees. <code>RTan</code> uses radians.<br />
...
<p><a id="Tanh" class="f" href="https://cs.uesp.net/wiki/Tanh">Tanh</a> - returns the hyperbolic tangent of the angle. <code>Tanh</code> and <code>DTanh</code> use degrees. <code>RTanh</code> uses radians.<br />
...
<p><a id="LeftShift" class="f" href="https://cs.uesp.net/wiki/LeftShift">LeftShift</a> - shifts the argument left by the specified number of bits. Returns zero if shiftAmount is &gt;= 32.<br />
<code class="s">(result:int) LeftShift value:int shiftAmount:int</code></p>

<p><a id="RightShift" class="f" href="https://cs.uesp.net/wiki/RightShift">RightShift</a> - shifts the argument right by the specified number of bits, inserting zeros on the left. Returns zero if shiftAmount is &gt;= 32.<br />
<code class="s">(result:int) RightShift value:int shiftAmount:int</code></p>

<p><a id="LogicalAnd" class="f" href="https://cs.uesp.net/wiki/LogicalAnd">LogicalAnd</a> - returns the bitwise AND of the two arguments<br />
<code class="s">(result:int)LogicalAnd arg1:int arg2:int</code></p>

<p><a id="LogicalOr" class="f" href="https://cs.uesp.net/wiki/LogicalOr">LogicalOr</a> - returns the bitwise OR of the two arguments<br />
<code class="s">(result:int)LogicalOr arg1:int arg2:int</code></p>

<p><a id="LogicalXor" class="f" href="https://cs.uesp.net/wiki/LogicalXor">LogicalXor</a> - returns the bitwise XOR of the two arguments<br />
<code class="s">(result:int)LogicalXor arg1:int arg2:int</code></p>

<p><a id="LogicalNot" class="f" href="https://cs.uesp.net/wiki/LogicalNot">LogicalNot</a> - returns the bitwise NOT of the argument<br />
...
href="https://cs.uesp.net/wiki/GenerateZeroMatrix">GenerateZeroMatrix</a>
...
href="https://cs.uesp.net/wiki/GenerateIdentityMatrix">GenerateIdentityMatrix</a>
...
href="https://cs.uesp.net/wiki/GenerateRotationMatrix">GenerateRotationMatrix</a>
...
href="https://cs.uesp.net/wiki/VectorMagnitude">VectorMagnitude</a>
...
href="https://cs.uesp.net/wiki/VectorNormalize">VectorNormalize</a>
...
href="https://cs.uesp.net/wiki/VectorDot">VectorDot</a>
...
href="https://cs.uesp.net/wiki/VectorCross">VectorCross</a>
...
href="https://cs.uesp.net/wiki/ForceRowVector">ForceRowVector</a>
...
href="https://cs.uesp.net/wiki/ForceColumnVector">ForceColumnVector</a>
...
href="https://cs.uesp.net/wiki/MatrixTrace">MatrixTrace</a>
...
href="https://cs.uesp.net/wiki/MatrixDeterminant">MatrixDeterminant</a>
...
href="https://cs.uesp.net/wiki/MatrixRREF">MatrixRREF</a>
...
href="https://cs.uesp.net/wiki/MatrixInvert">MatrixInvert</a>
...
href="https://cs.uesp.net/wiki/MatrixTranspose">MatrixTranspose</a>
...
href="https://cs.uesp.net/wiki/MatrixScale">MatrixScale</a>
...
href="https://cs.uesp.net/wiki/MatrixAdd">MatrixAdd</a>
...
href="https://cs.uesp.net/wiki/MatrixSubtract">MatrixSubtract</a>
...
href="https://cs.uesp.net/wiki/MatrixMultiply">MatrixMultiply</a>
...
<p><a id="PrintToConsole" class="f" href="https://cs.uesp.net/wiki/PrintToConsole">PrintToConsole</a> - prints a formatted message to the console using the extended <a href="#Format_Specifiers">format specifiers</a>.<br />
...
<p><a id="SetMessageIcon" class="f" href="https://cs.uesp.net/wiki/SetMessageIcon">SetMessageIcon</a> - sets the icon which is to be displayed to the left of the text for the next call to <code>MessageEX</code>. The icon is a .dds file located in the folder "Data\Textures\Menus\" or a subfolder thereof. Once <code>MessageEX</code> has been called the icon will be cleared.<br />
<b>Note: </b>The full path must be entered starting with "Data".<br />
<code class="s">(nothing) SetMessageIcon iconPath:string</code></p>

<p><a id="DebugPrint" class="f" href="https://cs.uesp.net/wiki/DebugPrint">DebugPrint</a> - prints a message to the console only if debug mode has been enabled for the mod from which the calling script originates. Use <code>SetDebugMode</code> to toggle debug messages on or off. <br />
<code class="s">(nothing) DebugPrint <a href="#Format_Specifiers">formatString</a>:string <span class="op">var1 var2 ... var20</span></code></p>

<p><a id="SetDebugMode" class="f" href="https://cs.uesp.net/wiki/SetDebugMode">SetDebugMode</a> - toggles all debug messages on or off for the mod from which the calling script originates. Pass 1 as the argument to turn debug messages on, or 0 to turn them off. Optionally pass the modIndex of the mod for which you wish to toggle messages.<br />
<code class="s">(nothing) SetDebugMode EnableDebugMessages:bool <span class="op">modIndex:int</span></code></p>

<p><a id="Print" class="f" href="https://cs.uesp.net/wiki/Print">Print</a> - prints a string expression to the console. This is mainly a convenience function to eliminate the need for temporary string variables when printing complex strings using <code>PrintToConsole</code>, as it supports string concatenation, the <code>ToString</code> function, etc.<br />
<code class="s">(nothing) Print string:expr</code></p>

<p><a id="PrintD" class="f" href="https://cs.uesp.net/wiki/PrintD">PrintD</a> - as <code>DebugPrint</code>, but accepts any OBSE expression evaluating to a string<br />
...
<p>Some existing script functions generate UI messages in the top-left corner of the screen when called on the player. The following functions duplicate the behavior of those functions while suppressing those messages. Syntax is identical to the original functions.</p><ul>
	<li><a class="f" href="https://cs.uesp.net/wiki/AddItemNS">AddItemNS</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/RemoveItemNS">RemoveItemNS</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/EquipItemNS">EquipItemNS</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/UnequipItemNS">UnequipItemNS</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/AddSpellNS">AddSpellNS</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/RemoveSpellNS">RemoveSpellNS</a></li>
</ul>
<p>The following commands, in addition to suppressing UI messages, also suppress the "item up/down" sounds generated by their original versions:</p><ul>
	<li><a class="f" href="https://cs.uesp.net/wiki/EquipItemSilent">EquipItemSilent</a></li>
	<li><a class="f" href="https://cs.uesp.net/wiki/UnequipItemSilent">UnequipItemSilent</a></li>
</ul>
...
<p><a id="GetModIndex" class="f" href="https://cs.uesp.net/wiki/GetModIndex">GetModIndex</a> - returns the mod index of the specified plugin. This is equivalent to the first two digits of the object's formID (when represented in hexadecimal notation).<br />
<code class="s">(index:int) GetModIndex modName:string</code></p>

<p><a id="GetSourceModIndex" class="f" href="https://cs.uesp.net/wiki/GetSourceModIndex">GetSourceModIndex</a> - returns the mod index of the plugin from which the specified object originates<br />
<code class="s">(index:int) <span class="op">reference.</span>GetSourceModIndex <span class="op">object:ref</span></code></p>

<p><a id="GetNumLoadedMods" class="f" href="https://cs.uesp.net/wiki/GetNumLoadedMods">GetNumLoadedMods</a> - returns the number of plugins currently loaded. Used in conjunction with GetModIndex, this can be used to verify load order at run-time.<br />
<code class="s">(loadedPluginCount:int) GetNumLoadedMods</code></p>

<p><a id="IsModLoaded" class="f" href="https://cs.uesp.net/wiki/IsModLoaded">IsModLoaded</a> - returns 1 if the specified .esp or .esm is currently loaded. String is case-insensitive but must include the file extension.<br />
<code class="s">(isLoaded:bool) IsModLoaded modName:string</code></p>

<p><a id="GetNthModName" class="f" href="https://cs.uesp.net/wiki/GetNthModName">GetNthModName</a> - returns the filename of the nth loaded mod<br />
...
<p><a id="SetModLocalData" class="f" href="https://cs.uesp.net/wiki/SetModLocalData">SetModLocalData</a> - sets the data value associated with the specified key for the mod to which the calling script belongs. The key must be a string; the data can be a string, number, or object. Keys are case-insensitive and unique - only one data value can be associated with a particular key. <br />
<code class="s">(success:bool) SetModLocalData key:string data:multi</code></p>

<p><a id="GetModLocalData" class="f" href="https://cs.uesp.net/wiki/GetModLocalData">GetModLocalData</a> - gets the data value associated with the specified key for the mod to which the calling script belongs. If no data exists for the key, returns 0. <br />
<code class="s">(data:multi) GetModLocalData key:string</code></p>

<p><a id="ModLocalDataExists" class="f" href="https://cs.uesp.net/wiki/ModLocalDataExists">ModLocalDataExists</a> - returns true if local data exists with the specified key for the mod to which the calling script belongs. <br />
<code class="s">(exists:bool) ModLocalDataExists key:string</code></p>

<p><a id="RemoveModLocalData" class="f" href="https://cs.uesp.net/wiki/RemoveModLocalData">RemoveModLocalData</a> - removes the data value associated with the specified key for the mod to which the calling script belongs. If no data exists for the key, returns false, otherwise returns true. <br />
<code class="s">(removed:bool) RemoveModLocalData key:string</code></p>

<p><a id="GetAllModLocalData" class="f" href="https://cs.uesp.net/wiki/GetAllModLocalData">GetAllModLocalData</a> - returns a StringMap consisting of all of the name-value entries for the mod local data associated with the mod to which the calling script belongs. This is a copy of the local data so modifying the array contents will not modify the stored data. <br />
<code class="s">(data:StringMap) GetAllModLocalData</code></p>

<h2><a id="Hotkey_Functions">Hotkey Functions</a></h2>

<p><a id="GetHotkeyItem" class="f" href="https://cs.uesp.net/wiki/GetHotkeyItem">GetHotkeyItem</a> - returns the item or spell bound to the specified hotkey (1-8)<br />
<code class="s">(itemOrSpell:ref) GetHotkeyItem whichHotkey:int</code></p>

<p><a id="SetHotkeyItem" class="f" href="https://cs.uesp.net/wiki/SetHotkeyItem">SetHotkeyItem</a> - sets a hotkey to the specified spell or item<br />
<code class="s">(nothing) SetHotkeyItem whichHotkey:int spellOrItem:ref</code></p>

<p><a id="ClearHotkey" class="f" href="https://cs.uesp.net/wiki/ClearHotkey">ClearHotkey</a> - removes any spell or item bound to the specified hotkey<br />
<code class="s">(nothing) ClearHotkey whichHotkey:int</code></p>

<h2><a id="File_Functions">File Functions</a></h2>

<p><a id="FileExists" class="f" href="https://cs.uesp.net/wiki/FileExists">FileExists</a> - returns 1 if the specified file exists in the user's installation folder or within one of the BSA archives. Path is relative to the user's install folder, which is "Bethesda Softworks\Oblivion" by default.<br />
...
<p><a id="GetActiveMenuMode" class="f" href="https://cs.uesp.net/wiki/GetActiveMenuMode">GetActiveMenuMode</a> - returns the <a href="#Menu_Code">menu code</a> of the active menu. These are the same codes used by the <code>MenuMode</code> function.<br />
<code class="s">(<a href="#Menu_Code">menuCode</a>:int) GetActiveMenuMode</code></p>

<p><a id="GetActiveMenuSelection" class="f" href="https://cs.uesp.net/wiki/GetActiveMenuSelection">GetActiveMenuSelection</a> - returns the item in the active menu over which the mouse is currently positioned<br />
...
<p><a id="GetActiveMenuFilter" class="f" href="https://cs.uesp.net/wiki/GetActiveMenuFilter">GetActiveMenuFilter</a> - returns the <a href="#Menu_Filter_Code">code</a> which indicates the current filteroptions for the active menu<br />
...
<p><a id="GetActiveMenuRef" class="f" href="https://cs.uesp.net/wiki/GetActiveMenuRef">GetActiveMenuRef</a> - returns the reference from which the active menu is derived<br />
...
<p><a id="GetActiveMenuObject" class="f" href="https://cs.uesp.net/wiki/GetActiveMenuObject">GetActiveMenuObject</a> - returns the base object from which the active menu is derived<br />
...
<p><a id="GetEnchMenuSoulgem" class="f" href="https://cs.uesp.net/wiki/GetEnchMenuSoulgem">GetEnchMenuSoulgem</a> - returns the soulgem selected for enchantment in the enchantment menu. Only works if the enchantment menu is the active menu.<br />
<code class="s">(soulgem:ref) GetEnchMenuSoulgem</code></p>

<p><a id="GetEnchMenuEnchItem" class="f" href="https://cs.uesp.net/wiki/GetEnchMenuEnchItem">GetEnchMenuEnchItem</a> - returns the enchantment which is to be applied to the item to be enchanted. Only works if the enchantment menu is the active menu.<br />
<code class="s">(enchantment:ref) GetEnchMenuEnchItem</code></p>

<p><a id="IsBarterMenuActive" class="f" href="https://cs.uesp.net/wiki/IsBarterMenuActive">IsBarterMenuActive</a> - returns 1 if the player is bartering with a merchant, providing a way to distinguish between an ordinary container menu and a barter menu, which both return the same MenuMode code<br />
<code class="s">(isBarterMode:bool) IsBarterMenuActive</code></p>

<p><a id="GetAlchMenuIngredient" class="f" href="https://cs.uesp.net/wiki/GetAlchMenuIngredient">GetAlchMenuIngredient</a> - returns one of the four ingredients, from 0 to 3, selected for inclusion in the potion currently being brewed<br />
<code class="s">(ingredient:ref) GetAlchMenuIngredient whichIngred:int</code></p>

<p><a id="GetAlchMenuIngredientCount" class="f" href="https://cs.uesp.net/wiki/GetAlchMenuIngredientCount">GetAlchMenuIngredientCount</a> - returns the number of the specified ingredient selected for inclusion in the potion being brewed. Pass 0 for the first ingredient, 3 for the last.<br />
<code class="s">(count:int) GetAlchMenuIngredientCount whichIngred:int</code></p>

<p><a id="GetAlchMenuApparatus" class="f" href="https://cs.uesp.net/wiki/GetAlchMenuApparatus">GetAlchMenuApparatus</a> - returns the apparatus object being used in the brewing process<br />
<code class="s">(apparatus:ref) GetAlchMenuApparatus <a href="#Alchemy_Apparatus">apparatusType</a>:int</code></p>

<p><a id="CloseAllMenus" class="f" href="https://cs.uesp.net/wiki/CloseAllMenus">CloseAllMenus</a> - closes all currently open menus. Note: if the console is open at the time this function is called, it will be closed but the displayed console text will remain visible until the console is opened and closed again.<br />
<code class="s">(nothing) CloseAllMenus</code></p>

<p><a id="GetContainerMenuView" class="f" href="https://cs.uesp.net/wiki/GetContainerMenuView">GetContainerMenuView</a> - when the container/barter menu is open, returns 1 if the player is viewing his own inventory, or 0 if viewing the container or merchant's inventory<br />
<code class="s">(menuView:int) GetContainerMenuView</code></p>

<p><a id="SetButtonPressed" class="f" href="https://cs.uesp.net/wiki/SetButtonPressed">SetButtonPressed</a> - When any Message menu is displayed (game prompts such as the inventory quantity prompt as well as those created by the <code>MessageBox</code> function), forces the menu to behave as if the specified button was pressed. Button IDs range from 0 to 9.<br />
<code class="s">(nothing) SetButtonPressed buttonID:int</code></p>

<p><a id="IsGameMessageBox" class="f" href="https://cs.uesp.net/wiki/IsGameMessageBox">IsGameMessageBox</a> - returns 1 if a messagebox is currently displayed which was generated by game code (e.g., confirm item purchase) rather than a script<br />
<code class="s">(isGameMessage:bool) IsGameMessageBox</code></p>

<p><a id="GetMessageBoxType" class="f" href="https://cs.uesp.net/wiki/GetMessageBoxType">GetMessageBoxType</a> - returns a code indicating the origin of the currently-displayed messagebox</p>
...
<p><a id="GetActiveUIComponentName" class="f" href="https://cs.uesp.net/wiki/GetActiveUIComponentName">GetActiveUIComponentName</a> - returns the name of the menu element currently highlighted by the mouse cursor as defined in the menu XML file.<br />
<code class="s">(name:string_var) GetActiveUIComponentName</code></p>

<p><a id="GetActiveUIComponentFullName" class="f" href="https://cs.uesp.net/wiki/GetActiveUIComponentFullName">GetActiveUIComponentFullName</a> - like GetActiveUIComponentName, returns the name of the menu element currently highlighted by the mouse cursor, if any. However the returned name is fully qualified with the names of the element's parents in a form suitable to pass to commands like GetMenuFloatValue. i.e., if button_1 is highlighted in the MessageMenu, this command returns "background\button_1".<br />
...
<p><a id="GetTileTraits" class="f" href="https://cs.uesp.net/wiki/GetTileTraits">GetTileTraits</a> - given a UI component, returns a StringMap representing all of that component's traits and their values. The keys of the returned StringMap's elements are the names of the traits; their values are the string or numeric values of the traits. This command is more efficient for accessing multiple traits of the same component than the commands which access traits individually.<br />
<code class="s">(traits:StringMap) GetTileTraits componentName:string menuType:int</code></p>

<p><a id="PrintTileInfo" class="f" href="https://cs.uesp.net/wiki/PrintTileInfo">PrintTileInfo</a> - a debugging command which outputs all of the children of a UI component as well as the names and values of all of its traits. Output is sent to the console and to obse.log. Avoid using this function in released mods; it is intended for testing and debugging only.<br />
<code class="s">(nothing) PrintTileInfo componentName:string menuType:int</code></p>

<p><a id="PrintActiveTileInfo" class="f" href="https://cs.uesp.net/wiki/PrintActiveTileInfo">PrintActiveTileInfo</a> - a debugging command which outputs all of the children of the UI component currently under the mouse cursor as well as the names and values of all of its traits. Output is sent to the console and to obse.log. Avoid using this function in released mods; it is intended for testing and debugging only.<br />
<code class="s">(nothing) PrintActiveTileInfo</code></p>

<p><a id="GetMapMenuMarkerName" class="f" href="https://cs.uesp.net/wiki/GetMapMenuMarkerName">GetMapMenuMarkerName</a> - when the world map menu is visible and a location icon is highlighted by the mouse, this command returns the name of the highlighted icon. At all other times it returns an empty string.<br />
<code class="s">(markerName:string) GetMapMenuMarkerName</code></p>

<p><a id="GetMapMenuMarkerRef" class="f" href="https://cs.uesp.net/wiki/GetMapMenuMarkerRef">GetMapMenuMarkerRef</a> - when the world map menu is visible and a location icon is highlighted by the mouse, this command returns a reference to the MapMarker reference associated with the highlighted icon. This is a slow function, so avoid calling it repeatedly. If you want to detect changes in the currently highlighted map icon, it is best to check GetMapMenuMarkerName over the course of several frames, and only call GetMapMenuMarkerRef if the name changes and is not an empty string.<br />
<code class="s">(markerRef:ref) GetMapMenuMarkerRef</code></p>

<p><a id="GetBarterItem" class="f" href="https://cs.uesp.net/wiki/GetBarterItem">GetBarterItem</a> - returns the active item in a container menu<br />
<code class="s">(item:ref) GetBarterItem</code></p>

<p><a id="GetBarterItemQuantity" class="f" href="https://cs.uesp.net/wiki/GetBarterItemQuantity">GetBarterItemQuantity</a> - returns the selected quantity of the active item in a container menu<br />
<code class="s">() GetBarterItemQuantity</code></p>

<p><a id="GetLastTransactionItem" class="f" href="https://cs.uesp.net/wiki/GetLastTransactionItem">GetLastTransactionItem</a> - returns the item most recently confirmed for buying or selling by the player. Note that this transaction may not have been completed due to the purchaser having insufficient gold or attempting to sell a quest item. Use <a href="#GetTransactionInfo">GetTransactionInfo</a> for more accurate information.<br />
<code class="s">(item:ref) GetLastTransactionItem</code></p>

<p><a id="GetLastTransactionQuantity" class="f" href="https://cs.uesp.net/wiki/GetLastTransactionQuantity">GetLastTransactionQuantity</a> - returns the quantity of the most recent buy/sell transaction confirmed by the player. Note that the transaction may not have been completed due to the purchaser having insufficient gold or attempting to sell a quest item. Use <a href="#GetTransactionInfo">GetTransactionInfo</a> for more accurate information.<br />
<code class="s">(quantity:short) GetLastTransactionQuantity</code></p>

<p><a id="GetTransactionInfo" class="f" href="https://cs.uesp.net/wiki/GetTransactionInfo">GetTransactionInfo</a> - returns information about the most recent barter transaction completed by the player as a Stringmap. Specify "buy" for information about the player's most recent purchase, or "sell" for his most recent sale to a merchant. Once a transaction has been returned to a particular script, subsequent calls to this function requesting the same type of transaction ("buy" or "sell") will return zero until a new transaction of that type takes place. The returned Stringmap contains the following information:<br />
...
<p><a id="GetQMCurrent" class="f" href="https://cs.uesp.net/wiki/GetQMCurrent">GetQMCurrent (GetQuantityMenuCurrentQuantity)</a> - returns the current quantity in the quantity menu<br />
<code class="s">(quantity:int) GetQMCurrent</code></p>

<p><a id="GetQMMaximum" class="f" href="https://cs.uesp.net/wiki/GetQMMaximum">GetQMMaximum (GetQuantityMenuMaximumQuantity)</a> - returns the maximum quantity in the quantity menu<br />
<code class="s">(maxQuantity:int) GetQMMaximum</code></p>

<p><a id="GetQMItem" class="f" href="https://cs.uesp.net/wiki/GetQMItem">GetQMItem (GetQuantityMenuItem)</a> - returns the active item in the quantity menu<br />
<code class="s">(item:ref) GetQMItem</code></p>

<p><a id="GetClassMenuSelectedClass" class="f" href="https://cs.uesp.net/wiki/GetClassMenuSelectedClass">GetClassMenuSelectedClass</a> - while the class selection menu is visible, returns the class which would be selected by the player if he were to click 'Done'.<br />
<code class="s">(class:ref) GetClassMenuSelectedClass</code></p>

<p><a id="GetClassMenuHighlightedClass" class="f" href="https://cs.uesp.net/wiki/GetClassMenuHighlightedClass">GetClassMenuHighlightedClass</a> - while the class selection menu is visible, returns the class over which the cursor is currently positioned, if any.<br />
<code class="s">(class:ref) GetClassMenuHighlightedClass</code></p>

<p><a id="GetEnchMenuBaseItem" class="f" href="https://cs.uesp.net/wiki/GetEnchMenuBaseItem">GetEnchMenuBaseItem</a> - while the enchantment menu is visible, returns the unenchanted item selected by the player as the target of the enchantment.<br />
<code class="s">(item:ref) GetEnchMenuBaseItem</code></p>

<p><a id="UpdateContainerMenu" class="f" href="https://cs.uesp.net/wiki/UpdateContainerMenu">UpdateContainerMenu</a> - if called while a container or barter menu is displayed, updates the contents of the menu. In barter mode this recalculates prices and quantities of available items.<br />
<code class="s">(nothing) UpdateContainerMenu</code></p>

<p><a id="UpdateSpellPurchaseMenu" class="f" href="https://cs.uesp.net/wiki/UpdateSpellPurchaseMenu">UpdateSpellPurchaseMenu</a> - when called while the spell purchase menu is visible, updates the contents of the menu to reflect changes in prices<br />
...
<p><a id="IsTextInputInUse" class="f" href="https://cs.uesp.net/wiki/IsTextInputInUse">IsTextInputInUse</a> - returns 1 if a script is currently using a text input menu, regardless of whether or not the menu is visible. Only one script may request text input at a time.<br />
<code class="s">(isInUse:bool) IsTextInputInUse</code></p>

<p><a id="GetInputText" class="f" href="https://cs.uesp.net/wiki/GetInputText">GetInputText</a> - returns the text entered by the user. You may call this function at any point before calling <code>CloseTextInput</code>. Note that the returned string includes any html formatting inserted by the user. It also includes an html prefix along the lines of <code>&lt;FONT face="#"&gt;&lt;div align="align"&gt;</code>.<br />
<code class="s">(inputText:string_var) GetInputText</code></p>

<p><a id="UpdateTextInput" class="f" href="https://cs.uesp.net/wiki/UpdateTextInput">UpdateTextInput</a> - tells the text input menu to check for user input and refresh the displayed text if necessary. In general, unless you want to temporarily disallow input, this command should be called every frame while the text input menu is open.<br />
<code class="s">(nothing) UpdateTextInput</code></p>

<p><a id="CloseTextInput" class="f" href="https://cs.uesp.net/wiki/CloseTextInput">CloseTextInput</a> - closes the text input menu, releasing it for use by other scripts. Be sure to call this command when you are done getting input.<br />
<code class="s">(nothing) CloseTextInput</code></p>

<p><a id="InsertInInputText" class="f" href="https://cs.uesp.net/wiki/InsertInInputText">InsertInInputText</a> - inserts formatted text at the current cursor position in the text input menu, as long as doing so would not increase the length of the text beyond its maximum length.<br />
...
<p><a id="sv_Construct" class="f" href="https://cs.uesp.net/wiki/sv_Construct">sv_Construct</a> - constructs a string from a format string and set of variables and assigns the result to a string variable.<br />
...
<p><a id="sv_Length" class="f" href="https://cs.uesp.net/wiki/sv_Length">sv_Length</a> - returns the number of characters in a string variable<br />
<code class="s">(length:int) sv_Length variable:string_var</code></p>

<p><a id="sv_Compare" class="f" href="https://cs.uesp.net/wiki/sv_Compare">sv_Compare</a> - compares a string to a formatted string. Performs a case-insensitive comparison by default. Returns 0 if the strings are equal, 1 if the string variable occurs alphabetically before the formatted string, -1 if the string variable occurs alphabetically after the formatted string, or -2 if the comparison fails.<br />
...
<p><a id="sv_Erase" class="f" href="https://cs.uesp.net/wiki/sv_Erase">sv_Erase</a> - erases the specified number of characters from a string starting at the specified position. If omitted, <span class="op">startPos</span> = 0. Omitting <span class="op">numToErase</span> erases all characters from <code><span class="op">startPos</span></code> to the end of the string.<br />
<code class="s">(nothing) sv_Erase variable:string_var <span class="op">startPos:int numToErase:int</span></code></p>

<p><a id="sv_ToNumeric" class="f" href="https://cs.uesp.net/wiki/sv_ToNumeric">sv_ToNumeric</a> - attempts to convert the contents of a string variable to a number. Valid characters include digits, a leading sign, and an e to indicate scientific notation. Conversion halts at the first invalid character.<br />
<code class="s">(float) sv_ToNumeric sourceString:string_var</code></p>

<p><a id="sv_Find" class="f" href="https://cs.uesp.net/wiki/sv_Find">sv_Find</a> - returns the index of the first occurrence of a substring within a string variable, starting at the specified position and only including occurrences contained completely within the range [<span class="op">startPos, startPos + searchLen</span>]. Omit the arguments to search the entire string without regard to case.<br />
...
<p><a id="sv_Count" class="f" href="https://cs.uesp.net/wiki/sv_Count">sv_Count</a> - returns the number of occurrences of a substring within a string variable, using the same arguments as <code>sv_Find</code>.<br />
...
<p><a id="sv_Insert" class="f" href="https://cs.uesp.net/wiki/sv_Insert">sv_Insert</a> - inserts a substring into a string at the specified position, provided the position is less than the length of the string, or prepends it if no position is specified.<br />
...
<p><a id="sv_Split" class="f" href="https://cs.uesp.net/wiki/sv_Split">sv_Split</a> - given a string and a set of delimiters, returns an Array containing all the substrings separated by one or more of the delimiting characters. For example, <code>sv_Split "#This is.a##. string." ".# "</code> returns <code>{ "This", "is", "a", "string" }</code>. The '.', '#', and space characters are removed.<br />
<code class="s">(substrings:Array) sv_Split toSplit:string delimiters:string</code></p>

<p><a id="GetKeyName" class="f" href="https://cs.uesp.net/wiki/GetKeyName">GetKeyName</a> - returns the name of a key given its DirectInput scan code<br />
<code class="s">(keyName:string) GetKeyName keycode:int</code></p>

<p><a id="AsciiToChar" class="f" href="https://cs.uesp.net/wiki/AsciiToChar">AsciiToChar</a> - returns the character associated with an ASCII code as a string<br />
<code class="s">(character:string) AsciiToChar asciiCode:int</code></p>

<p><a id="NumToHex" class="f" href="https://cs.uesp.net/wiki/NumToHex">NumToHex</a> - returns a string representation of an integer in hexadecimal format. An optional <span class="op">width</span> parameter ranging from 0 to 8 specifies the minimum number of digits toinclude; unused digits are padded with zeroes. By default, 8 digits are included.<br />
<code class="s">(hex:string) NumToHex num:int <span class="op">width:int</span></code></p>

<p><a id="sv_Percentify" class="f" href="https://cs.uesp.net/wiki/sv_Percentify">sv_Percentify</a> - Takes an input string and returns it with each '%' character replaced by two '%' characters. For instance, "100% gold" becomes "100%% gold" and "99.99%%" becomes "99.99%%%%". The argument can be any expression evaluating to a string value.<br />
<code class="s">(percentified:string) sv_Percentify source:string</code></p>

<p><a id="sv_ToLower" class="f" href="https://cs.uesp.net/wiki/sv_ToLower">sv_ToLower</a> - returns the passed string with all characters converted to lowercase.<br />
<code class="s">(lower:string) sv_ToLower source:string </code></p>

<p><a id="sv_ToUpper" class="f" href="https://cs.uesp.net/wiki/sv_ToUpper">sv_ToUpper</a> - returns the passed string with all characters converted to uppercase.<br />
...
<p><a id="IsDigit" class="f" href="https://cs.uesp.net/wiki/IsDigit">IsDigit</a> - returns 1 if the character is a digit<br />
<code class="s">(isDigit:bool) IsDigit character:int</code></p>

<p><a id="IsPunctuation" class="f" href="https://cs.uesp.net/wiki/IsPunctuation">IsPunctuation</a> - returns 1 if the character is punctuation<br />
<code class="s">(isPunctuation:bool) IsPunctuation character:int</code></p>

<p><a id="IsUppercase" class="f" href="https://cs.uesp.net/wiki/IsUppercase">IsUppercase</a> - returns 1 if the character is an uppercase letter<br />
<code class="s">(isUpper:bool) IsUppercase character:int</code></p>

<p><a id="IsPrintable" class="f" href="https://cs.uesp.net/wiki/IsPrintable">IsPrintable</a> - returns 1 if the character is printable (not a non-printable control character)<br />
<code class="s">(isPrint:bool) IsPrintable character:int</code></p>

<p><a id="IsLetter" class="f" href="https://cs.uesp.net/wiki/IsLetter">IsLetter</a> - returns 1 if the character is alphabetic<br />
<code class="s">(isLetter:bool) IsLetter character:int</code></p>

<p><a id="CharToASCII" class="f" href="https://cs.uesp.net/wiki/CharToASCII">CharToASCII</a> - returns the ASCII code of a character passed as a string. Additional characters in the string are ignored.<br />
<code class="s">(character:int) CharToASCII character:string</code></p>

<p><a id="ToUpper" class="f" href="https://cs.uesp.net/wiki/ToUpper">ToUpper</a> - returns the ASCII code of a character converted to uppercase<br />
<code class="s">(upperCharacter:int) ToUpper character:int</code></p>

<p><a id="ToLower" class="f" href="https://cs.uesp.net/wiki/ToLower">ToLower</a> - returns the ASCII code of a character converted to lowercase<br />
<code class="s">(lowerCharacter:int) ToLower character:int</code></p>

<p><a id="ToNumber" class="f" href="https://cs.uesp.net/wiki/ToNumber">ToNumber</a> - takes a string expression and attempts to convert it to a numeric value. By default the string is assumed to be in decimal notation containing digits, at most one decimal point, and an optional leading sign. If the string is prefixed with "0x" or the optional argument is non-zero, the string is interpreted in hexadecimal notation instead, with valid characters consisting of digits and the letters 'A' through 'F'. Returns 0 if the conversion fails.<br />
...
<p><a id="ar_Construct" class="f" href="https://cs.uesp.net/wiki/ar_Construct">ar_Construct</a> - creates a new array_var and assigns it to an array variable. Must be called within the context of an OBSE expression such as <code>Let</code>. The parameter specifies the type of array to create: StringMap, Map, or Array. See the above section for more information on the different types of array variables.<br />
<code class="s">(array_var) ar_Construct arrayType:string</code></p>

<p><a id="ar_Size" class="f" href="https://cs.uesp.net/wiki/ar_Size">ar_Size</a> - returns the number of elements in an array, or -1 if the array is not initialized. For Array-type variables the highest key in the array is equal to one less than the array's size. Must be called within the context of an OBSE expression. The array can be an array variable or an array element which contains an array.<br />
<code class="s">(size:int) ar_Size array:array_var</code></p>

<p><a id="ar_Dump" class="f" href="https://cs.uesp.net/wiki/ar_Dump">ar_Dump</a> - for debugging purposes, prints the key and value of every element in an array to the console. Must be called within an OBSE expression.<br />
<code class="s">(nothing) ar_Dump array:array_var</code></p>

<p><a id="ar_DumpID" class="f" href="https://cs.uesp.net/wiki/ar_DumpID">ar_DumpID</a> - does the same as ar_Dump but accepts an array ID instead of an array_var. Provided as a convenience for debugging in the console.<br />
<code class="s">(nothing) ar_DumpID arrayID:int</code></p>

<p><a  name="ar_Erase" class="f" href="https://cs.uesp.net/wiki/ar_Erase">ar_Erase</a> - erases elements from an array. You may provide a single element, in which case only that element will be erased and only if it is present. Or, you may provide a range in slice notation. Any elements greater than or equal to the lower bound and less than or equal to the upper bound of the range will be erased. If the array is of type <code>Array</code>, elements above the erased elements will be shifted down. Returns the number of elements removed. Users of OBSE 0020 or later may omit the second argument; doing so will erase all elements of the array.<br />
...
<p><a id="ar_Sort" class="f" href="https://cs.uesp.net/wiki/ar_Sort">ar_Sort</a> - attempts to sort the elements of an array in ascending or descending order and returns a new Array containing the elements in sorted order (keys associated with the elements are lost). In order to be sorted all elements of an array must be of the same type (strings, numbers, or objects). If this condition is not met an empty Array is returned. Strings are sorted alphabetically and case-insensitively, numbers are sorted numerically, and objects are sorted by formID. By default the elements are sorted in ascending order.<br />
<code class="s">(sortedArray:Array) ar_Sort toSort:array <span class="op">sortDescending:bool</span></code></p>

<p><a id="ar_SortAlpha" class="f" href="https://cs.uesp.net/wiki/ar_SortAlpha">ar_SortAlpha</a> - sorts the elements of an array alphabetically in ascending or descending order and returns a new Array containing the elements in sorted order. Ordering is case-insensitive. Unlike <code>ar_Sort</code>, does not require elements to be of the same type - numeric elements are converted to a string representation, and forms are sorted by their names (if named) or the string representation of their formIDs. Omitting the optional parameter causes elements to be sorted in ascending order.<br />
<code class="s">(sortedArray:Array) ar_SortAlpha toSort:array <span class="op">sortDescending:bool</span></code></p>

<p><a id="ar_Copy" class="f" href="https://cs.uesp.net/wiki/ar_Copy">ar_Copy</a> - creates a copy of the keys and elements of the specified array. The resulting array is identical to the source array. If the source array contains other arrays, the copy will contain <strong>references</strong> to those same arrays.<br />
<code class="s">(copy:array) ar_Copy src:array</code></p>

<p><a id="ar_DeepCopy" class="f" href="https://cs.uesp.net/wiki/ar_DeepCopy">ar_DeepCopy</a> - performs the same function as <code>ar_Copy</code>, except any arrays contained within the source array are <strong>also</strong> copied (and any arrays within those arrays are copied as well, and so on).<br />
<code class="s">(copy:array) ar_DeepCopy src:array</code></p>

<p><a id="ar_First" class="f" href="https://cs.uesp.net/wiki/ar_First">ar_First</a> - returns the key of the first element in an array<br />
<code class="s">(key:arrayKey) ar_First src:array</code></p>

<p><a id="ar_Last" class="f" href="https://cs.uesp.net/wiki/ar_Last">ar_Last</a> - returns the key of the last element in an array<br />
<code class="s">(key:arrayKey) ar_Last src:array</code></p>

<p><a id="ar_Next" class="f" href="https://cs.uesp.net/wiki/ar_Next">ar_Next</a> - returns the key of the element immediately following the passed key, or <code>BadIndex</code> if no key follows it<br />
<code class="s">(key:arrayKey) ar_Next src:array precedingKey:arrayKey</code></p>

<p><a id="ar_Prev" class="f" href="https://cs.uesp.net/wiki/ar_Prev">ar_Prev</a> - returns the key of the element immediately preceding the passed key, or <code>BadIndex</code> if no key precedes it<br />
<code class="s">(key:arrayKey) ar_Prev src:array prevKey:arrayKey</code></p>

<p><a id="ar_BadNumericIndex" class="f" href="https://cs.uesp.net/wiki/ar_BadNumericIndex">ar_BadNumericIndex</a> - returns a constant representing an invalid numeric array index. Compare to the return value of commands returning an array key to determine if a valid key was returned.<br />
<code class="s">(badKey:int) ar_BadNumericIndex</code></p>

<p><a id="ar_BadStringIndex" class="f" href="https://cs.uesp.net/wiki/ar_BadStringIndex">ar_BadStringIndex</a> - as above, but for string array keys<br />
<code class="s">(badKey:string) ar_BadStringIndex</code></p>

<p><a id="ar_Keys" class="f" href="https://cs.uesp.net/wiki/ar_Keys">ar_Keys</a> - returns an Array containing all of the keys of the source array<br />
<code class="s">(keys:Array) ar_Keys src:array</code></p>

<p><a id="ar_HasKey" class="f" href="https://cs.uesp.net/wiki/ar_HasKey">ar_HasKey</a> - returns true if the array has an element with the specified key<br />
<code class="s">(hasKey:bool) ar_HasKey src:array key:arrayKey</code></p>

<p><a id="ar_Null" class="f" href="https://cs.uesp.net/wiki/ar_Null">ar_Null</a> - returns an invalid array. This is useful if you wish to specify that a variable which previously referred to an array should no longer refer to any array.<br />
<code class="s">(nullArray:array) ar_Null</code></p>

<p><a id="ar_List" class="f" href="https://cs.uesp.net/wiki/ar_List">ar_List</a> - Takes up to twenty arguments of any type and returns an Array containing those elements in the order in which they were passed. We recommend separating the values with commas (starting after the first argument).<br />
...
<p><a id="ar_Resize" class="f" href="https://cs.uesp.net/wiki/ar_Resize">ar_Resize</a> - resizes an Array-type array to be of the specified size. If the new size is smaller than the current size, elements at the end of the array are discarded. If the new size is larger, additional elements are appended to the array. By default these elements have the numeric value zero, but an optional argument can be used to specify the value with which to pad the array. Returns 1 if successful, 0 otherwise.<br />
<code class="s">(bResized:bool) ar_Resize array:Array newSize:int <span class="op">paddingValue:multi</span></code></p>

<p><a id="ar_Insert" class="f" href="https://cs.uesp.net/wiki/ar_Insert">ar_Insert</a> - inserts a single element into an Array-type array at the specified index provided the index is not greater than the current size of the array. Elements above the index are shifted up by one index.<br />
<code class="s">(bInserted:bool) ar_Insert array:Array index:int valueToInsert:multi</code></p>

<p><a id="ar_InsertRange" class="f" href="https://cs.uesp.net/wiki/ar_InsertRange">ar_InsertRange</a> - inserts a range of elements into an Array-type array at the specified index provided the index is not greater than the current size of the array. The range is passed as an Array. Each element of the range is inserted into the target Array in order. Elements above the insertion index are shifted up by the number of elements inserted.<br />
<code class="s">(bInserted:bool) ar_Insert target:Array index:int rangeToInsert:Array</code></p>

<p><a id="ar_Range" class="f" href="https://cs.uesp.net/wiki/ar_Range">ar_Range</a> - returns an Array of zero or more numbers ranging from <span class="op">start</span> up to and including <span class="op">end</span> spaced in intervals of <span class="op">step</span>. For example, <code>ar_Range (5,10,2)</code> returns <code>(5,7,9)</code> and <code>ar_Range (5,3,-1)</code> returns <code>(5,4,3)</code>. This is useful for performing a traditional <code>for</code> loop within a <code>foreach</code> expression. The optional <span class="op">step</span> argument defaults to 1.<br />
<code class="s">(range:Array) ar_Range start:int end:int <span class="op">step:int</span></code></p>

<p><a id="ar_Map" class="f" href="https://cs.uesp.net/wiki/ar_Map">ar_Map</a> - creates a Map or Stringmap given a list of 0-20 key-value pairs. Pairs are specified as 'key::value', where 'key' is a string or numeric value and 'value' is a string, number, array, or form.<br />
...
<p><a id="Eval" class="f" href="https://cs.uesp.net/wiki/Eval">Eval</a> - <code>Eval</code> is used within <code>if</code> statements to test the value of an expression. This allows OBSE expressions to be used as conditions. The expression must evaluate to a boolean value.<br />
...
<p><a id="TestExpr" class="f" href="https://cs.uesp.net/wiki/TestExpr">TestExpr</a> - attempts to evaluate an expression, returning false if an error occurs during evaluation and true otherwise. This can be useful when checking if an array index is out of bounds or if an element exists with a given key, among other things. <code>TestExpr</code> suppresses the output of error messages to the console and log file.<br />
...
<p><a id="TypeOf" class="f" href="https://cs.uesp.net/wiki/TypeOf">TypeOf</a> - returns a string representing the type of an expression. This is mainly useful for determining the type of an array element at run-time. Possible return values: "String", "Number", "Form", "Array", "StringMap", "Map".<br />
...
<p><a id="Function" class="f" href="https://cs.uesp.net/wiki/Function">Function</a> - a blocktype which precedes the body of a function. This blocktype is only valid within function scripts. A parameter list consisting of up to ten local variables used to hold arguments passed to the function must follow this keyword enclosed in curly braces; if the function takes no arguments the braces should be empty.</p><pre>Begin Function {<span class="op">arg1, arg2, ... arg10</span>}
	<span class="op">; function body</span>
End</pre>

<p><a id="SetFunctionValue" class="f" href="https://cs.uesp.net/wiki/SetFunctionValue">SetFunctionValue</a> - specifies the value to be returned from a function. Valid only within a <code>Function</code> block. If a function does not specify a return value, the return value is assumed to be numeric zero. If multiple calls to <code>SetFunctionValue</code> are processed within a single Function block, the most recent value specified will be returned.<br />
<code class="s">(nothing) SetFunctionValue returnValue:expr</code></p>

<p><a id="Call" class="f" href="https://cs.uesp.net/wiki/Call">Call</a> - calls a user-defined function. Should be followed by a list of arguments matching the types expected by the function. If a calling reference is specified, commands within the function body will operate on that reference. Call returns whatever value is returned by the function.<br />
...
<p><a id="GetCallingScript" class="f" href="https://cs.uesp.net/wiki/GetCallingScript">GetCallingScript</a> - returns the script that called the currently executing function script. Returns nothing if the function script was not invoked by a <strong>Call</strong> statement from another script (e.g., will return nothing if the function was invoked as an event handler by OBSE).<br />
...
<p><a id="GetCurrentEventName" class="f" href="https://cs.uesp.net/wiki/GetCurrentEventName">GetCurrentEventName</a> - When called from within an event handler, returns the name of the event currently being handled, as defined <a href="#Events">above</a>.<br />
...
<p><a id="RemoveMeIR" class="f" href="https://cs.uesp.net/wiki/RemoveMeIR">RemoveMeIR</a> - removes an inventory reference from its container, optionally transferring it to a different container, in much the same way as the vanilla RemoveMe command. The inventory reference becomes invalid once this command is called and should no longer be used. This command will not remove <strong>equipped</strong> items until the end of the loop.<br />
<code class="s">(success:bool) reference.RemoveMeIR<span class="op"> containerRef:ref</span></code></p>

<p><a id="CopyIR" class="f" href="https://cs.uesp.net/wiki/CopyIR">CopyIR</a> - copies an inventory reference to the specified container. The calling object needn't be in a container and remains valid after the command is called. If the calling object is equipped, the copy will not be equipped.<br />
<code class="s">(success:bool) reference.CopyIR container:ref</code></p>

<p><a id="CreateTempRef" class="f" href="https://cs.uesp.net/wiki/CreateTempRef">CreateTempRef</a> - creates a temporary reference to the specified form. This reference does not exist in the gameworld or in a container, and remains valid for only one frame. It is mostly useful for creating a stack of one or more items to be added to a container with CopyIR<br />
<code class="s">(tempRef:ref) CreateTempRef baseObject:ref</code></p>

<p><a id="GetInvRefsForItem" class="f" href="https://cs.uesp.net/wiki/GetInvRefsForItem">GetInvRefsForItem</a> - given a base inventory item, returns an Array of temporary references to stacks of that item inside the calling container.<br />
<code class="s">(refs:Array) ref.GetInvRefsForItem baseObject:ref</code></p>

<p><a id="IsEquipped" class="f" href="https://cs.uesp.net/wiki/IsEquipped">IsEquipped</a> - returns true if the calling object is currently being worn<br />
